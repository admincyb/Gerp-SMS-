    ...
    public class PayrollProcessBL
    {
        public static EmpPayrollHeader GetEmployeePayrollList(string strxml)
        {
            try
            {
                ...
                string payrolldtl = PayrollProcessDL.GetEmployeePayrollList(strxml);
        ...
        {
            return PayrollProcessDL.ProcessPayrollDetails(strxml, out TrxNo, out dtErrorList);
        }
        ...
        {
            return PayrollProcessDL.GetPayrollProcessPeriodList(gridParam, bizUnit, processMode);
        }
        ...
        public static EmpPayrollPayHeader GetEmployeePayrollDetailList(int epsPK)
        {
            try
            {
                ...
                string empPaydtl = PayrollProcessDL.GetEmployeePayrollDetailList(epsPK);
        ...
        {
            return PayrollProcessDL.SaveEmployeePayroll(strxml);
        }

        public static DataTable GetPayrollType(int PK, int bizUnit, int status, int processMode = 0, int? UserPK = null)
        {
            return PayrollProcessDL.GetPayrollType(PK, bizUnit, status, processMode, UserPK);
        }
        ...
        public static PeriodWorkingDayHdr GetWorkingDaysDetails(int PayrollPK, int bizUnit, int status, int itemPK)
        {
            try
            {
                ...
                string wrkdayDtl = PayrollProcessDL.GetWorkingDaysDetails(PayrollPK, bizUnit, status, itemPK);
        ...
        {
            return PayrollProcessDL.DeleteProcessPeriod(pk, lastModifiedDate);
        }

        public static int DeleteEmployeePayroll(string xml)
        {
            return PayrollProcessDL.DeleteEmployeePayroll(xml);
        }


        public static DataSet GetPayslipRPT(int currPK)
        {
            return PayrollProcessDL.GetPayslipRPT(currPK);
        }

        public static DataSet GetSalaryStatementRPT(int currPK)
        {
            return PayrollProcessDL.GetSalaryStatementRPT(currPK);
        }
        public static DataSet GetPaySlipMultipleReport(string xmlPaySlip, string payslipSp)
        {
            return PayrollProcessDL.GetPaySlipMultipleReport(xmlPaySlip, payslipSp);
        }

        public static DataSet GetPayrollPreprocess(string xmlPreprocess)
        {
            return PayrollProcessDL.GetPayrollPreprocess(xmlPreprocess);
        }

        public static DataSet GetPayrollSalaryOutRPT(int currPK)
        {
            return PayrollProcessDL.GetPayrollSalaryOutRPT(currPK);
        }

        public static DataTable GetPayroll(int PayrollPk, int bizUnit)
        {
            return PayrollProcessDL.GetPayroll(PayrollPk, bizUnit);
        }
        public static DataTable GetNonPayrollEmployees( int payrollType, string fromDate, string toDate)
        {
            return PayrollProcessDL.GetNonPayrollEmployees(payrollType, fromDate, toDate);
        }
    }
}
