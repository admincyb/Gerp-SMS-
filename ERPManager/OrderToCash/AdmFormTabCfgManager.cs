...
{
    public class AdmFormTabCfgManager : IAdmFormTabCfgManager
    {
        ...
        /// <example></example>
        public AdmFormTabCfgManager(ERPEntities currentEntity)
        {
            try
            {
        ...
        public List<SPADM_FORM_TAB_CFG_GET_Result> GetFormTabList(string formCode)
        {
            try
            {
                List<SPADM_FORM_TAB_CFG_GET_Result> resultFieldsList;
                resultFieldsList = this.currentEntity.SPADM_FORM_TAB_CFG_GET(formCode).ToList();
