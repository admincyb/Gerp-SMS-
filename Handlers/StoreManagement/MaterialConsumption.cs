...
namespace Handlers
{
    public partial class Handlers : IHttpHandler, IRequiresSessionState
    {
        ...
        private static void MaterialConsumption(HttpContext context)
        {
            ...
            if (Request.Params.Count > 0)
            {
                ...
                switch (Action)
                {
                    ...
                    case "SaveConsumption":
                        Handlers.SaveConsumption(context);
                        break;
                    case "GetConsumptionList":
                        Handlers.GetConsumptionList(context);
                        break;
                    case "GetConsumptionSearchValue":
                        Handlers.GetConsumptionSearchValue(context);
                        break;
                    //case "GetSearchValue":
                    ...
                    case "DeleteConsumption":
                        Handlers.DeleteConsumption(context);
                        break;
        ...
        /// </summary>
        /// <param name="context"></param>
        private static void SaveConsumption(HttpContext context)
        {
            HttpRequest Request = context.Request;
            HttpResponse Response = context.Response;
            ...
            try
            {
                ...
                string requisition = BusinessLogic.StoreManagement.MaterialConsumption.SaveConsumptionDetails(requisitionDetails, objUser);
        ...
        /// </summary>
        /// <param name="context"></param>
        private static void GetConsumptionList(HttpContext context)
        {
            ...
            try
            {
                ...
                Response.Write(BusinessLogic.StoreManagement.MaterialConsumption.GetConsumptionList(CommonFunctions.GetGridParams(Request), bizUnit, objUser, procID));
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <param name="context"></param>
        private static void DeleteConsumption(HttpContext context)
        {
            HttpRequest Request = context.Request;
            HttpResponse Response = context.Response;
            int consumptionID = 0;
            try
            {
                ...
                if (Request.Params["ConsumptionID"] != null)
                {
                    // Assign requisitionID From Request to requisitionID variable
                    consumptionID = Convert.ToInt32((Request.Params["ConsumptionID"].Trim()));

                }

                Response.Write(BusinessLogic.StoreManagement.MaterialConsumption.DeleteConsumption(consumptionID));
        ...
        /// </summary>
        /// <param name="context"></param>
        private static void GetConsumptionSearchValue(HttpContext context)
        {
            // Create the request and response objects from context
            HttpRequest Request = context.Request;
            HttpResponse Response = context.Response;
            ...
            try
            {
                ...
                BusinessObject.User objUser = ((BusinessObject.User)(HttpContext.Current.User.Identity));
                Response.Write(BusinessLogic.StoreManagement.MaterialConsumption.GetSearchValues(searchBy, searchValue, sbuPk, objUser, procID));
            }
            catch (Exception ex)
            {
                NLog.Logger logger = NLog.LogManager.GetLogger("Store Requisition Slip List");
