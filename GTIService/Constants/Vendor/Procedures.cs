...
namespace GTIService.Constants.Vendor
{
    public class Procedures
    {
       ...
       // public const string GETVENDOR = "SpGDnvTldTm";
        ...
        public const string GETVENDORDTL = "SPPUR_VENDOR_MST_GET_DTL";
        public const string GETVENDORBANKDTL = "SPPUR_VENDOR_BANK_DTL_GET_KV";
        public const string SPPUR_VENDOR_CONTACT_LOC_GET_KV = "SPPUR_VENDOR_CONTACT_LOC_GET_KV"; 
        public const string GETVENDORONLY = "SPPUR_ORDER_VENDOR_GET_KV";
        public const string SPPUR_VENDOR_GET_AUTO = "SPPUR_VENDOR_GET_AUTO";
        public const string SPASR_VENDOR_ROLE_GET_KV = "SPASR_VENDOR_ROLE_GET_KV";
       ...
       // public const string GETESUPPLIEDMATERIAL = "SpGMtiEpt";
        ...
        //Vineeth Vendor Details Save and Get
        public const string SAVEVENDOR = "SPPUR_VENDOR_MST_SAVE";
        ...
        public const string GETVENDORDETILSLIST = "SPPUR_VENDOR_MST_GET_LIST_WRKF";
        ...
        public const string SPPUR_VENDOR_CONTACT_LOC_DELETE = "SPPUR_VENDOR_CONTACT_LOC_DELETE"; 

        public const string SPPUR_VENDOR_CONTACT_LOC_SAVE = "SPPUR_VENDOR_CONTACT_LOC_SAVE"; 
