...
namespace TelerikUserFunctions
{
    public static class GTIUserFunctions 
    {
        [Function(Category = "User Functions", Namespace = "GtiUF", Description = "Say Hi")]
        public static string Greet(string name)
        {
            return string.Format("Hello, {0}", name);
        }
        #region User functions
        static DataTable dtCurrency;

        [Function(Category = "User Functions", Namespace = "GtiUF", Description = "Number to words")]
        ...
        public static string ToBahtText(double value)
        {
            string result;
        ...
        [Function(Category = "User Functions", Namespace = "GtiUF", Description = "Local Currency Conversion With Only")]
        public static string LocalCurrencyConversionWithOnly(string Number)
        {
        ...
        private static int Instr(string string1, string string2)
        {
        ...
        [Function(Category = "User Functions", Namespace = "GtiUF", Description = "Foreign Currency Conversion")]
        public static String ForeignCurrencyConversionDecimalWithOnly(String numb)
        {
        ...
        public static String ForeignCurrencyConversionDecimalWithOutOnly(String numb)
        {
            numb = numb.Replace(",", "");
            bool isCurrency = true;
            String val = "", wholeNo = numb, points = "", andStr = "", pointStr = "";
        ...
        [Function(Category = "User Functions", Namespace = "GtiUF", Description = "Translate number")]
        ...
        #region Million
        [Function(Category = "User Functions", Namespace = "GtiUF", Description = "Million")]
