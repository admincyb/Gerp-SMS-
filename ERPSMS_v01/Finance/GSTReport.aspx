<%@ Page Title="<%$ Resources:Captions,Title_GSTReport %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" CodeBehind="GSTReport.aspx.cs" Inherits="ERPSMS_v01.Finance.GSTReport" Theme="ClassicExt"%>
                ...
                <div class="clear"></div>
                            ...
                            <tr>
                                <td>
                                    <div class="div2col-S">
                                        ...
                                        <asp:TextBox ID="txtItemFromDate" runat="server" TabIndex="3" CssClass="input-small" MaxLength="11"
                                      ...
                                      <div class="starwrap">
                                        ...
                                        <asp:Label runat="server" ID="lblItemToDate" Text="<%$ resources:ItemToDate %>" CssClass="middle-lbl-a"
                                            AssociatedControlID="txtItemToDate"></asp:Label>
                                        <asp:TextBox ID="txtItemToDate" runat="server" TabIndex="4" CssClass="input-small" MaxLength="11"
                                            onkeydown="return CheckKey(event)" onpaste="return false;"> </asp:TextBox>
                                    <div class="starwrap">
                                        ...
                                        <asp:Label ID="lblItemTaxType" runat="server" Text="<%$resources:ItemTaxType %>" AssociatedControlID="lstItemTaxType"></asp:Label>
                                        <asp:ListBox ID="lstItemTaxType" runat="server" SelectionMode="Multiple" TabIndex="6" CssClass="select-half"></asp:ListBox>
                                        <%--<asp:RequiredFieldValidator ID="vrfItemTaxType" runat="server" ControlToValidate="lstItemTaxType"
                                            Text="*" CssClass="star" InitialValue="" ValidationGroup="item" EnableClientScript="true"
                                            SetFocusOnError="true" ErrorMessage="<%$ resources:Err_ItemTaxType %>"></asp:RequiredFieldValidator>--%>
                                        
                                    </div>
                                </td>
                                <td>
                                    <div class="div2col-S"> 
                                    <asp:Label ID="lblItemReport" runat="server" Text="<%$resources:ItemReport %>" AssociatedControlID="ddlItemReport"></asp:Label>
                                        <asp:DropDownList ID="ddlItemReport" runat="server" TabIndex="5" CssClass="select-half"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="vrfItemReport" runat="server" ControlToValidate="ddlItemReport"
                                            Text="*" CssClass="star" InitialValue="-1" ValidationGroup="item" EnableClientScript="true"
                                            SetFocusOnError="true" ErrorMessage="<%$ resources:Err_ItemReport %>"></asp:RequiredFieldValidator>
                                        <div class="clear"></div>
                                            
                                            <asp:Label runat="server" ID="lblChkRecords" Text="<%$ resources:ItemChkRecords %>"
                                             AssociatedControlID="chkRecords"></asp:Label>
                                        <asp:CheckBox ID="chkRecords" runat="server" TabIndex="7"/>                                   
                    ...
                    <div class="reportviewer" id="divReportViewer" runat="server">
                        <div style="overflow:auto;">
                            <rsweb:ReportViewer ID="rvViewReport" runat="server" BorderWidth="0" SizeToReportContent="true" Width="98%">
                            </rsweb:ReportViewer>
                        </div>
                    </div>
                    <div style="height:15px;"></div>
                    <div id="divNodata" class="nodata" runat="server" visible="false">No Record Found</div>
