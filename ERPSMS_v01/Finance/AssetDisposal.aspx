<%@ Page Title="<%$ Resources:Captions,Title_AssetDisposal %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="AssetDisposal.aspx.cs" Inherits="ERPSMS_v01.Finance.AssetDisposal" %>

<%@ Register Src="~/Journalize/UserControls/JournalizeControlNew.ascx" TagName="Journalize" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            GrandScriptUtils.MakeAutoCompleteDDL("txtDepNo", url, "hdfDeprPK", true, true, "ASSETDISPOSALAUTO");
        ...
        function CalculateTotal() {
            ...
            $("#[id*=grdSelectedAssets] [id*=lblTotalAssetDepreAmtFooter]").html(GrandScriptUtils.ToFixed(DepreciationAmt, DecimalDigits));
            $("#[id*=grdSelectedAssets] [id*=lblTotalAssetDepreAmtFooter]").attr('title', GrandScriptUtils.ToFixed(DepreciationAmt, DecimalDigits));
        }
                                ...
                                <ul runat="server" id="pnlListing" style="display: none">
                                    <li runat="server" id="pnlEditforCancel">
                                        <asp:Button runat="server" TabIndex="38" ID="btnEditforCancel" CommandName="EDITFORCANCEL"
                                            OnClick="ActionHandler" Text="<%$resources:CancelDisposal %>" CommandArgument="SEC_ActionPanel"
                                            SkinID="btnInner-cancel1" ToolTip="<%$resources:CancelDisposal %>" />
                                    </li>
                                    <li>
                        ...
                        <asp:TableCell>
                            ...
                            <table class="table-devide " id="tbladvancedSearch">
                                <tr>
                                    ...
                                    <td>
                                        <div class="div2col-S div-separatn">
                                            <asp:Label ID="lblDepreciation" runat="server" Text="<%$resources:AssetDispNo %>"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField runat="server" ID="hdfDePreTranID" Value='<%# Eval(Resources.DataFieldRes.AssetDisposalPK) %>' />
                                                <asp:HiddenField ID="hdfDept" runat="server" Value='<%# Eval(Resources.DataFieldRes.AssetDisposalDept) %>' />
                                                <asp:HiddenField ID="hdfDelStatus" runat="server" Value='<%# Eval(Resources.DataFieldRes.AssetDisposalDelStatus) %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="3%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Date %>" SortExpression="<%$ resources:DataFieldRes,AssetDisposalDate %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDepreTranDate" runat="server" Text='<%# Eval(Resources.DataFieldRes.AssetDisposalDate, Resources.Constants.DateFormatGrid)  %>'
                                                    ToolTip='<%# Eval(Resources.DataFieldRes.AssetDisposalDate, Resources.Constants.DateFormatGrid)%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:AssetDispNo %>" SortExpression="<%$ resources:DataFieldRes,AssetDisposalNo %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDepreTranNo" runat="server" Text='<%# Eval(Resources.DataFieldRes.AssetDisposalNo) ==""?"[NEW]":Eval(Resources.DataFieldRes.AssetDisposalNo)%>'
                                                    ToolTip='<%# Eval(Resources.DataFieldRes.AssetDisposalNo)%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:DeprePeriodFrom %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDeprePeriodFrom" runat="server" Text='<%# Eval(Resources.DataFieldRes.AssetDisposalFrom, Resources.Constants.DateFormatGrid) %>'
                                                    ToolTip='<%#  Eval(Resources.DataFieldRes.AssetDisposalFrom, Resources.Constants.DateFormatGrid) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:DeprePeriodTo %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDeprePeriodTo" runat="server" Text='<%# Eval(Resources.DataFieldRes.AssetDisposalTo, Resources.Constants.DateFormatGrid) %>'
                                                    ToolTip='<%# Eval(Resources.DataFieldRes.AssetDisposalTo, Resources.Constants.DateFormatGrid) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:AssetType %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAssetType" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(HttpUtility.HtmlDecode(Eval("ADH_ASSET_TYPE_TEXT").ToString()),50)%>'
                                                    ToolTip='<%# HttpUtility.HtmlDecode(Eval("ADH_ASSET_TYPE_TEXT").ToString())%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="36%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:DepreAmount %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDepreAmount" runat="server" Text='<%# Eval(Resources.DataFieldRes.AssetDisposalAmount,this.GetCurrencyFormat()) %>'
                                                    ToolTip='<%# Eval(Resources.DataFieldRes.AssetDisposalAmount,this.GetCurrencyFormat()) %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="imgApproved" runat="server" OnClientClick="javascript:return false;"
                                                    CssClass='<%# Eval(Resources.DataFieldRes.DepreWorkFlowCssClas) %>' ToolTip='<%# Eval(Resources.DataFieldRes.AssetDisposalWorkflowStatus) %>' />
                                                ...
                                                <asp:HiddenField runat="server" ID="hdfApproved" Value='<%# Eval(Resources.DataFieldRes.AssetDisposalApproved) %>' />
                                                <asp:HiddenField runat="server" ID="hdfPosted" Value='<%# Eval(Resources.DataFieldRes.AssetDisposalPosted) %>' />
                                            </ItemTemplate>
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <div id="divMonth" runat="server">
                                                <asp:Label ID="lblDepreMonth" runat="server" Text="<%$ resources:AssetDispMonth%>"
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            <asp:Label ID="lblAssetStatus" runat="server" Text="<%$resources:AssetStatus %>" AssociatedControlID="ddlAssetStatus"></asp:Label>
                                            <asp:DropDownList ID="ddlAssetStatus" runat="server" TabIndex="4" CssClass="input-halfsmall-19-3">
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <asp:GridView runat="server" ID="grdSelectedAssets" Width="100%" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:AssetCode %>">
                                            <ItemTemplate>
                                                <asp:HiddenField runat="server" ID="hdfDepreDetailPK" Value='<%# Eval("DetailPK") %>' />
                                                <asp:HiddenField runat="server" ID="hdfAssetPK" Value='<%# Eval("AssetPK") %>' />
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:AssetDepreAmt %>">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtAssetDepreAmt" runat="server" CssClass="medium numeric" Text='<%# Eval("Amount",this.GetCurrencyFormat()) %>'
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:RadioButton CssClass="rdoSelection" TabIndex="6" runat="server" GroupName="SelectOne"
                                            ID="rbtSelectAsset" onclick="GrandScriptUtils.EnableRbtnGrouping(this);" />
                                    </ItemTemplate>
                                    <ItemStyle Width="2%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="<%$ resources:AssetDepreAmtPopup %>">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblAssetDepreAmt" runat="server" Text='<%# Eval(Resources.DataFieldRes.AssetDepreAmount,this.GetCurrencyFormat()) %>'
                                            ToolTip='<%# Eval(Resources.DataFieldRes.AssetDepreAmount,this.GetCurrencyFormat()) %>'></asp:Label>
                                    </ItemTemplate>
