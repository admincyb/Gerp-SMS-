...
var RequisitionList = {
    ...
    REDIRECTURLEDIT: "../StoreManagement/FormerDamageIssue.aspx?IssueID=",
    ADDNEWURL: "../StoreManagement/FormerDamageIssue.aspx",
    ...
    PAGEURL: "../StoreManagement/FormerDamageIssue.aspx",
...
function AddNew() {
    ...
    $.get(RequisitionList.GetCurrentDepartment, function (data) { //for multi tab department checking
        if ($("[id$=hdfDeptID]").val() != data) {
            ...
            //alert(RequisitionList.ADDNEWURL + "?TYPE=" + TRX_TYPE)
