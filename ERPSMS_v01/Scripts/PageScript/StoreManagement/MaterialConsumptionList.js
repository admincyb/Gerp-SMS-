...
var RequisitionList = {
    ...
    //Url
    AutoCompleteURL: "MaterialConsumption.do?Action=GetConsumptionSearchValue&SBUPk=",
    BindGridURL: "MaterialConsumption.do?Action=GetConsumptionList&Status=",
    DeleteRowURL: "MaterialConsumption.do?Action=DeleteConsumption&ConsumptionID=",
    REDIRECTURLEDIT: "../StoreManagement/MaterialConsumption.aspx?ConsumptionID=",
    ADDNEWURL: "../StoreManagement/MaterialConsumption.aspx",
...
function DeleteDetails(tr) {
    ...
    $.get(RequisitionList.DeleteRowURL + consumptionHeaderId, function (data) {
...
///<summary>Function To Get consumptionHeaderId and Pass this consumptionHeaderId as a QueryString </summary>
function FillDetails(tr) {
    //Get OrderID From tr - For Pass this as QueryString
    consumptionHeaderId = GrandGrid.Utilities.GetColumnValue(tr, RequisitionList.ConsumptionHeaderId, $(tr).parent().attr("id"));
    window.location = RequisitionList.REDIRECTURLEDIT + consumptionHeaderId;
}
function BindGrid() {
...
//    var ajaxUrl = RequisitionList.BindGridURL + $("[id$=SearchType]").val() + "&SearchValue=" + Value + "&BizUnit=" + $("[id$=BizUnitPk]").val() + "&ProcID=" + $("[id$=hdfProcId]").val();
    var ajaxUrl = RequisitionList.BindGridURL + $("[id$=SearchType]").val() + "&SearchValue=" + $("[id$=SearchValue]").val() + "&BizUnit=" + $("[id$=BizUnitPk]").val() + "&ProcID=" + $("[id$=hdfProcId]").val();
...
//            }
//            if (UserStatus == 2) {
            window.location = RequisitionList.ADDNEWURL + "?ConsumptionID=" + consumptionHeaderId + "&Status=0";
//            }
//            return false;
            break;
        ...
        case RequisitionList.View:
            ...
            if (UserStatus == 1) {
                ...
                window.location = RequisitionList.ADDNEWURL + "?ConsumptionID=" + consumptionHeaderId + "&Status=1";
            }
        ...
        case RequisitionList.Print:
            ...
            window.location = RequisitionList.PRINTURL + "?ConsumptionID=" + consumptionHeaderId;
            return false;
            break;
