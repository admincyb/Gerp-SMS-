...
(function ($) { // hide the namespace
    ...
    function Datetimepicker() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            dateFormat:'dd-mmm-yyyy hh:MM',//     'mm/dd/yyyy hh:MM TT', // See format options on parseDate
            /*  format options.
        ...
        this._defaults = { // Global defaults for all the date picker instances
            ...
            defaultDate: new Date(), // Used when field is blank: actual date,
            ...
            minDate: null, //new Date(), // The earliest selectable date, or null for no limit
    ...
    $.extend(Datetimepicker.prototype, {
        ...
        */
        ...
        _formatDate: function (inst, day, month, year) {
            ...
            var DateString = '' + inst.currentMonth + '/' + inst.selectedDay + '/' + inst.selectedYear + ' ' + (Hour == null ? "00" : Hour) + ':' + MinuteString + ' ' + (inst.currentAMPM == null ? "AM" : inst.currentAMPM);
...
RegexDateFormat.masks = {
    ...
    isoDateTime: "yyyy-mm-dd'T'HH:MM:ss",
    isoUtcDateTime: "UTC:yyyy-mm-dd'T'HH:MM:ss'Z'",
    CustomForSMS: "dd-mmm-yyyy HH:MM"
};
