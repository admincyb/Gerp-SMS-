<%@ Page Title="<%$ Resources:Captions,Title_MaterialRequest %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    EnableEventValidation="false" AutoEventWireup="true" CodeBehind="MaterialRequest.aspx.cs" Inherits="ERPSMS_v01.Inventory.MaterialRequest" %>

<%@ Register Src="../WorkFlow/WorkflowComments.ascx" TagName="WorkflowComments" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/PurchaseRequestManagement/MaterialRequest.js.axd"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-wrapper">
            ...
            <tr>
                <td>
                    <div class="div2col-S">
                        <label for="PurchaseRequestNo">
                            <%=Resources.Controls.MR_NO%></label>
                        ...
                        <asp:HiddenField ID="hdfIsShowInvestor" runat="server" Value="0" />
                        ...
                        <asp:Label ID="Label1" runat="server" Text='<%$ Resources:ConfigurationsRes,RequestedBy%>' CssClass="bg-none border0 lbl-25-1perc numeric"></asp:Label>
                        <asp:TextBox ID="PRH_USER" runat="server" TabIndex="5" EnableViewState="false" CssClass="input-half"
                            MaxLength="200"></asp:TextBox>
                        <div id="divCostCenter" class="display-inline">
                            <label for="CostCenter" class="margnrgt3">
                                <%=Resources.Controls.CostCenter %></label>
                            <asp:DropDownList runat="server" ID="PRH_COST_CENTER" TabIndex="7" CssClass="select-half-a">
                            </asp:DropDownList>
                        </div>
                        <div id="divInvestor" runat="server" class="display-inline">
                            <label for="Investor" class="margnrgt3">
                                <%=Resources.Controls.InvestorCode%></label>
                            <asp:DropDownList runat="server" ID="PRH_INVESTOR" TabIndex="7" CssClass="select-half-a">
                            </asp:DropDownList>
                        </div>

                        <div id="divIssueDept" runat="server" class="display-inline">
                            <label for="IssueDept" class="margnrgt3">
                                <%=GetLocalResourceObject("IssuingStore")%></label>
                            <asp:DropDownList runat="server" ID="IssueDept" TabIndex="7" CssClass="select-half-a" EnableViewState="true"
                                onchange="javascript:InitializeMaterial();">
                            </asp:DropDownList>
                        </div>
                        <div class="clear">
                        </div>
                ...
                <td>
                    <div class="div2col-S" style="float: right;">
                        ...
                        <label for="ddlIssuingStore" id="lblIssuingStore" runat="server">
                        ...
                        <div id="divSubDept" style="display: none;" runat="server">
                            <label for="ddlIssuingSubStore" class="margnrgt3">
                                <%=GetGlobalResourceObject("Controls", "RequestedSubDept")%>
                            </label>
                            <asp:DropDownList ID="PRH_ISSUE_SUB_DEPT" runat="server" TabIndex="6" CssClass="select-half" onchange="javascript:SubDeptChange();">
                            </asp:DropDownList>
                        </div>
        ...
        <h1 class="search-colapse-normal" style="display: none;">
            <%=Resources.Captions.ItemCatSearch%>
            <img id="imgReOrderShowHeader" src="../Images/Classic/Icons/arrow-colapse-active.png"
                ...
                onclick="javascript:ShowReOrderHeader();" />
        ...
        <div id="divROL" class="checkbx w100perc" style="display: none;">
            <%----%>
            ...
            <img id="imgReOrderShow" src="../Images/Classic/Icons/arrow-colapse-active.png" alt="<%= Resources.Controls.Show%>"
                title="<%= Resources.Controls.Show%>" style="display: none; cursor: pointer; float: right!important; margin-right: 11px!important;"
                onclick="javascript:ShowReOrder();" />
            <img id="imgReOrderHide" src="../Images/Classic/Icons/arrow-colapse-inactive.png"
                alt="<%= Resources.Controls.Hide%>" title="<%= Resources.Controls.Hide%>" style="cursor: pointer; float: right!important; margin-right: 11px!important;"
                onclick="javascript:HideReOrder();" />
        </div>
        <div class="clear">
        </div>
                ...
                <table rules="all" id="grdPuchasePendingList" grandtype="GrandGrid" paging="false"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th fieldmap="ITM_UOM" isvisible="false"></th>
                            <th fieldmap="UOM_CODE" isvisible="false"></th>
                            <th fieldmap="ITM_IS_PM" isvisible="false">
                                <%--For identifying item is packing material or not--%>
                            </th>
                            <%-- Lot no Hiddenfield--%>
                            <th fieldmap="SOD_LOT_NO" isvisible="false"></th>
                            <th fieldmap="ITM_DESC" isvisible="false"></th>
                            <th fieldmap="ITM_CATEGORY" isvisible="false"></th>
                            ...
                            <th fieldmap="ITM_ROL_STK" align="right" width="6%" isvisible="false">
                                <%=Resources.Controls.ReorderLevel%>
                            </th>
                            <th fieldmap="PRD_QTY_APPROVED" align="right" width="11%" isvisible="false">
                    ...
                    <table id="PurchaseRequestInsert" class="gridwraptable gridwrap tablefixwidth-td">
                        ...
                        <tbody>
                            <tr class="grd-rowhead">
                                <td>
                                    <asp:TextBox ID="MaterialCategory" Width="150px" runat="server" TabIndex="14">
                                    </asp:TextBox>
                                    <asp:HiddenField ID="MaterialCategoryPK" runat="server" Value="0"></asp:HiddenField>
                                </td>
                                <td>
                                    <asp:TextBox ID="ItemCodeMaterial" runat="server" TabIndex="15" CssClass="input-w81per">
                                    </asp:TextBox>
                                ...
                                <td style="width: 150px;">
                                    <asp:TextBox ID="MaterialSpec" runat="server" Width="140px" TabIndex="21" MaxLength="2000">
                                    </asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="RequestPorpose" runat="server" Width="115px" TabIndex="22" MaxLength="2000">
                                    </asp:TextBox>
                    ...
                    <table rules="all" id="grdPurchaseRequest" grandtype="GrandGrid" paging="false" editfunction="GridAction"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th fieldmap="ITM_CATEGORY_VALUE" isvisible="false"></th>
        ...
        <div id="divBreakupStore" title="<%=Resources.Captions.CurrentStockBreakup%>">
            <table rules="all" id="grdBreakupStoreList" grandtype="GrandGrid" paging="false"
                ...
                <thead>
                    <tr>
                        <th fieldmap="STD_DEPT" isvisible="false"></th>
            ...
            <%-- For Showing  Last PO Rate with Currency--%>
                -----------------------------------------------------------------------
                 ...
                 <label for="lblLastPOR" style="width: 111px">
                     <%=Resources.Controls.LastPORate%>
                 </label><b>
            <asp:Label ID="lblLastPOR" runat="server" EnableViewState="false"></asp:Label>
            </b>
            <div class="clear">
            </div>
            <label for="lblCurrency" style="width: 111px">
                <%=Resources.Controls.Currency%>
            </label>
            <b>
            <asp:Label ID="lblCurrency" runat="server" EnableViewState="false"></asp:Label>
            </b>
        </div>
    <%-- end breakup--%>
    ...
    <asp:HiddenField ID="hdfRequestedBy" runat="server"></asp:HiddenField>
    <asp:HiddenField ID="hdfRequestbyDept" runat="server"></asp:HiddenField>
    ...
    <asp:HiddenField ID="hdfIsPostBack" runat="server" Value="0" />
