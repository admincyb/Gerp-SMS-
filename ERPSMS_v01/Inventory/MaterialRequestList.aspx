<%@ Page Title="<%$ Resources:Captions,Title_MaterialRequest %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="MaterialRequestList.aspx.cs" Inherits="ERPSMS_v01.Inventory.MaterialRequestList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            var prAutoCompleteURL = "PurchaseRequest.do?Action=GetMaterialSearchValue&AUTOSEARCH=1";
            var MaterialCodeName = "MaterialManagement.do?Action=GetMaterialsPlantToPlant&AUTOSEARCH=1";
            var prPageURL = "/Inventory/MaterialRequest.aspx";
            var StorePK = "0";
            if ($("[id$=hdfReqStore]").val() == "")
                StorePK = "0";
            else
                StorePK = $("[id$=hdfReqStore]").val();
            if ($("[id$=hdfMenuType]").val() == "4")
                prPageURL = "/Inventory/MaterialRequest.aspx?TYPE=4";
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtPRNumber", prAutoCompleteURL + "&SearchType=PRH_NO" + "&PageURL=" + prPageURL + "&MenuType=" + $("[id$=hdfMenuType]").val(), "hdfPRNumber", true, true, 4);
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtReqStore", prAutoCompleteURL + "&SearchType=DPT_NAME" + "&PageURL=" + prPageURL, "hdfReqStore", true, true, 4);
            //            GrandScriptUtils.MakeAutoCompleteDDL("txtIONo", prAutoCompleteURL + "&SearchType=SOH_NO" + "&PageURL=" + prPageURL, "hdfIONo", true, true);
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtReqDept", prAutoCompleteURL + "&SearchType=CON_NAME" + "&PageURL=" + prPageURL, "hdfReqDept", true, true, 4);
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtReqBy", prAutoCompleteURL + "&SearchType=PRH_USER" + "&PageURL=" + prPageURL, "hdfReqBy", true, true, 4);
            GrandScriptUtils.MakeAutoComplete("txtItemname", MaterialCodeName + "&Store=" + StorePK, "hdfItemcode", true, true, "MaterialCategoryPK", true);
    ...
    <asp:UpdatePanel ID="aupdpnlAvtivity" runat="server">
        <ContentTemplate>
            ...
            <div class="content-wrapper">
                ...
                <asp:Table runat="server" ID="tblTemplate" CssClass="tablelayout asptbllinks">
                    ...
                    <asp:TableRow ID="PageAction_List" runat="server">
                        ...
                        <asp:TableCell>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            ...
                                            <asp:Label runat="server" ID="lblItemName" Text="<%$ Resources:Controls, ItemNameCode%>"
                                            ...
                                            <asp:HiddenField ID="hdfItemName" runat="server" Value=""  />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            <asp:Label runat="server" ID="lblReqStore" Text="<%$ resources:ReqStore %>" AssociatedControlID="txtReqStore"></asp:Label>
                                            <asp:TextBox ID="txtReqStore" runat="server" CssClass="select-w63per" TabIndex="5">
                                            </asp:TextBox>
                                            ...
                                            <asp:Label runat="server" ID="lblPohType" Visible="false" Text="<%$ resources:Type %>"
                                                CssClass="lbl-13perc" AssociatedControlID="ddlPOHType"></asp:Label>
                                            <asp:DropDownList ID="ddlPOHType" TabIndex="5" Visible="false" CssClass="select-w27per"
                                                runat="server">
                                            </asp:DropDownList>
                                            <div class="clear">
                                            </div>
                                            <asp:Label runat="server" ID="lblReqDept" Text="<%$ resources:ReqDept %>" AssociatedControlID="txtReqDept"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtReqDept" TabIndex="7" CssClass="select-w63per"></asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S div-separatn">
                                            ...
                                            <asp:TextBox runat="server" ID="txtReqBy" TabIndex="7" CssClass="input-small-c0 margnbotm0"></asp:TextBox>
                                            <asp:HiddenField ID="hdfReqBy" runat="server" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="div2col-S div-separatn">
                                            <%--<asp:CheckBox ID="chkIsServiceItem" runat="server" Text="Service Item" />--%>
                                            <%--   <asp:DropDownList ID="ddlItemCategory" runat="server" CssClass="margnbotm0" ToolTip="<%$ resources:PrType %>">
                                                <asp:ListItem Value="0" Text="<%$ Resources:BindValues, StatusFilterAll%>" Selected="True"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="<%$ Resources:BindValues, Goods%>"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="<%$ Resources:BindValues, Services%>"></asp:ListItem>
                                            </asp:DropDownList>--%>
                                            <asp:Label runat="server" ID="lblPrNumber" Text="<%$ resources:PrNo %>" AssociatedControlID="txtPRNumber"
                                                CssClass="lbl-12-5perc"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtPRNumber" TabIndex="9" CssClass="select-small-e margnbotm0 h14">
                                            </asp:TextBox>
                                            ...
                                            <asp:ImageButton ID="btnSearch" runat="server" ToolTip="<%$ resources:Controls,Search %>"
                                                CssClass="margnrgt5 margnbotm0 margntop2" TabIndex="9" SkinID="search-ext" OnClick="ActionHandler"
                                                CommandName="SEARCH" />
                            ...
                            <div class="gridwrap">
                                <asp:GridView runat="server" ID="grdPRList" AutoGenerateColumns="False" EmptyDataRowStyle-CssClass="emptytable"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <%-- <asp:ImageButton runat="server" ID="imbPRList" alt="" CssClass="itemlist" ToolTip="<%$Resources:ItemDetails %>"
                                                    OnClick="ActionHandler" CommandName="PRITEMDETAILS" />--%>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:ReqDate %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPoDate" runat="server" Text='<%# Eval("PRH_DATE") %>' ToolTip='<%# Eval("PRH_DATE", Resources.Constants.DateFormatGrid) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCmpny" CssClass="<%# Eval(Resources.DataFieldRes.CompnayLineColor) %>"
                                                    runat="server" Text='<%# Eval("CMP_DISPLAY_CODE") %>' ToolTip='<%# Eval("CMP_DISPLAY_CODE") %>'></asp:Label>
                                                <asp:HiddenField ID="hdfPohCategoryCode" runat="server" Value='<%# Eval("PRH_PO_CATEGORY_CODE") %>' />
                                                <asp:HiddenField ID="hdfPohCategoryText" runat="server" Value='<%# Eval("PRH_PO_CATEGORY_TEXT") %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="2%" />
                                            <HeaderStyle />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:RequestedDept %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblReqDept" runat="server" Text='<%# Eval("PRH_ISSUE_DEPT_TEXT") %>'
                                                    ToolTip='<%# Eval("PRH_ISSUE_DEPT_TEXT") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="11%" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Button ID="imgbtnPRHierarchyLevel" runat="server" OnClientClick="javascript:return false;"
                                                    TabIndex="10" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton runat="server" ID="imbDelete" ToolTip="<%$resources:ErpRes,Delete %>"
                                                    TabIndex="10" SkinID="imbdeletegrid" CommandName="DELETEPR" OnClientClick="return ShowDeleteConfirm(this);" />
                                                ...
                                                <asp:ImageButton runat="server" ID="imbPrint" ToolTip="<%$resources:ErpRes,Print %>"
                                                    TabIndex="10" SkinID="btnPrint" CommandName="PRINT" />
                                                ...
                                                <asp:ImageButton runat="server" ID="imbPRCancel" CommandName="CANCELPR" OnClientClick="return ShowDeleteConfirm(this,'Are you sure want to cancel this MR.?');"
                            ...
                            <%-- <h4>
                                Item Details</h4>--%>
                            <%--Secnd Division--%>
                            <div class="gridwrap hierarchical-wrap" style="display: none">
                                <cc1:ExtGridView runat="server" ID="grdPRItems" AutoGenerateColumns="False" OnRowDataBound="ActionHandler"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:PRQty %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPRQty" runat="server" Text='<%#GetFormattedNumberWithSeperation(Eval("PRD_QTY_REQUESTED")) +" "+Eval("PRD_UOM_TEXT") %>'
                                                    ToolTip='<%#GetFormattedNumberWithSeperation(Eval("PRD_QTY_REQUESTED")) +" "+Eval("PRD_UOM_TEXT") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                                            <HeaderStyle CssClass="rate-numeric" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:IssuedQty %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOQty" runat="server" Text='<%#GetFormattedNumberWithSeperation(Eval("PRD_QTY_ORDERED")) +" "+Eval("PRD_UOM_TEXT") %>'
                                                    ToolTip='<%#GetFormattedNumberWithSeperation(Eval("PRD_QTY_ORDERED")) +" "+Eval("PRD_UOM_TEXT") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" HorizontalAlign="Right" />
                                            <HeaderStyle CssClass="rate-numeric" />
                                        </asp:TemplateField>
                                                    ...
                                                    <cc1:ExtGridView runat="server" ID="grdPOList" AutoGenerateColumns="False" OnRowDataBound="ActionHandler"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="<%$ resources:PONo %>">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPONo" runat="server" Text='<%# Eval("POH_NO") %>' ToolTip='<%# Eval("POH_NO") %>'>
                                                                    </asp:Label>
                ...
                <asp:HiddenField ID="MaterialCategoryPK" runat="server" Value="0" />
