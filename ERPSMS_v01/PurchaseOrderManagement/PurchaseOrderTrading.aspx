<%@ Page Title="<%$ Resources:Captions,Title_PurchaseOrderTrading %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" Theme="ClassicExt" EnableEventValidation="false"  CodeBehind="PurchaseOrderTrading.aspx.cs" Inherits="ERPSMS_v01.PurchaseOrderManagement.PurchaseOrderTrading" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/PurchaseOrderManagement/PurchaseOrderTrading.js.axd"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-wrapper">
            ...
            <div id="tab1Content">
                ...
                <div id="divPendingPR">
                    <div class="div2col-S button-alignright">
                        ...
                        <asp:Button ID="btnDirectPO" runat="server" ToolTip="<%$resources:Controls,DirctPO %>" TabIndex="1"
                            Text="<%$ Resources:Controls, DirctPO%>" OnClientClick="javascript:return DirectPO();" />
                        <div class="clear">
                        </div>
                    </div>
                    <%-- <div class="div2col-S">
                            ...
                            <table rules="all" id="grdPendingPRList" grandtype="GrandGrid" paging="false" enablecheckbox="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th fieldmap="ITC_PO_ITEM_TYPE" isvisible="false">
                                        </th>
                                        <th fieldmap="PRH_COMPANY" isvisible="false">
                                        </th>
                                        <th fieldmap="PRH_DEPT" isvisible="false">
                                        </th>
                                        <%--<th fieldmap="PRD_UOM_TEXT" isvisible="false">
                                        </th>--%>
                                        <th fieldmap="ITV_PRICE" isvisible="false">
                                        </th>
                                        ...
                                        <th fieldmap="PRH_NO" align="left" sortable="true" width="90px">
                                            <%=Resources.Controls.PRNo%>
                                        </th>
                                        <th fieldmap="ITM_TEXT" isvisible="false">
                                        </th>
                                        <th fieldmap="PRH_COMPANY_TEXT" align="left" width="20px">
                                        </th>
                                        ...
                                        <th fieldmap="PRH_ISSUE_DEPT_TEXT" align="left" sortable="true" width="140px">
                                            <%=Resources.Controls.ReqDept%>
                                        </th>
                                        <th fieldmap="PRH_ISSUE_DEPT" isvisible="false">
                                        </th>
                                        ...
                                        <th fieldmap="PRD_SORT_DATE" isvisible="false" sortable="true">
                                        </th>
                                        <th fieldmap="PRD_DATE" align="left" sortable="true" width="60px">
                                        ...
                                        <th fieldmap="IO_NO" isvisible="false">
                                        </th>
                                    </tr>
                                </thead>
                            </table>
                            ...
                            <table rules="all" id="grdPOList" grandtype="GrandGrid" paging="false" width="100%"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th fieldmap="SLNO" align="center" width="20px">
                                            SN.
                                        </th>
                                        ...
                                        <th fieldmap="PRH_ISSUE_DEPT_TEXT" align="left" width="140px">
                                            <%=Resources.Controls.ReqDept%>
                                        </th>
                                        <th fieldmap="PRH_ISSUE_DEPT" isvisible="false">
                                        </th>
                                        <th fieldmap="PRD_ITEM_SPEC" align="left" width="109px">
                                            <%=Resources.Controls.Spec%>
                                        </th>
                                        ...
                                        <th fieldmap="PRD_UOM_TEXT" align="left" width="38px">
                                            <%=Resources.Controls.MaterialUOM%>
                                        </th>
                                        ...
                                        <th type="Template" width="45px">
                                            <div>
                                                <asp:ImageButton runat="server" ID="imbDeleteItem" ToolTip="<%$resources:ErpRes,Delete %>" TabIndex="7"
                                                    SkinID="imbdeletegrid" OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'DELETEITEM')" />
                                                <asp:ImageButton runat="server" ID="imbrateHistory" SkinID="history" ToolTip="<%$resources:ErpRes,ShowHistory %>" TabIndex="7"
                                                    OnClientClick="javascript:return GridMaterialAction($(this).parents('tr:eq(0)'),'HISTORY')" />
                                            </div>
                                        </th>
                                    </tr>
                                </thead>
            ...
            <div id="tab2Content">
                            ...
                            <tr>
                                <td>
                                    <div class="div2col-S">
                                        ...
                                        <div style="width: 18px; display: inline-block;">
                                            <asp:ImageButton ID="btnRevision" runat="server" OnClientClick="javascript:return RevisionHistory();" TabIndex="10"
                                        ...
                                        <asp:Label ID="Label1" runat="server" Text='<%$ Resources:ConfigurationsRes,POContrRef%>' CssClass="bg-none border0 lbl-25-1perc numeric"></asp:Label>
                                ...
                                <td>
                                    <div class="div2col-S">
                                        ...
                                        <label for="Type" class="middle-lbl-small-c">
                                        ...
                                        <%-- End PO Amendment Date--%>
                                          <div id="divRequestedDept">
                                            <label for="lblRequestedDept" class="margnrgt3">
                                                <%=Resources.Controls.RequestedDept%></label>
                        ...
                        <div class="div3col-Hi-Lbx">
                            <div class="title">
                                <label for="ShippingAddress" style="width: auto">
                                    ...
                                    <%=Resources.Controls.ShippingLocation%>
                                    *</label>
                ...
                <div id="divPOItems">
                    <div class="gridwrap grid-maxw1400">
                        ...
                        <table class="gridwraptable " id="tblPODetails">
                            <tr>
                            ...
                            <tr class="grd-rowhead">
                                ...
                                <td>
                                 ...
                                 <asp:DropDownList ID="POD_UOM" runat="server"  TabIndex="18" CssClass="medium">
                                    </asp:DropDownList>
                                </td>
                                <td>
                    ...
                    <div id="poDetails">
                        ...
                        <div class="gridwrap">
                            <table rules="all" id="grdPODetails" grandtype="GrandGrid" paging="false" editfunction="GridHandler" style="width:1248px;"
                                editable="true" class="gridwraptable gridwrap tablefixwidth-td">
                                <thead>
                                    <tr>
                                        <th fieldmap="POD_PK" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_PO" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_ITEM" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_RATE_UPDATE" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_UOM" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_SL_NO" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_CONV_FACT" isvisible="false">
                                        </th>
                                        <th fieldmap="POD_REASON" isvisible="false">
                                        </th>
                                        ...
                                        <th type="Template" width="70px" align="right" >
                                            <div style="margin-left:4px !important;">
                                                ...
                                                <asp:ImageButton runat="server" ID="imbDelete" ToolTip="<%$resources:ErpRes,Delete %>"
                                                    ...
                                                    TabIndex="26" />
                                            <asp:ImageButton runat="server" ID="imbrateHistoryPODetails" SkinID="history" TabIndex="26"  ToolTip="<%$resources:ErpRes,ShowHistory %>"
                                                    OnClientClick="javascript:return GridMaterialAction($(this).parents('tr:eq(0)'),'HISTORYPODETAILS')" />
                                            </div>
                                        </th>
                                    </tr>
                                </thead>
                        ...
                        <div class="gridwrap">
                            <table id="tblCalc" class="gridwraptable gridwrap">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img id="imgHeaderDiscount" onclick="javascript:AddItemHeaderDiscount();" alt="<%=Resources.Controls.Discounts%>"
                                            title="<%=Resources.Controls.Discounts%>" style="cursor: pointer" src="../Images/Classic/Icons/discount.png" />
                                    </td>
                                    <td style="text-align: left;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img id="imgHeaderTax" onclick="javascript:AddItemHeaderTax();" alt="<%=Resources.Controls.Taxes%>"
                                            title="<%=Resources.Controls.Taxes%>" style="cursor: pointer" src="../Images/Classic/Icons/tax.png" />
                                    </td>
                                    <td style="text-align: left;">
                ...
                <div id="divTerms">
                    ...
                    <div class="div3col-val">
                        <label for="GENERAL_TERMS">
                            <%=Resources.Controls.GeneralTerms%></label>
                        ...
                        <div class="scroll-h150" style="margin: 0">
                        <asp:TextBox runat="server" ID="txtTermText" TextMode="MultiLine" Height="80px" Width="380px"  EnableViewState="false" 
                                EnableTheming="false"></asp:TextBox>
                    ...
                    <div class="div3col-val">
                        ...
                        <asp:TextBox runat="server" ID="POH_COMMENTS" TextMode="MultiLine" EnableTheming="false"
                            Width="395px" Height="80px" TabIndex="33"></asp:TextBox>
                    </div>
                    <div class="clear">
                    </div>
                </div>
                 <h1 class="search-colapse-normal" id="h1ShortClose" style="display:none">
                    ...
                    <img id="imgShrtCloseShow" src="../Images/Classic/Icons/arrow-colapse-inactive.png"
                        ...
                        cursor: pointer" onclick="javascript:ShowShortClose();" />
                            ...
                            <table rules="all" id="grdTaxDetails" grandtype="GrandGrid" paging="false" width="100%"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th fieldmap="POT_TYPE" isvisible="false">
                                        </th>
                        ...
                        <table rules="all" id="grdRevisionHistory" grandtype="GrandGrid" paging="false" editable="false"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th fieldmap="POH_VERSION" isvisible="false">
                                    </th>
                ...
                <div id="divItemRate" title="<%=Resources.Captions.LineItemsRate%>">
                    ...
                    <div class="div2col-S">
                        ...
                        <div class="clear">
                         ...
                         <label for="ddlItemUOM" style="width: 130px">
                            <%=Resources.Controls.UOM%>
                        </label>
                        <asp:DropDownList ID="ddlItemUOMPopup" runat="server" TabIndex="18" CssClass="input-w90" onchange="ConvertQtyBasedOnUOM();">
                        </asp:DropDownList>
                        <div class="clear">
                        </div>
                        ...
                        <table rules="all" id="grdSelectedPurchaseRequest" grandtype="GrandGrid" paging="false"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th fieldmap="PRH_NO" width="30%">
                                        <%=Resources.Controls.PRNo%>
                                    </th>
                                    <th fieldmap="PRD_REQD_DATE" width="25%" align="center">
                                        <%=Resources.Controls.RequestDate%>
                                    </th>
                                    <th fieldmap="PRD_QTY_APPROVED" align="right" width="25%">
                                        <%=Resources.Controls.RequestQuantity%>
                                    </th>
                                    <th fieldmap="PRD_UOM_TEXT" align="left" width="20%">
                                        <%=Resources.Controls.UOM%>
                                    </th>
                                </tr>
                            </thead>
            ...
            <div class="content-wrapper">
                ...
                <div>
                    <table id="grdRateDetails" grandtype="GrandGrid" rules="all" paging="false" width="100%"
                        ...
                        <thead>
                            <tr>
                                <th fieldmap="VIH_VENDOR_TEXT" width="23%">
                                    <%=Resources.Controls.Vendor%>
                                </th>
                                <%--<th fieldmap="VIH_RATING" width="9%">
                                    <%=Resources.Controls.Rating%>
                                </th>--%>
                                <th fieldmap="VIH_LAST_QUOT_DATE" width="13%">
                                    <%=Resources.Controls.LastQuotedDate%>
                                </th>
                                <th fieldmap="VIH_LAST_QUOT_RATE" width="11%" align="right">
        ...
        <div id="divAmendPRDetails" title="<%=Resources.Captions.AmendPRQty%>" style="display: none">
            ...
            <div class="content-wrapper">
                <table rules="all" id="grdAmendPRDetails" grandtype="GrandGrid" paging="false" editable="false"
                    ...
                    <thead>
                        <tr>
                            <th fieldmap="POR_PK" isvisible="false">
                            </th>
                            <th fieldmap="POR_PR_DTL" isvisible="false">
                            </th>
                            <th fieldmap="POR_PO_DTL" isvisible="false">
                            </th>
                            <th fieldmap="POR_ITEM" isvisible="false">
                            </th>
        ...
        <asp:HiddenField runat="server" ID="hdfIsItemTaxForPurchase" Value="0" />
        <asp:HiddenField runat="server" ID="hdfIsItemDiscountPurchase" Value="0" />
        <asp:HiddenField runat="server" ID="hdfIsHeaderTaxForPurchase" Value="0" />
        <asp:HiddenField runat="server" ID="hdfIsHeaderDiscForPurchase" Value="0" />
        ...
        <asp:HiddenField ID="hdfRateHistoryGridHide" runat="server" Value="0" />
         <asp:HiddenField ID="hdfDefaultPOItemUOM" Value="0" runat="server" />
         <asp:HiddenField runat="server" ID="hdfCurrItemUomPKPopup" Value="0" />
         <asp:HiddenField runat="server" ID="hdfCurrItemPKPopup" Value="0" />
         <asp:HiddenField runat="server" ID="hdfCurrentItemPRqty" Value="0" />
          <%--  For New Workflow SP--%>
