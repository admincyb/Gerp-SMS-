...
{
    public partial class PurchaseOrderTrading : ERP.Store.UI.MyBasePage
    {
        #region properties
        private int CurrPK
        {
        ...
        /// </summary>
        private void PageActionHandler(int type)
        {
            ...
            APT_CODE.Value = ApplicationType.POT;
        ...
        private void ConfigurationSettings()
        {
            ...
            hdfDefaultPOItemUOM.Value = GetGlobalResourceObject("ConfigurationsRes", "DefaultPOItemUOM").ToString();
            ...
            hdfIsHeaderTaxForPurchase.Value = (GetGlobalResourceObject("ConfigurationsRes", "IsHeaderTaxForTradingPurchase")).ToString();
            hdfIsHeaderDiscForPurchase.Value = (GetGlobalResourceObject("ConfigurationsRes", "IsHeaderDiscountForTradingPurchase")).ToString();
            hdfIsItemTaxForPurchase.Value = (GetGlobalResourceObject("ConfigurationsRes", "IsItemwiseTaxForTradingPurchase")).ToString();
            hdfIsItemDiscountPurchase.Value = (GetGlobalResourceObject("ConfigurationsRes", "IsItemwiseDiscountForTradingPurchase")).ToString();            
            #endregion
        }

        private void FillInitialData(int type)
        {
            ...
            {
                FillPODetails(Convert.ToInt32(Request.QueryString["POID"]));
            }
            ...
            {
                GetUserRights();//Inside this function ,both hdfRateHistoryGridHide & hdfVerificationRequired values are setted .
        ...
        private void FillPODetails(int pOID)
        {
            if (pOID != 0)
            {
                PurchaseOrderList.Value = BusinessLogic.PurchaseOrderManagement.PurchaseOrderGeneration.GetPODetailsTrading(pOID);
                ...
                POrderTradingDetails ob = JsonConvert.DeserializeObject<POrderTradingDetails>(PurchaseOrderList.Value);
            ...
            else
            {
                if (Request.QueryString["PRefID"] != null)
                {
                    ...
                    if (dt.Rows.Count > 0)
                        FillPODetails(Convert.ToInt32(dt.Rows[0]["appPK"]));
                    else
                    {
                        SetPrimaryInfo();
                    }
        ...
        private string GetDOCMODE()
        {
            ...
            AppTypeDetailsList = cm.GetReportParameters(ApplicationType.POT, 0, DateTime.Now);
            ...
            try
            {
                ...
                switch (commonActions)
                {
                    ...
                    case ActionsEnum.ALERT:
                        ...
                        Response.Redirect(Resources.PageURL.AlertURL + ApplicationType.POT);
                        break;
                    #endregion
                    ...
                    case ActionsEnum.ALERTSAVE:
                        ...
                        if (hdfIsGoInbox.Value == "0")
                        {
                            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ClosePopup();ShowErrorMessage('" + saveMsg.Value
                                                + "','" + Resources.ErpRes.Information + "','" + Resources.PageURL.PurchaseOrderListTrading + "');", true);
                        }
                        else
                        {
                            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ClosePopup();ShowErrorMessage('" + saveMsg.Value
            ...
            try
            {
                switch (type)
                {
                    ...
                    case ControlsEnum.NOTIFICATIONDAYS:
                        ...
                        admAppConfigMstObj.ACF_DATA = ApplicationType.POT;
                        admAppConfigMstObj.ACF_ACTIVE = Convert.ToByte(ERP.Utilities.CommonConstants.ACTIVE);
                        admAppConstMstList = CommonServiceClient.GetAlertNotify(admAppConfigMstObj);
                        break;
                    #endregion
        ...
        private void GetUserRights()
        {
            ...
            UserRightsBO UserVerifyRights = userAuth.GetWorkFlowUserRightsInfo(currentUser.PKUser, pageURL, currentUser.CurrentDeptPK, ucrWrkf.RefID);
    ...
    public class POrderTradingDetails
    {
