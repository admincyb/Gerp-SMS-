<%@ Page Title="<%$ Resources:Captions,Title_PurchaseOrder %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" Theme="ClassicExt" CodeBehind="PurchaseOrderDetailListing.aspx.cs" Inherits="ERPSMS_v01.PurchaseOrderManagement.PurchaseOrderDetailListing" %>
<%@ Register Assembly="CustomControls" Namespace="CustomControls" TagPrefix="cc1" %>
<%@ Register Src="~/UserControls/PgerControlNew.ascx" TagName="PagerControl" TagPrefix="uc1" %>
<%@ Register Src="../UserControls/TransactionComments.ascx" TagName="TransactionComments"  TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            var poPageURL = "/PurchaseOrderManagement/PurchaseOrderGenerate.aspx"; //?TYPE=1";

             var prAutoCompleteURL = "PurchaseRequest.do?Action=GetSearchValue&AUTOSEARCH=1";

              prAutoCompleteURL += "&TYPE=" + $("[id$=POH_MENU_TYPE]").val();
            poAutoCompleteURL += "&TYPE=" + $("[id$=POH_MENU_TYPE]").val();
            poPageURL += "?TYPE=" + $("[id$=POH_MENU_TYPE]").val();

            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtVendor", poAutoCompleteURL + "&SearchType=VEN_NAME" + "&PageURL=" + poPageURL, "hdfVendor", true, true,3);
            ...
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtPONumber", poAutoCompleteURL + "&SearchType=POH_NO" + "&PageURL=" + poPageURL, "hdfPONumber", true, true, 4); 
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtInvNo", url, "hdfInvNo", true, true, 4, "INVCONVERTED");
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtReqDept", prAutoCompleteURL + "&SearchType=CON_NAME" + "&PageURL=" + poPageURL, "hdfReqDept", true, true, 4);
        ...
        //For show a warning msg "After shortclosing,this PO will not be available for further transaction"
        function ShowPONotAvailableFurtherContinue(val) {

            var msgTitle;
            var msg;
            msgTitle = '<%= Resources.ErpRes.Title_Information %>';
            msg = '<%= GetLocalResourceObject("Msg_Cont_ConfirmPONotAvailableFurther").ToString() %>';
            $("#divConfirmation").html(msg).dialog({
                ...
                buttons: {
                    Yes: function (e) {
                        $("[id$=hdfCheckNonStockPO]").val(0);
                        $(this).dialog("close");                      
                        $("[id$=btnAddConv]").click();                                            
                    },
                    No: function (e) {
                        $("[id$=hdfCheckNonStockPO]").val(1);
                        $(this).dialog("close");
                        return false;
                    }
                }
            ...
            <tr>
                <td>
                    <div class="div2col-S padgtop7">
                        ...
                        <asp:Label runat="server" ID="lblReqFor" Text="<%$ resources:Department %>" AssociatedControlID="txtReqFor"></asp:Label>
                      ...
                      <%----------------End PO type --------------------------%> 
                       <%-----------   Plant ----------------%>                          
                         <asp:Label runat="server" ID="lblPlantCode" Text="<%$ Resources:Controls,CompanyPlant%>" AssociatedControlID="ddlPlantCode" CssClass="middle-lbl-small-b" ></asp:Label>                                        
                ...
                <td>
                    <div class="div2col-S padgtop7">
                        ...
                        <asp:Label ID="lblInvNo" runat="server" Text="<%$ resources:InvoiceNumber %>" AssociatedControlID="txtInvNo" ></asp:Label>
                     ...
                     <asp:Label ID="lblReqDept" runat="server" Text="<%$ resources:ReqDept %>" CssClass="req-label" AssociatedControlID="txtReqDept" ></asp:Label>
                        <asp:TextBox ID="txtReqDept" runat="server" MaxLength="100" TabIndex="8" CssClass="input-small margnbotm0"> </asp:TextBox>
                        <asp:HiddenField ID="hdfReqDept" runat="server" Value="" />
                        ...
                        <asp:ImageButton ID="btnClear" runat="server" TabIndex="12" Style="margin-bottom: 0px!important;
                          ...
                          <div class="clear">
                            ...
                            <div class="gridwrap hierarchical-wrap">
                                 <asp:GridView runat="server" ID="grdPOList" AutoGenerateColumns="False"  EmptyDataRowStyle-CssClass="emptytable"   Width="100%" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>                                                
                                                <asp:ImageButton runat="server" ID="imbPOList" CssClass="itemlist"  ToolTip="<%$Resources:ItemDetails %>" OnClick="ActionHandler" CommandName="POITEMDETAILS" alt="" />                                               
                                                ...
                                                <asp:HiddenField runat="server" ID="hdfPohIsCommentExist" Value='<%# Eval("POH_IS_CMNT_EXISTS") %>' />  
                                                 ...
                                                 <asp:HiddenField runat="server" ID="hdfisConvertedPO" Value='<%# Eval("POH_CONVERTED") %>' /> 
                                                 <asp:HiddenField runat="server" ID="hdfGRNExist" Value='<%# Eval("POH_GRN_EXISTS") %>' /> 
                                            </ItemTemplate>
                                            <ItemStyle Width="2%" />
                                        </asp:TemplateField>                                        
                                        <asp:TemplateField HeaderText="<%$ resources:PODate %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPoDate" runat="server" Text='<%# Eval("POH_DATE") %>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Creator %>">
                                            <ItemTemplate>                                                 
                                                    <asp:Label ID="lblCreator"  runat="server" Text='<%# Eval("POH_EMPLOYEE") %>' ToolTip='<%# Eval("POH_EMPLOYEE") %>'></asp:Label>                                              
                                            </ItemTemplate>
                                            <ItemStyle Width="5%" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="<%$ resources:IONumber %>" Visible="<%$ resources:IsIONumber %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIONumber" runat="server" Text='<%# Eval("SOH_NO") %>' ToolTip='<%# Eval("SOH_CUSTOMER_NAME") %>'></asp:Label>                                                
                                            </ItemTemplate>
                                            <ItemStyle Width="12%" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>  
                                       <asp:TemplateField HeaderText="<%$ resources:RefNumber %>">
                                            <ItemTemplate>                                                 
                                                    <asp:Label ID="lblRefNo"  runat="server" Text='<%# Eval("SOH_REFERENCE") %>' ToolTip='<%# Eval("SOH_REFERENCE") %>'></asp:Label>                                              
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCmpny"  CssClass="<%# Eval(Resources.DataFieldRes.CompnayLineColor) %>" runat="server" Text='<%# Eval("CMP_DISPLAY_CODE_TEXT") %>'
                                                    ToolTip='<%# Eval("CMP_DISPLAY_CODE_TEXT") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="2%" />
                                            <HeaderStyle />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Vendor %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblVendorCode" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval("VEN_NAME"),18) %>' ToolTip='<%# Eval("VEN_NAME") %>'></asp:Label>                                                
                                            </ItemTemplate>
                                            <ItemStyle Width="14%" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:ItemDetails %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblItem" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval("POH_ITEM_TEXT"),30) %>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Department %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblReqFor" runat="server" Text='<%# Eval("DPT_NAME") %>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:InvoiceNumber %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblInvoices" runat="server" Text='<%# Eval("POH_CONV_INV_NO") %>'  ToolTip='<%# Eval("POH_CONV_INV_NO") %>'></asp:Label>                                               
                                            </ItemTemplate>
                                            <ItemStyle Width="2%" />
                                            <HeaderStyle HorizontalAlign="Left" />
                                        </asp:TemplateField> 
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton runat="server" TabIndex="14" ID="imbShortClose" CommandName="SHORTCLOSE"  OnClientClick="return ShowDeleteConfirm(this,'Are you sure want to close this PO.?');"
                                ...
                                <cc1:ExtGridView runat="server" ID="grdPOItems" AutoGenerateColumns="False" OnRowDataBound="ActionHandler"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:POQty %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPOQty" runat="server" Text='<%#GetFormattedNumberWithSeperation(Eval("POD_QTY_ORDERED")) +" "+Eval("PRD_UOM_TEXT") %>' ToolTip='<%#GetFormattedNumberWithSeperation(Eval("POD_QTY_ORDERED")) +" "+Eval("PRD_UOM_TEXT") %>'></asp:Label>
                                            </ItemTemplate>
                                                                                              ...
                                                                                              <Columns>
                                                                                                    <asp:TemplateField HeaderText="<%$ resources:GinNo %>">
                                                                                                        <ItemTemplate>
                                                                                                            ...
                                                                                                            <asp:LinkButton ID="lnkGinNo" CssClass="text-underline" runat="server" Text='<%# Eval("GIH_NO") %>' OnClick="ActionHandler" 
                                                                                                                 CommandName="PRINTGIN" CommandArgument='<%# Eval("GIH_PK") %>' ToolTip='<%# Eval("GIH_NO") %>'></asp:LinkButton>
                                                                                                                    ...
                                                                                                                    <Columns>
                                                                                                                        <asp:TemplateField HeaderText="<%$ resources:STNumber %>">
                                                                                                                            <ItemTemplate>
                                                                                                                                ...
                                                                                                                                <asp:LinkButton ID="lnkStNumber" CssClass="text-underline" runat="server" Text='<%# Eval("SFH_NO") %>' OnClick="ActionHandler" 
                                                                                                                                     CommandName="PRINTSA" CommandArgument='<%# Eval("SFH_PK") %>' ToolTip='<%# Eval("SFH_NO") %>'></asp:LinkButton>
            ...
            <div class="divcolmiddle-S">
               ...
               <%-- End Shortclose region -----------------%>
                ...
                <asp:HiddenField runat="server" ID="POH_MENU_TYPE" Value="1" />
                 ...
                 <asp:HiddenField ID="hdfGRNExistForShortClose" runat="server" Value="0" />
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
