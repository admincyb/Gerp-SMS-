<%@ Page Title="<%$ Resources:Captions,Title_POExpInvTrading %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" Theme="ClassicExt" CodeBehind="ExpensesTrading.aspx.cs" Inherits="ERPSMS_v01.POInvoicing.ExpensesTrading" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            GrandScriptUtils.MakeAutoCompleteDDL("txtExpenseNumber", url  +"?InvCategory=1&InvGroup=" + $("[id$=hdfgroup]").val(), "hdfExpenseNumberPK", true, true, "GETDIRECTINVOICENOAUTO");
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="div2col-S">
                                                                ...
                                                                <asp:DropDownList ID="ddlAddressType" runat="server" OnSelectedIndexChanged="ActionHandler"
                                                                    AutoPostBack="true" CssClass="select-small" Visible="false">
                                                                </asp:DropDownList>
                                                                ...
                                                                <asp:TextBox ID="txtAddressType" runat="server" MaxLength="100" TabIndex="12" Width="200"
                                                        ...
                                                        <td>
                                                            <div class="div2col-S">
                                                                ...
                                                                <asp:TextBox ID="txtVendorDtl" runat="server" MaxLength="100" TabIndex="11" onchange="Bindtaxid();"
