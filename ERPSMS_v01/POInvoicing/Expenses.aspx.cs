...
{
    public partial class Expenses : ERP.Store.UI.WorkFlowBasePage
    {
                ...
                switch (type)
                {
                    ...
                    case ControlsEnum.EXPENSELIST:
                        ...
                        dsPageData = BusinessLogic.POInvoicing.POInvoiceBL.GetPOInvoiceList(
                            ...
                            , Convert.ToInt32(ddlStatus.SelectedValue), group: (byte)POInvoiceGroup.Expense, category: 0, pending: null, grnNo: null, due: null, cmpPk: CompanyPK);
                    ...
                    case ControlsEnum.JOURNALIZE:
                        ...
                        if (bIsChecked)
                        {
                            if (Approved == 2)
                            {
                                ...
                                Session[ERP.Utilities.SessionStrings.JournalType] = ApplicationType.EIJ;
        ...
        private void SaveTransaction(POInvoiceHeader objExpence, int workflowFlag)
        {
            ...
            objExpence.ATL_APP_TYPE = ApplicationType.EI;
            objExpence.APT_CODE = ApplicationType.EI;
            #endregion
