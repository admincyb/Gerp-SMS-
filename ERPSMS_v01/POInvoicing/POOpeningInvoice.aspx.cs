...
{
    public partial class POOpeningInvoice : ERP.Store.UI.WorkFlowBasePage
    {
        ...
        private void PageActionHandler()
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (CurrPK == 0 && Session[ERP.Utilities.SessionStrings.InvoicePK] != null)
                    {
                        CurrPK = Session[ERP.Utilities.SessionStrings.InvoicePK] == null ? 0 : Convert.ToInt32(Session[ERP.Utilities.SessionStrings.InvoicePK].ToString());
                        Session[ERP.Utilities.SessionStrings.InvoicePK] = null;
                        if (CurrPK > 0)
                        {
                    ...
                    else
                    {
                        ...
                        btnNew.CommandName = ActionsEnum.NEW.ToString();
                        ActionHandler(btnNew, new EventArgs());
                    }
                    AST_DOC_MODE.Value = GetDOCMODE();
                    AST_CODE.Value = ApplicationType.EI;
                    lblExpenseNo.Text = hdfExpenseNo.Value == string.Empty ? "[NEW]" : hdfExpenseNo.Value;

                    hdfAppType.Value = ApplicationType.EI;
        ...
        private void GetFieldValues(ControlsEnum type)
        {
            ...
            try
            {
                switch (type)
                {
                    ...
                    //TempConfigMstDetails = cm.GetConfigValues(admConfigMstObj).Where(vcl => Values.Contains(vcl.CFG_VALUE)).ToList();
                    //    break;
                    //#endregion
                    ...
                    case ControlsEnum.EXPENSELIST:
                        ...
                        dsPageData = BusinessLogic.POInvoicing.POInvoiceBL.GetPOInvoiceList(
                            ...
                            , Convert.ToInt32(ddlStatus.SelectedValue), group: (byte)POInvoiceGroup.Goods, category: 0);
                ...
                switch (controlType)
                {
                    ...
                    case ControlsEnum.EXPENSEHEADER:
                        if (ExpenseHeaderSession != null)
                        {
                            ...
                            expenseHeaderObj.IVH_GROUP = (byte)POInvoiceGroup.Goods;
                            ...
                            expenseHeaderObj.IVH_EXCHG_RATE = string.IsNullOrEmpty(hdfExchangeRate.Value) ? 1 : Convert.ToDouble(hdfExchangeRate.Value);
                            ...
                            expenseHeaderObj.APT_CODE = ApplicationType.EI;
                            ...
                            expenseHeaderObj.IVH_IS_OPENING = 1;
                            expenseHeaderObj.IVH_VENDOR_NAME = HttpUtility.HtmlEncode(txtVendor.Text);
                            //Uploads
                    ...
                    case ControlsEnum.JOURNALIZE:
                        ...
                        //{
                            if (Approved == 2)
                            {
                                ...
                                Session[ERP.Utilities.SessionStrings.JournalType] = ApplicationType.PIJ;
                                ...
                                Session[ERP.Utilities.SessionStrings.JournalMode] = (EntryStatus == EntryStatus.ENTRYMODE || EntryStatus == EntryStatus.NEWMODE) ? EntryStatus.ENTRYMODE : EntryStatus.VIEWMODE;
        ...
        private void FillProcessID(int pid)
        {
            ...
            if (pid == 2)
            {
                path = GetLocalResourceObject("PIJPath").ToString().ToLower();
            }
            ...
            try
            {
                ...
                switch (commonActions)
                {
                        ...
                        else
                        {
                            ...
                            if (expenseHeaderObj != null && expenseHeaderObj.OrderDetail != null)
                            {
                                ...
                                if (result > 0) // Success !  redirect to listing page
                                {
                                    ...
                                    litErrorMsg.Text = string.Format(litErrorMsg.Text, GetLocalResourceObject("ExpenseInvoice").ToString());//Resources.PageNameRes.POOpeningInvoice
                                    ...
                                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ShowErrorMessage('" + litErrorMsg.Text + "','" + Resources.Messages.Information + "','" +
                                       Page.ResolveClientUrl(Resources.PageURL.PurchaseOrderInvoicing) + "');", true);
                                }
                                else
                                {
                                    ...
                                    {
                                        litErrorMsg.Text = Resources.PageNameRes.POOpeningInvoice + " " + GetLocalResourceObject("RefNoExist").ToString();
                                    ...
                                    {
                                        litErrorMsg.Text = Resources.Messages.ActionFailedPleaseTryAgain;
                                        litErrorMsg.Text = string.Format(litErrorMsg.Text, Resources.PageNameRes.POOpeningInvoice);
                                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ShowErrorMessage('" + litErrorMsg.Text
                                            + "','" + Resources.ErpRes.Information + "');", true);
                                    }
                                }
                    ...
                    case ActionsEnum.PAYMENT:
                        //Session[ERP.Utilities.SessionStrings.ExpensePayment] = true;
                    ...
                    case ActionsEnum.DELETE:
                        ...
                        {
                            result = 0;
                            result = BusinessLogic.POInvoicing.POInvoiceBL.DeletePOInvoiceDetails(CurrPK, LastModifiedTime, ApplicationType.EI, currentUser.PKUser.ToString());
                            ...
                            else
                            {
                                ...
                                {
                                    litErrorMsg.Text = Resources.PageNameRes.POOpeningInvoice + " " + Resources.Messages.UsedInAnotherPlace;
                                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ShowErrorMessage('" + CommonFunctions.FormatErrorMessage(litErrorMsg.Text)
                                    + "','" + Resources.ErpRes.Information + "');", true);
                                }
                                else if (result == (int)DbDeleteStatus.DELETECONCURRENCY)
                                {
                                    litErrorMsg.Text = Resources.PageNameRes.POOpeningInvoice + " " + Resources.Messages.AlreadyDeleted;
                                    ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ShowErrorMessage('" + CommonFunctions.FormatErrorMessage(litErrorMsg.Text)
                                        + "','" + Resources.ErpRes.Information + "');", true);
                                    ////EntryStatus = EntryStatus.LISTMODE;
                                    ////ResetForm(ControlsEnum.EXPENSELIST);
                        ...
                        else//valid
                        {
                            ...
                            if (hdfIsSaveSubmit.Value == CommonConstants.SELECT_VALUE_ONE)
                            {
                                ...
                                if (hdfExchangeRate.Value != "-1")
                                {
                                    ...
                                    if (expenseHeaderObj != null && expenseHeaderObj.OrderDetail != null)
                                    {
                                        string xmlDoc = CommonFunctions.XmlSerialize<POInvoiceHeader>(expenseHeaderObj);//CommonFunctions.ObjectTOXml(rfqResponseHeaderObj);
                                        // save Process Control inspection details
                                        result = BusinessLogic.POInvoicing.POInvoiceBL.SavePOInvoiceHeader(xmlDoc);
                            ...
                            if (ucrWrkf.ApplicationID > 0)
                            {
                                ...
                                if (ddlWkfAction.Items.Count > 0)
                                {
                                    ...
                                    if (result.HasValue && result.Value > 0)
                                    {
                                        ...
                                        GetFieldValues(ControlsEnum.EXPENSEHEADER);
                                        if (expenseHeaderObj != null)
                                            lblExpenseNo.Text = expenseHeaderObj.IVH_NO;
                                        object[] args = new object[2];
                                        args[0] = GetLocalResourceObject("ExpenseInvoice").ToString(); //Resources.PageNameRes.POOpeningInvoice;
                                        args[1] = lblExpenseNo.Text.Trim() == "[NEW]" ? "" : lblExpenseNo.Text;
                                        ...
                                        AdmTrxLogDet.ATL_APP_TRX_CODE = expenseHeaderObj.IVH_NO;
                                        AdmTrxLogDet.ATL_APP_TYPE = ApplicationType.EI;
                                        AdmTrxLogDet.ATL_MOD_BY = expenseHeaderObj.USER_PK;
                                        AdmTrxLogDet.ATL_MOD_DT = DateTime.Now;
                                        AdmTrxLogDet.ATL_BIZUNIT = expenseHeaderObj.IVH_BIZUNIT;
                                        AdmTrxLogDet.ATL_APP_TRX_PK = expenseHeaderObj.IVH_PK;
                    ...
                    case ActionsEnum.ALERT:
                        ucrAlert.TypeCode = ApplicationType.EI;
                    ...
                    case ActionsEnum.PRINT:
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "Openwindow", "OpenPDF('" + Page.ResolveClientUrl(Resources.PageURL.ReportUrl + "?ID=" + CurrPK.ToString() + "&APPTYPE=" + ApplicationType.EI + "&APPSUBTYPE=") + "');", true);
                        break;
                    #endregion
                    #region PRINTLISTING
                    case ActionsEnum.PRINTLISTING:
                        ...
                        foreach (GridViewRow grdrow in grdExpenseList.Rows)
                        {
                            ...
                            if (chkInvselect.Checked)
                            {
                                ...
                                {
                                    if (Convert.ToInt32(hdfType.Value) == (int)POInvoiceGroup.Goods)
                                    {
        ...
        /// <summary>
        /// Redirect to purchase invoice list page
        /// </summary>
        private void RedirectToInvoice()
        {
            Response.Redirect(Resources.PageURL.PurchaseOrderInvoicing);
        }
