<%@ Page Title="<%$ Resources:Captions,Title_POExpInv %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" Theme="ClassicExt" CodeBehind="Expenses.aspx.cs" Inherits="ERPSMS_v01.POInvoicing.Expenses"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            GrandScriptUtils.MakeAutoCompleteDDL("txtVendorSch", url + "?IsSBUVendor=" + $("[id$='hdfIsSBUVendor']").val(), "hdfVendorSch", true, true, "PARTY");
            GrandScriptUtils.MakeAutoCompleteDDL("txtVendor", url+ "?IsSBUVendor=" + $("[id$='hdfIsSBUVendor']").val(), "hdfVendor", true, true, "PARTY");
            ...
            <div class="fixed-buttons">
                ...
                <div class="tab-container" id="divTabContainer" runat="server">
                    <ul id="tab-menu">
                        ...
                        <li><span id="spnExpenses" runat="server" class="tab-active" visible="<%$ resources:ConfigurationsRes,TabShowExpense %>">
                ...
                <asp:Table runat="server" ID="tblTemplate" CssClass="tablelayout asptbllinks">
                                ...
                                <tr id="Tr1" runat="server">
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            ...
                                            <asp:Label ID="lblToDate" runat="server" Text="<%$resources:ToDate %>" CssClass="middle-lbl-small-c-20-11-3"
                    ...
                    <asp:TableRow ID="PageAction_Entry" runat="server" Style="display: none">
                        <asp:TableCell>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:RequiredFieldValidator ID="vrfVendorInvNO" CssClass="star" SetFocusOnError="true"
                                                ...
                                                Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_VendorRef %>">
                                            </asp:RequiredFieldValidator>
                                            <div class="clear">
                                            </div>
                                            <%--Start--%>
                                            ...
                                            &nbsp&nbsp
                                            <asp:Label runat="server" ID="lblHdrchkBH" Text="<%$ resources:HO%>" CssClass="middle-lbl-xsmall-a1-22-12"
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:TextBox ID="txtVendor" runat="server" MaxLength="100" TabIndex="3" CssClass="input-half-20-11-4"> </asp:TextBox>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="div2col-S">
                                             <asp:Label ID="lblCompanyView" Visible="true"  runat="server" Text="<%$ resources:Controls, CompanyPlant %>"  AssociatedControlID="ddlCompanyView" CssClass="lbl-12-5perc"></asp:Label>
                                            <asp:DropDownList ID="ddlCompanyView" Visible="true"  Enabled="false"  runat="server" CssClass="input-w13-8per-20-11-3"  >
                                            </asp:DropDownList>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <div class="gridwrap" style="width: 100%; overflow: auto; max-width: 100%;">
                                <asp:GridView ID="grdItemDetails" runat="server" AutoGenerateColumns="False" PageSize="<%$ resources:PageSize %>"
                                    ...
                                    TabIndex="22" ShowFooter="true" OnRowDataBound="ActionHandler" Width="1700px">
                                    <EmptyDataTemplate>
