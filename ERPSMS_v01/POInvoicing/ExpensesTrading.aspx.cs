...
{
    public partial class ExpensesTrading : ERP.Store.UI.WorkFlowBasePage
    {
        ...
        private void PageActionHandler()
        {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    #region Grid DataKeyNames Settings
                    string[] datakeyarray;
                    ...
                    #region Currency,Number,Rate Format Settings
            ...
            try
            {
                switch (type)
                {
                    ...
                    case ControlsEnum.EXPENSEHEADER:
                        expenseHeaderObj = BusinessLogic.POInvoicing.POInvoiceBL.GetPOInvoiceTradingHeader(0, CurrPK);
                    ...
                    case ControlsEnum.INVOICEGET:
                        ...
                        dsPageData = BusinessLogic.POInvoicing.POInvoiceBL.GetPOInvoiceList(
                            ...
                            , statusfilter, group: (byte)POInvoiceGroup.Expense, category: 0);                        
                        if (dsPageData != null)
                        {                           
                    ...
                    case ControlsEnum.EXPENSELIST:
                        ...
                        dsPageData = BusinessLogic.POInvoicing.POInvoiceBL.GetPOInvoiceTradingList(
                            ...
                            }, currentUser, cusID, InvPk, 0, customer, string.Empty, Resources.PageURL.ExpenseInvoiceTrading.Replace("~", ""), 0
                            , Convert.ToInt32(ddlStatus.SelectedValue), group: (byte)POInvoiceGroup.Expense, category: 1);
        ...
        private string GetDOCMODE()
        {
            ...
            AppTypeDetailsList = cm.GetReportParameters(ApplicationType.EIT, 0, DateTime.Now);
                ...
                switch (controlType)
                {
                    ...
                    case ControlsEnum.EXPENSEHEADER:
                        if (ExpenseHeaderSession != null)
                        {
                            ...
                            expenseHeaderObj.IVH_GROUP = (byte)POInvoiceGroup.Expense;
                            ...
                            expenseHeaderObj.APT_CODE = ApplicationType.EIT;
                    ...
                    case ControlsEnum.JOURNALIZE:                       
                        ...
                        if (bIsChecked)
                        {
                            if (Approved == 2)
                            {
                                ...
                                Session[ERP.Utilities.SessionStrings.JournalType] = ApplicationType.EITJ;
            ...
            try
            {
                ...
                switch (commonActions)
                {
                        ...
                        else
                        {
                            ...
                            if (expenseHeaderObj != null && expenseHeaderObj.OrderDetail != null)
                            {
                                ...
                                if (result > 0) // Success !  redirect to listing page
                                {
                                    ...
                                    litErrorMsg.Text = string.Format(litErrorMsg.Text, GetLocalResourceObject("ExpenseInvoice").ToString());//Resources.PageNameRes.Expenses
                                ...
                                else
                                {
                                    ...
                                    else if (result == -9)//--Payment Entry Exists
                                    {
                                        litErrorMsg.Text = GetLocalResourceObject("Err_Modify_PaymentEntry").ToString();
                                    ...
                                    else if (result == -10)//Invoice has Voucher Entry
                                    {
                                        litErrorMsg.Text = GetLocalResourceObject("Err_Modify_VoucherEntry").ToString();
                                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "ShowErrorMsg", "ShowErrorMessage('" + CommonFunctions.FormatErrorMessage(litErrorMsg.Text) + "','" + Resources.ErpRes.Information + "','" + "');", true);
                                    }
                                    else
                                    {
                    ...
                    case ActionsEnum.TAXDETAILS:
                        ...
                        {
                            if (TempExpenseHeaderSession.TaxHdr != null && TempExpenseHeaderSession.TaxHdr.Where(r => r.VTL_TAX_CATEGORY == (int)TaxType.Tax).Count() > 0)
                            {
                    ...
                    case ActionsEnum.DISCDETAILS:
                        ...
                        else//valid
                        {
                            ...
                            if (TempExpenseHeaderSession.TaxHdr != null && TempExpenseHeaderSession.TaxHdr.Where(r => r.VTL_TAX_CATEGORY == (int)TaxType.Discount).Count() > 0)
                            {
                    ...
                    case ActionsEnum.TAXHEADER:
                        hdfTaxCategory.Value = ((int)TaxType.Tax).ToString();
                        hdfTaxFormula.Value = string.Empty;
                        if (ExpenseHeaderSession != null && ExpenseHeaderSession.OrderDetail != null)
                        {
                            foreach (POInvoiceDetails item in ExpenseHeaderSession.OrderDetail)
                            {
                                if (item.TaxDtl != null)
                                {
                                    if (item.TaxDtl.Where(t => t.VTL_TAX_CATEGORY == (int)TaxType.Tax).Count() > 0)
                                    {
                    ...
                    case ActionsEnum.DISCHEADER:
                        ...
                        {                           
                            foreach (POInvoiceDetails item in ExpenseHeaderSession.OrderDetail)
                            {
                                if (item.TaxDtl != null)
                                {
                                    if (item.TaxDtl.Where(t => t.VTL_TAX_CATEGORY == (int)TaxType.Discount).Count() > 0)
                                    {
                    ...
                    case ActionsEnum.DELETE:
                        ...
                        {
                            result = 0;
                            result = BusinessLogic.POInvoicing.POInvoiceBL.DeletePOInvoiceTradingDetails(CurrPK, LastModifiedTime, ApplicationType.EIT, currentUser.PKUser.ToString());
                    ...
                    case ActionsEnum.WRKFSUBMIT:
                        ...
                        else//valid
                        {
                            ...
                            {
                                if (BusinessLogic.CommonManagement.CommonBL.ValidationForCancellation((int)CurrPK, ApplicationType.EIT))
                                {
                    ...
                    case ActionsEnum.ALERT:
                        ucrAlert.TypeCode = ApplicationType.EIT;
                    ...
                    case ActionsEnum.PRINT:
                        ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "Openwindow", "OpenPDF('" + Page.ResolveClientUrl(Resources.PageURL.ReportUrl + "?ID=" + CurrPK.ToString() + "&APPTYPE=" + ApplicationType.EIT + "&APPSUBTYPE=") + "');", true);
                        break;
                    #endregion
                    #region PRINTLISTING
                    case ActionsEnum.PRINTLISTING:
                        ...
                        foreach (GridViewRow grdrow in grdExpenseList.Rows)
                        {
                            ...
                            if (chkInvselect.Checked)
                            {
                                ...
                                {
                                    if (Convert.ToInt32(hdfType.Value) == (int)POInvoiceGroup.Expense)
                                    {
        ...
        private void SaveTransaction(POInvoiceHeader objExpence, int workflowFlag)
        {
            ...
            objExpence.ATL_APP_TYPE = ApplicationType.EIT;
            objExpence.APT_CODE = ApplicationType.EIT;
            #endregion
            ...
            if (result.HasValue && result.Value > 0) // Success !  redirect to listing page
            {
                ...
                if (result.HasValue && result.Value > 0)
                {
                    ...
                    args[0] = GetLocalResourceObject("ExpenseInvoice").ToString(); //Resources.PageNameRes.Expenses;
        ...
        protected void Page_PreRender(Object sender, EventArgs e)
        {
            try
            {              
                hdfgroup.Value = Convert.ToByte((byte)POInvoiceGroup.Expense).ToString();
                if (ExpenseHeaderSession != null)
                {
