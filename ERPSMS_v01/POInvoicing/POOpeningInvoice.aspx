<%@ Page Title="<%$ Resources:Captions,Title_POOpeningInv %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" Theme="ClassicExt" CodeBehind="POOpeningInvoice.aspx.cs" Inherits="ERPSMS_v01.POInvoicing.POOpeningInvoice"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            GrandScriptUtils.MakeAutoCompleteDDL("txtVendorSch", url, "hdfVendorSch", true, true, "VENDOR");
            GrandScriptUtils.MakeAutoCompleteDDL("txtVendor", url + "?IsSBUVendor=" + $("[id$='hdfIsSBUVendor']").val(), "hdfVendor", true, true, "VENDOR");
           
            GrandScriptUtils.MakeAutoCompleteDDL("txtVendorDtl", url, "hdfVendorDtl", true, false, "VENDOR");
        ...
        function CalculateDueDate() {
            ...
            var vendDate = $.datepicker.parseDate("dd-M-yy", $("[id$=txtExpenseDate]").val());
        ...
        function AfterDateSelect(controlID) {
            ...
            else if (controlID == "txtExpenseDate" && $("[id$=hdfHasTax]").val() != "0") {
        ...
        <ContentTemplate>
            <div class="fixed-buttons">
                ...
                <div class="tab-container" id="divTabContainer" runat="server">
                    <ul id="tab-menu">
                        <li style="display:none;"><span id="spnPOListing" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lbnPOListing" Text="<%$resources:PageNameRes,PurchaseOrder %>"
                                ...
                                TabIndex="1" CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        ...
                        <li style="display:none;"><span id="spnInvoicing" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lnkInvoicing" Text="<%$resources:PageNameRes,Invoice %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="1" OnClick="ActionHandler" CommandName="INVOICE"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li ><span id="spnPOInvoice" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lbnPOInvoice" Text="<%$resources:PageNameRes,POInvoice %>"
                                TabIndex="1" OnClick="ActionHandler" CommandArgument="SEC_ActionPanel" CommandName="POINVOICE"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li><span id="spnExpenses" runat="server" class="tab-active">
                            <asp:LinkButton runat="server" ID="lbnExpenses" Text="<%$resources:PageNameRes,POOpeningInvoice %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="1" OnClick="ActionHandler" CommandName="EXPENSES"
                                CssClass="tab-active"></asp:LinkButton>
                        </span></li>
                        <li style="display:none;"><span id="spnPayment" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lnkPayment" Text="<%$resources:PageNameRes,Payment %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="1" OnClick="ActionHandler" CommandName="PAYMENT"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li style="display:none;"><span id="spnCrDrNote" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lnbCrDrNote" Text="<%$resources:PageNameRes,CreditDebitNotes %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="1" OnClick="ActionHandler" CommandName="CRDRNOTE"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li style="display:none;"><span id="spnAcPayables" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lnbAcPayables" Text="<%$resources:PageNameRes,AccountPayables %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="1" OnClick="ActionHandler" CommandName="ACPAYABLES"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                    ...
                    <ul>
                        ...
                        <li>
                            <asp:LinkButton runat="server" ID="lnkDetail" Text="<%$resources:PageNameRes,Detail %>"
                                ...
                                CssClass="tab-inactive" ></asp:LinkButton><%--OnClientClick="javascript:return SelectedCheckBoxCount(1);"--%>
                        </li>
                    </ul>
                </div>
                                ...
                                <tr id="Tr1" runat="server">
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            ...
                                            <asp:TextBox ID="txtFromDate" runat="server" TabIndex="47" CssClass="input-small" MaxLength="11"
                                                onkeydown="return CheckKey(event)" onpaste="return false;"> </asp:TextBox>
                                            <asp:HiddenField ID="hdfFromDate" runat="server" Value="" />
                                              <asp:Label ID="lblToDate" runat="server" Text="<%$resources:ToDate %>"  CssClass="middle-lbl-small-c" AssociatedControlID="txtToDate"></asp:Label>
                                    ...
                                    <td>
                                        <div class="div2col-S div-separatn">
                                           <asp:Label ID="lblVendorSch" runat="server" Text="<%$resources:Vendor %>" AssociatedControlID="txtVendorSch"></asp:Label>
                                            <asp:TextBox ID="txtVendorSch" runat="server" CssClass="select-half margnbotm0" MaxLength="100" TabIndex="50"> </asp:TextBox>
                                    ...
                                    <td>
                                        <div class="div2col-S div-separatn">
                                         <asp:Label ID="lblExpenseNumber" runat="server" Text="<%$resources:ExpenseNo %>" 
                                            ...
                                            <asp:TextBox ID="txtExpenseNumber" runat="server" CssClass="select-small-c1 margnbotm0" MaxLength="100"
                                                TabIndex="51"> </asp:TextBox>
                                            <asp:HiddenField ID="hdfExpenseNumberPK" runat="server" Value="" />
                                          
                                            <asp:Label ID="lblSearch" runat="server" CssClass="middle-lbl-xsmall-d style-none margnbotm0" AssociatedControlID="btnSearch"></asp:Label>
                                            <asp:ImageButton ID="btnSearch" runat="server" ToolTip="<%$ resources:Controls,Search %>" OnClick="ActionHandler" TabIndex="52" CssClass="margntop2 margnbotm0"
                                                CommandName="SEARCH" SkinID="search-ext"/>
                                            <asp:ImageButton ID="btnClear" runat="server" ToolTip="<%$ resources:Controls,Clear %>"
                                                TabIndex="53" OnClick="ActionHandler" CommandName="CLEAR" SkinID="clear-ext" CssClass="margntop2 margnbotm0"/>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div class="gridwrap">
                                <asp:GridView runat="server" ID="grdExpenseList" Width="100%" PageSize="<%$ resources:PageSize%>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:InvDate %>" SortExpression="IVH_POH_DT">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSoDate" runat="server" Text='<%# Eval("IVH_DATE", Resources.Constants.DateFormatGrid) %>'
                                                    ToolTip='<%# Eval("IVH_DATE", Resources.Constants.DateFormatGrid)%>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Wrap="false" />
                                            <ItemStyle Width="8%" Wrap="false" />
                        ...
                        <asp:TableCell>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                           ...
                                           <asp:Label runat="server" ID="lblExpenseDate" Text="<%$ resources:ExpenseDate%>" CssClass="middle-lbl"
                                                AssociatedControlID="txtExpenseDate"></asp:Label>
                                            ...
                                            <asp:TextBox ID="txtCurrency" runat="server" CssClass="input-small" TabIndex="4" MaxLength="100"></asp:TextBox>
                                            ...
                                            <asp:Label runat="server" ID="lblVendorInvNO" Text="<%$ resources:RefNo%>" CssClass="middle-lbl" AssociatedControlID="txtVendorInvNO"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtVendorInvNO" CssClass="input-small" TabIndex="5" MaxLength="100"></asp:TextBox>
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                         ...
                                         <div class="clear">
                                            ...
                                            <asp:TextBox runat="server" ID="txtVendorInvDate" CssClass="date-picker input-small" TabIndex="6"
                                            ...
                                            <asp:RequiredFieldValidator ID="vrfVendorInvDate" CssClass="star" SetFocusOnError="true"
                                              ...
                                              <asp:Label runat="server" ID="lblCreditDays" Text="<%$ resources:CreditDays%>" CssClass="middle-lbl-small-e"  AssociatedControlID="txtCreditDays"></asp:Label>
                                            ...
                                            <asp:Label runat="server" ID="lblInvoiceDueDate" Text="<%$ resources:InvoiceDueDate%>" CssClass="middle-lbl-small-d" 
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="div2col-S">
                                                                ...
                                                                <asp:TextBox runat="server" ID="txtPartyNo" CssClass="input-small" TabIndex="10" MaxLength="100"></asp:TextBox>
                                                                 <asp:Label runat="server" ID="lblPartyInvDate" Text="<%$ resources:PartyInvDate%>" CssClass="middle-lbl"
                                                                    AssociatedControlID="txtPartyInvDate"></asp:Label>
                                                                ...
                                                                <asp:TextBox ID="txtAddressType" runat="server" MaxLength="100" TabIndex="13" Width="200" CssClass="input-small"
                                                                    OnTextChanged="ActionHandler" AutoPostBack="true"> </asp:TextBox>
                                                                ...
                                                                &nbsp&nbsp
                                                                <asp:Label runat="server" ID="lblchkBH" Width="22px" Text="<%$ resources:HO%>" CssClass="middle-lbl" AssociatedControlID="chkHO"></asp:Label>
                                                        ...
                                                        <td>
                                                            <div class="div2col-S">
                                                                ...
                                                                <asp:TextBox ID="txtVendorDtl" runat="server" MaxLength="100" TabIndex="11" onkeydown="Bindtaxid();" CssClass="select-half"
                                                                    OnTextChanged="ActionHandler" AutoPostBack="true"> </asp:TextBox>
                                                              ...
                                                              <div class="clear"></div>
                                                                ...
                                                                <asp:TextBox runat="server" ID="txtVatTaxId" TabIndex="14" CssClass="input-small"></asp:TextBox>
                                                                 ...
                                                                 <asp:Label runat="server" ID="lblBranchCode" Text="<%$ resources:BranchCode%>" CssClass="middle-lbl-small-d" AssociatedControlID="txtBranchCode"></asp:Label>
                                                                <asp:TextBox ID="txtBranchCode" runat="server" CssClass="input-small" MaxLength="5" TabIndex="15" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="div2col-S">
                                                            ...
                                                            <asp:TextBox ID="txtQty" runat="server" CssClass="input-w80 numeric input-small" MaxLength="11"
                                                                TabIndex="17" onchange="CalculateAmount();" Text="1"></asp:TextBox>
                                                            ...
                                                            <asp:ImageButton ID="imgDiscount" SkinID="discount" runat="server" OnClick="ActionHandler" CssClass="margntop2"
                                                                TabIndex="19" ToolTip="<%$ resources:Controls,Discounts %>" CommandName="DISCDETAILS"
                                                                ValidationGroup="taxDate" OnClientClick="javascript:ValidatePageNow('taxDate')" />

                                                                 <asp:Label ID="lblItemTax" runat="server" CssClass="lbl-14-2perc" AssociatedControlID="txtTax" Text="<%$ resources:Tax %>">
                                                            </asp:Label>
                                                            <asp:TextBox ID="txtTax" runat="server" CssClass="input-w80 input-disabled numeric medium input-small"
                                                                MaxLength="14" onkeydown="return EnableArrowKey(event)" onpaste="return false;"></asp:TextBox>
                                                            <asp:ImageButton ID="imgTax" SkinID="tax" runat="server" OnClick="ActionHandler" CssClass="margntop2"
                                                                TabIndex="19" ToolTip="<%$ resources:Tax %>" CommandName="TAXDETAILS" ValidationGroup="taxDate"
                                                    ...
                                                    <td>
                                                        <div class="div2col-S">
                                                            ...
                                                            <asp:TextBox ID="txtRate" runat="server" CssClass="input-w80 numeric medium input-small" MaxLength="18"
                                                                TabIndex="18" onchange="CalculateAmount();"></asp:TextBox>
                                                            <div class="starwrap">
                                                             ...
                                                             <asp:Label ID="lblAmount" runat="server" CssClass="middle-lbl-small-d" AssociatedControlID="txtAmount" Text="<%$ resources:Amount_Mand %>">
                                                            </asp:Label>
                                                            ...
                                                            <asp:TextBox ID="txtTotAmt" runat="server" CssClass="input-w80 input-disabled numeric medium input-small"
                                                                MaxLength="15"></asp:TextBox>
                                                                 ...
                                                                 <asp:Label ID="Label1" runat="server" CssClass="middle-lbl-small-d" AssociatedControlID="txtTaxRefundDate" Text="Tax Refund Month">
                                                            </asp:Label>
                                        ...
                                        <td colspan="2">
                                            <div class="divcol-S">
                                                ...
                                                <asp:ImageButton runat="server" ID="btnAddItem" CommandName="ADDITEM" TabIndex="21"
                                                    ...
                                                    ToolTip="<%$resources:ErpRes,Add %>" CommandArgument="PageAction_Entry" ValidationGroup="details" CssClass="margntop2"
                                                    SkinID="plus" />
                                                <asp:ImageButton runat="server" ID="btnClearItem" CommandName="CLEARITEM" TabIndex="22" CssClass="margntop2"
                            ...
                            <div class="gridwrap" style="width: 100%; overflow: auto; max-width: 1200px;">
                                <asp:GridView ID="grdItemDetails" runat="server" AutoGenerateColumns="False" PageSize="<%$ resources:PageSize %>"
                                    AllowPaging="false" EmptyDataRowStyle-CssClass="emptytable" AllowSorting="false" TabIndex="22"
                                    ShowFooter="true" OnRowDataBound="ActionHandler" Width="1700px">
                                    <EmptyDataTemplate>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Quantity%>" HeaderStyle-CssClass="amount-numeric">
                                            ...
                                            <ItemStyle Width="120px" CssClass="amount-numeric" />
