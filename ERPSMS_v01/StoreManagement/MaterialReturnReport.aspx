<%@ Page Title="<%$ Resources:Captions,Title_MaterialReturn %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" Theme="Classic" CodeBehind="MaterialReturnReport.aspx.cs"
    Inherits="ERPSMS_v01.StoreManagement.MaterialReturnReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-wrapper">
        <div class="reportviewer">
            <rsweb:ReportViewer ID="RptMaterialReturn" runat="server" BorderWidth="0" SizeToReportContent="true"
                Width="98%">
            </rsweb:ReportViewer>
        </div>
    </div>
