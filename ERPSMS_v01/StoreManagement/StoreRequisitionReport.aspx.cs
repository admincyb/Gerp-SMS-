...
{
    public partial class StoreRequisitionReport : ERP.Store.UI.MyBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    RecPK = Convert.ToInt32(Request.QueryString["RequisitionID"]);
                    FillReport(Convert.ToInt32(Request.QueryString["RequisitionID"]));
                }
        ...
        private void FillReport(int storeReqID)
        {
           ...
           // LocalReport locRpt;
            ...
            dsetStoreReqDtls = BusinessLogic.StoreManagement.StoreRequisitionSlipCreation.GetRequisitionReportByReqId(storeReqID);
            if (dsetStoreReqDtls != null)
            {
                ...
                if (dtRequestHeader.Rows.Count > 0 || dtRequestDetail.Rows.Count > 0)
                {
                    ...
                    locRpt.ReportPath = Server.MapPath("../Reports/StoreRequestReport.rdlc");
                    ...
                    {
                        int CompanyPK = Convert.ToInt32(dtRequestHeader.Rows[0]["BizUnitPk"].ToString());
                        RptStoreRequest.LocalReport.DataSources.Add(GetCompanyDetails(CompanyPK));
                    }
        ...
        public void PrintPDF()
        {
            ...
            if (File.Exists(attachmentFilePath))
            {
                ...
                //Response.Write("<script>window.open('" + redirectUrl + "','_blank');window.location='" + referUrl + "';</script>");
            }
        }
