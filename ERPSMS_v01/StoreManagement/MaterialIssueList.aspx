<%@ Page Title="<%$ Resources:Captions,Title_StockTransfer %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" Theme="ClassicExt" EnableEventValidation="false" CodeBehind="MaterialIssueList.aspx.cs"
    Inherits="ERPSMS_v01.StoreManagement.MaterialIssueList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/StoreManagement/MaterialIssueList.js.axd" type="text/javascript"></script>
</asp:Content>
        ...
        <div id="searchwrap" class="search-wrap-custom1">
            <div id="divSearch">
                ...
                <asp:DropDownList ID="SearchType" runat="server" CssClass="srchboxtextbx" TabIndex="1"
                    ...
                    <%--<asp:ListItem Value="MIH_MRH_NO" Text="<%$ Resources:BindValues, SR%>">
                    </asp:ListItem>--%>
                     <asp:ListItem Value="MIH_STATUS" Text="<%$ Resources:BindValues, Status%>">
                    </asp:ListItem>
            ...
            <div id="DivMIList">     
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="MIH_STATUS" isvisible="false">
                        </th>
                        <th fieldmap="MIH_NO" sortable="true" align="left" width="10%">
                            <%=PageType == 1 ? Resources.Controls.WOTNo : Resources.Controls.STNo%>
                        </th>
                         <th fieldmap="CMP_DISPLAY_CODE" isvisible="false" align="left" width="2%">                           
                        </th> 
                        <th fieldmap="MIH_DATE" sortable="true" width="10%" align="left">
                            <%=PageType == 1 ? Resources.Controls.WOTDate : Resources.Controls.STDate%>
                        </th>
                        <th fieldmap="MIH_ITEM_TEXT" sortable="true" width="39%" align="left">
                            <%=Resources.Controls.ItemDetails%>
                        </th>
                        <th fieldmap="DPT_NAME" sortable="true" width="10%" align="left">
                            <%=Resources.Controls.IssuedBy%>
                        </th>
                        <th fieldmap="DPT_NAME_TO" sortable="true" width="10%" align="left">
                            <%=Resources.Controls.IssuedTo%>
                        </th>
                        <th fieldmap="MIH_STATUS_TEXT" sortable="true" width="10%" align="left">
             ...
             <div id="DivMIReturnList">     
                ...
                <thead>
                    <tr>
                        ...
                        <th type="Template" width="9%" align="left">
                            <div style="text-align: left">
                              <%--  <asp:ImageButton runat="server" ID="ImageButton1" SkinID="imbeditgrid" ToolTip="<%$ resources:Controls,Edit %>" OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'PERFORMACTION')" />
                                <asp:ImageButton runat="server" ID="ImageButton2" SkinID="imbdeletegrid" ToolTip="<%$ resources:Controls,Delete %>" OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'DELETE')" />
                                <asp:ImageButton runat="server" ID="ImageButton3" SkinID="imbeditgrid" title="<%$Resources:Controls,Modify%>"  OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'MODIFY')" /> --%>                               
                                <asp:ImageButton runat="server" ID="ImageButton5" SkinID="btnview" ToolTip="<%$ resources:Controls,View %>" OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'VIEW')" />
                                <asp:ImageButton runat="server" ID="ImageButton6" SkinID="btnPrint" ToolTip="<%$ resources:Controls,Print %>" OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'PRINT')" />
                                <asp:ImageButton runat="server" ID="ImageButton4" SkinID="return2"  ToolTip="<%$Resources:Controls,Return%>" OnClientClick="javascript:return GridHandler($(this).parents('tr:eq(0)'),'RETURN')"  />
                            </div>
                        </th>
                    </tr>
                </thead>
