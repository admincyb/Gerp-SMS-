<%@ Page Title="Former Damage Issue" EnableEventValidation="false"
    Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" Theme="ClassicExt" ValidateRequest="false" CodeBehind="FormerDamageIssue.aspx.cs" Inherits="ERPSMS_v01.StoreManagement.FormerDamageIssue" %>

<%@ Register Src="../WorkFlow/WorkflowComments.ascx" TagName="WorkflowComments" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/StoreManagement/FormerDamageIssue.js.axd"
