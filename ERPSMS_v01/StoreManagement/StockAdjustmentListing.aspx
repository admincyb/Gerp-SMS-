<%@ Page Title="<%$ Resources:Captions,Title_StoreAdjustment %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="StockAdjustmentListing.aspx.cs" Theme="ClassicExt"
    Inherits="ERPSMS_v01.StoreManagement.StockAdjustmentListing" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/StoreManagement/StockAdjustmentListing.js.axd"
        type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <%--  <div id="webwizard-wrap">
        <h1>
            <%=Resources.Captions.StoreAdjustmentList%>
        </h1>
        <div class="button-wrap">
            ...
            <asp:ImageButton ID="imbCancel" runat="server" Visible="false" SkinID="btncancel"
                OnClientClick="javascript:return CancelFun();" TabIndex="8" />
        </div>
    </div>--%>
          ...
          <div id="searchwrap" class="search-wrap-custom1">
            <div id="divSearch">
                ...
                <asp:DropDownList ID="SearchType" runat="server" CssClass="srchboxtextbx" TabIndex="1"
                    ...
                    <asp:ListItem Value="SDH_NO" Text="<%$ Resources:BindValues, StoreAuditNo%>"></asp:ListItem>
                    <%--<asp:ListItem Value="STK_VARIANCE_TEXT" Text="<%$ Resources:BindValues, Status%>"></asp:ListItem>--%>
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="SAH_DATE" sortable="true" align="left" width="10%">
                         ...
                         <th fieldmap="SDH_ITEM_TEXT" sortable="true" width="55%" align="left">
                            <%=Resources.Controls.ItemDetails%>
                        </th>
                        <th fieldmap="DPT_NAME" sortable="true" width="10%" align="left">
                            <%=Resources.Controls.Store%>
                        </th>
                        <th fieldmap="SDH_STATUS_TEXT" sortable="true" width="8%" align="left">
