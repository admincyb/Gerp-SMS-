<%@ Page Title="<%$ Resources:Captions,Title_MaterialConsumption %>" Language="C#"
    ...
    Theme="Classic" CodeBehind="MaterialConsumptionList.aspx.cs" Inherits="ERPSMS_v01.StoreManagement.MaterialConsumptionList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%--    <div id="webwizard-wrap">
        <h1>
            <%=Resources.Captions.MaterialConsumptionList%>
        </h1>
            ...
            <table rules="all" id="grdRequsitionList" grandtype="GrandGrid" pagesize="20" paging="true"
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="ICH_DEPT_TEXT" sortable="true" align="left" width="20%">
