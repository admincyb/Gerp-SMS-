<%@ Page Title="<%$ Resources:Captions,Title_MaterialReturn %>" Language="C#"
Theme="ERP-Blue" MasterPageFile="~/ERPSMS.Master" AutoEventWireup="true" CodeBehind="MaterialReturn.aspx.cs"
EnableEventValidation="false" Inherits="ERPSMS_v01.StoreManagement.MaterialReturn" %>
<%@ Register Src="../WorkFlow/WorkflowComments.ascx" TagName="WorkflowComments" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/StoreManagement/MaterialReturn.js.axd" type="text/javascript"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="webwizard-wrap">
        <h1>
            <%=Resources.Captions.MaterialReturn %></h1>
        ...
        <div id="divData">
            <div id="divXml">
                <div class="div2col-S">
                    ...
                    <asp:Label ID="lblMaterilaConsumptionNo" runat="server" Text="" Width="220px"></asp:Label>
                    <div class="clear">
                    </div>
                    <label>
                        <%=Resources.Controls.Date%>*</label>
                    <asp:TextBox ID="ICH_DATE" runat="server" TabIndex="1" Width="220px"></asp:TextBox>
                    <asp:HiddenField ID="ICH_NO" runat="server" />
                </div>
                <div class="div2col-S">
                    <label for="Store">
                        <%=Resources.Controls.ConsumptionStore%>*</label>
                    <asp:DropDownList ID="ICH_DEPT" runat="server" TabIndex="1" Width="200px" onchange="javascript:FillDepartement();"
                    ...
                    <asp:DropDownList ID="ICH_ITEM_TYPE" runat="server" TabIndex="2" Width="200px" EnableViewState="False"
                ...
                <div id="ProductInsert">
                    <table id="tblProductInsert">
                        ...
                        <tbody>
                            <tr>
                                <td width="20%">
                                    <asp:DropDownList ID="MaterialType" runat="server" Width="180px" TabIndex="3" onchange="javascript:FillCategoryDetails($(this).val());">
                                    </asp:DropDownList>
                                    <asp:ImageButton ID="imbViewCag" runat="server" CssClass="imgbutton-wrap" ToolTip="Open Item Category"
                                        SkinID="imbselect2" Width="22px" Height="22px" TabIndex="4" OnClientClick="javascript:return ShowCategory();"
                                        EnableViewState="false" />
                                </td>
                                <td width="20%">
                                    <asp:DropDownList ID="ITV_ITEM" runat="server" TabIndex="5" Width="180px" onchange="javascript:GetCurrentStock($(this).val());">
                                    </asp:DropDownList>
            ...
            <table rules="all" id="grdRequisitionSlip" grandtype="GrandGrid" paging="false" editfunction="GridAction"
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="ICD_ITEM_CATEGORY" isvisible="false"> <%--MaterialTypePk--%>
                        </th>
                        <th fieldmap="ICD_ITEM_CATEGORY_TEXT" align="left" width="30%"> <%--MaterialType --%>
                            <%=Resources.Controls.MaterialType%>*
                        </th>
                        <th fieldmap="ICD_ITEM_TEXT" align="left" width="10%"> <%--MaterialCode--%>
                            <%=Resources.Controls.MaterialCode%>*
                        </th>
                        <th fieldmap="ICD_CURRENT_STK" align="right" width="15%"> <%--CurrentStock--%>
