<%@ Page Title="<%$ Resources:Captions,Title_ExternalMaterialReceive %>" Language="C#"
    ...
    CodeBehind="EMRList.aspx.cs" EnableEventValidation="false" Inherits="ERPSMS_v01.StoreManagement.EMRList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/StoreManagement/EMRList.js.axd" type="text/javascript"></script>
</asp:Content>
            ...
            <tr>
                <td>
                    <div class="div2col-S padgtop7">
                        <asp:Label runat="server" ID="lblFromDate" Text="<%$ resources:FromDate %>" CssClass="lbl-15-1perc"
                            AssociatedControlID="SearchFromDate"></asp:Label>
                        <asp:TextBox ID="SearchFromDate" runat="server" TabIndex="1" CssClass="input-small-b"
                            EnableViewState="false" onkeydown="return CheckKey(event)" onpaste="return false;">
                        </asp:TextBox>
                        <asp:HiddenField ID="hdfSearchFrmDate" runat="server" />
                        <asp:Label runat="server" ID="lblToDate" Text="<%$ resources:ToDate %>" AssociatedControlID="SearchToDate"
                            CssClass="lbl-9perc"></asp:Label>
                        <asp:TextBox ID="SearchToDate" runat="server" CssClass="input-small-a" TabIndex="2"
                            onkeydown="return CheckKey(event)" onpaste="return false;" EnableViewState="false">
                        </asp:TextBox>
                        <asp:HiddenField ID="hdfSearchToDate" runat="server" />
                        <asp:Label runat="server" ID="Label2" Text="<%$ resources:RefNo %>" AssociatedControlID="txtRefNo"
                            CssClass="lbl-7-5perc"></asp:Label>
                        <asp:TextBox ID="txtRefNo" runat="server" TabIndex="3" CssClass="w21perc">
                        </asp:TextBox>
                        <div class="clear">
                        </div>
                        <asp:Label runat="server" ID="Label4" Text="<%$ Resources:Controls,MaterialType%>"
                            CssClass="lbl-15-1perc" AssociatedControlID="txtItemCategory"></asp:Label>
                        <asp:TextBox ID="txtItemCategory" runat="server" TabIndex="5" CssClass="input-w51per"
                            EnableViewState="false">
                        </asp:TextBox>
                ...
                <td>
                    <div class="div2col-S padgtop7">
                        ...
                        <asp:DropDownList ID="ddlIssuingStore" runat="server" TabIndex="4" CssClass="w26perc"
                            EnableViewState="False">
                        </asp:DropDownList>
                        <div class="clear">
                        </div>
            ...
            <tr>
                <td>
                    <div class="div2col-S div-separatn">
                        <asp:Label runat="server" ID="lblIssueN0" CssClass="lbl-15-1perc" AssociatedControlID="SearchValue"><%=ReceiptNo%></asp:Label>
                        <asp:TextBox ID="SearchValue" runat="server" EnableViewState="false" TabIndex="7"
                            CssClass="input-small-b margnbotm0">
                        </asp:TextBox>
                        <asp:Label runat="server" ID="lblTrnStatus" Text="<%$ resources:TrnStatus %>" CssClass="lbl-9perc"
                            AssociatedControlID="ddlTrnStatus"></asp:Label>
                        <asp:DropDownList ID="ddlTrnStatus" runat="server" CssClass="w20perc margnbotm0"
                            TabIndex="7">
                        ...
                        <asp:Label runat="server" ID="lblType" Text="<%$ Resources:BindValues,Type %>" CssClass="lbl-7-5perc"
                            AssociatedControlID="ddlType"></asp:Label>
                        <asp:DropDownList ID="ddlType" runat="server" TabIndex="7" CssClass="select-w22-3per margnbotm0"
                            onchange="javascript:FillIssueToCategories();" EnableViewState="False">
                        </asp:DropDownList>
                ...
                <td>
                    <div class="div2col-S div-separatn">
                        ...
                        <asp:ImageButton ID="btnSearch" runat="server" ToolTip="<%$ resources:Controls,Search %>"
                            TabIndex="7" SkinID="search-ext" CssClass="margntop2 margnbotm0" OnClientClick="javascript:return BindGrid();" />
                        <asp:ImageButton ID="btnClear" runat="server" TabIndex="7" CssClass="margntop2 margnbotm0"
                            ToolTip="<%$ resources:Controls,Clear %>" SkinID="clear-ext" OnClientClick="javascript:return SearchAutoInit();" />
                    </div>
                </td>
            </tr>
        </table>
