<%@ Page Title="<%$ Resources:Captions,Title_ExternalMaterialReceive %>" Language="C#"
    ...
    CodeBehind="EMRCreate.aspx.cs" EnableEventValidation="false" Inherits="ERPSMS_v01.StoreManagement.EMRCreate" %>

<%@ Register Src="../WorkFlow/WorkflowComments.ascx" TagName="WorkflowComments" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/StoreManagement/EMRCreate.js.axd" type="text/javascript"></script>
</asp:Content>
                    ...
                    <table id="tblProductInsert" class="gridwraptable gridwrap">
                        ...
                        <tbody>
                            <tr class="grd-rowhead">
                                <td width="18%">
                                    <asp:TextBox ID="MaterialCategory" runat="server" Width="90%" TabIndex="7">
                                    </asp:TextBox>
                                ...
                                <td width="21%">
                                    ...
                                    <asp:TextBox ID="ItemCodeMaterial"  runat="server"  TabIndex="8" Width="90%">
                                    </asp:TextBox>
                                ...
                                <td width="4%">
                                    <asp:DropDownList ID="ICD_UOM" runat="server" TabIndex="12" Width="80px" EnableViewState="false">
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: right" width="8%">
                                    <asp:TextBox ID="ICD_VALUE_CONSUMED" runat="server" TabIndex="11" EnableViewState="false"
                                ...
                                <td width="5%">
                                    <asp:TextBox ID="ICD_EXPIRY_DATE" runat="server" Width="80px" onkeydown="return CheckKey(event)"
                                        onpaste="return false;" TabIndex="14" MaxLength="12" CssClass="date-picker floatLeft">
                                    </asp:TextBox>
                                </td>
                                <td width="15%">
                                    <asp:TextBox ID="ICD_REMARKS" runat="server" MaxLength="250" TabIndex="13" EnableViewState="false"
                                        CssClass="input-halfsmall-b">
                                    </asp:TextBox>
                                </td>
                                <td align="left" width="3%">
                                    <asp:ImageButton ID="imbAddNew" TabIndex="15" runat="server" SkinID="imbaddnew" OnClientClick="javascript:return AddRequisitionDetails();"
                                        Width="16px" />
                                    <asp:ImageButton ID="imbReset" TabIndex="15" runat="server" SkinID="cancel" OnClientClick="javascript:return ResetGridControlDetails();"
