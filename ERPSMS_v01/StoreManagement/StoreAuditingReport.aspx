<%@ Page Title="<%$ Resources:Captions,Title_StoreAuditReport %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true"
 Theme="Classic" CodeBehind="StoreAuditingReport.aspx.cs" Inherits="ERPSMS_v01.StoreManagement.StoreAuditingReport" %>
   ...
   <%-- <div id="webwizard-wrap">
    ...
    <div class="content-wrapper">
        <div class="reportviewer">
            <rsweb:ReportViewer ID="RptStoreAuditing" runat="server" BorderWidth="0" SizeToReportContent="true"
                Width="98%">
            </rsweb:ReportViewer>
        </div>
    </div>
