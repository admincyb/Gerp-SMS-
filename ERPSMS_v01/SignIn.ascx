<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SignIn.ascx.cs" Inherits="LatexERPV2.SignIn" %>
<div id="loginwrap" runat="server" class="loginwrap">
    <asp:Login ID="LgnUser" Visible="false" runat="server" BackColor="Transparent" BorderPadding="4"
        ...
        <LayoutTemplate>
            ...
            <asp:TextBox ID="UserName" runat="server" EnableTheming="false"></asp:TextBox>
            ...
            <asp:TextBox ID="Password" runat="server" EnableTheming="false" TextMode="Password"></asp:TextBox>
    ...
    <div id="NewLogin">
        ...
        <div id="login-container">
            ...
            <a href="./AccountManagement/ResetPassword.aspx">Forgot password</a>  <%--<a style="text-decoration: none"> | </a><a href="AccountManagement/ResetPassword.aspx">Reset</a>
