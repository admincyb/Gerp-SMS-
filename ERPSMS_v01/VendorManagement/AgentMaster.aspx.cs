...
{
    public partial class AgentMaster : ERP.Store.UI.MyBasePage
    {
        ...
        private void FillInitialData()
        {
            ...
            {
                FillAgentDetails(Convert.ToInt32(Request.QueryString["AgentID"].ToString()));
            }
            ...
            if (Request.QueryString["Status"] != null)
            {
                ...
                else if (Request.QueryString["AgentID"] != null)
                {
                    ...
                    WorkFlowDetails wrkFlowDtls = CommonBL.GetWorkflowDetails(int.Parse(Request.QueryString["AgentID"].ToString()), procId);
                    if (wrkFlowDtls != null)
                    {
        ...
        private void FillAgentDetails(int AgentID)
        {
            if (AgentID != 0)
            {

                VendorDetails.Value = BusinessLogic.VendorManagement.AgentRegistration.GetAgentDetails(AgentID);
                ...
                hdfVendorPK.Value = AgentID.ToString();
        ...
        private void FillProcessId()
        {
            ...
            //    path = Request.Url.AbsolutePath.ToLower();
             ...
             path = "/VendorManagement/AgentMaster.aspx?Type=11";
