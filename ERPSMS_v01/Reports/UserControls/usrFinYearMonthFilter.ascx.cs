...
{
    public partial class usrFinYearMonthFilter : System.Web.UI.UserControl
    {
        ...
        #region Properties
        private bool usrFinYearMonthFilter_IsPostBack
        {
            get
            {
                return this.ViewState["usrFinYearMonthFilter_IsPostBack"] == null ? false : (bool)this.ViewState["usrFinYearMonthFilter_IsPostBack"];
            }
            set
            {
                this.ViewState["usrFinYearMonthFilter_IsPostBack"] = value;
            }
        }
        #endregion
        #endregion
        ...
        private void PageActionHandler()
        {
            try
            {
                if (!usrFinYearMonthFilter_IsPostBack)
                {
                    usrFinYearMonthFilter_IsPostBack = true;
        ...
        {
            get { return txtMonth.Text.Trim(); }
            set { txtMonth.Text = Convert.ToString(value); }
        }
        #endregion
