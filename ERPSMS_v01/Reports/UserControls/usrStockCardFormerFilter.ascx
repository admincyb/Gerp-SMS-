<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usrStockCardFormerFilter.ascx.cs" Inherits="ERPSMS_v01.Reports.UserControls.usrStockCardFormerFilter" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="div2col-S">
                                ...
                                <asp:TextBox ID="FromDate" runat="server" CssClass="input-small margnbotm0" onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                                <cc1:calendarextender runat="server" id="txtMonth_CalendarExtender" behaviorid="calendar1"
                                    targetcontrolid="FromDate" format="MMM-yyyy" onclientshown="onCalendarShown"
                                ...
                                <asp:TextBox ID="ToDate" runat="server" CssClass="input-small margnbotm0" onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                                <cc1:calendarextender runat="server" id="CalendarExtender1" behaviorid="calendar2"
                                    targetcontrolid="ToDate" format="MMM-yyyy" onclientshown="onCalendarShown"
                                    onclienthidden="onCalendarHidden" clientidmode="Static">
                                </cc1:calendarextender>
