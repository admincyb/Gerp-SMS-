<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usrStockCardDataOnlyBatchFilter.ascx.cs" Inherits="ERPSMS_v01.Reports.UserControls.usrStockCardDataOnlyBatchFilter" %>
            ...
            <div class="fields-group">
                <table class="table-devide">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="div2col-S">
                                <asp:Label runat="server" ID="lblBatchNo" Text="Batch No" AssociatedControlID="txtBatchNo"></asp:Label>
                                <asp:TextBox ID="txtBatchNo" runat="server" MaxLength="100" CssClass="select-halfsmall" />
                            </div>
                        </td>
                    </tr>
                </table>
