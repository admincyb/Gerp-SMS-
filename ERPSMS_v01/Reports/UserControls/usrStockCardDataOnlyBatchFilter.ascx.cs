...
{
    public partial class usrStockCardDataOnlyBatchFilter : MISFilterBase
    {
        ...
        #region Properties
        private bool usrStockCardDataOnlyBatchFilter_IsPostBack
        {
            get
            {
                return this.ViewState["usrStockCardDataOnlyBatchFilter_IsPostBack"] == null ? false : (bool)this.ViewState["usrStockCardDataOnlyBatchFilter_IsPostBack"];
            }
            set
            {
                this.ViewState["usrStockCardDataOnlyBatchFilter_IsPostBack"] = value;
            }
        }
        #endregion
        #endregion
        ...
        public override ReportParameters GetReportParameters()
        {
            try
            {
                ...
                tempReportParams.BatchNo = txtBatchNo.Text;
        ...
        private void PageActionHandler()
        {
            try
            {
                if (!usrStockCardDataOnlyBatchFilter_IsPostBack)
                {
                    usrStockCardDataOnlyBatchFilter_IsPostBack = true;
