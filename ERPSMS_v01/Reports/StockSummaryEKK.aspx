<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockSummaryEKK.aspx.cs"
    EnableEventValidation="false" Theme="Classic" MasterPageFile="~/ERPSMS_2.Master"
    Inherits="ERPSMS_v01.Reports.StockSummaryEKK" %>
    ...
    <script type="text/javascript">
        function InitComponents() {
          ...
          //  GrandScriptUtils.AddDateRange("StockDate", "hdfDateStock", "StockToDate", "hdfStockToDate", "dd-M-yy", false, true, false);
            GrandScriptUtils.AddDateRangeCommon("StockDate", "hdfDateStock", "StockToDate", "hdfStockToDate","dd-M-yy", false, false);
        }
    </script>
</asp:Content>
            ...
            <div class="content-wrapper">
                <div id="searchwrap" class="search-wrap-custom1">
                    ...
                    <%--<label for="ddlMaterialCatg" >
                        Category</label>--%>
                    <asp:DropDownList ID="ddlCategory" runat="server" TabIndex="3" Visible="false">
                    </asp:DropDownList>
                    <label for="StockDate">
                        Date From</label>
                    ...
                    <asp:ImageButton ID="imbSearch" runat="server" SkinID="search" TabIndex="5" EnableViewState="false"
                         style="width: 14px" onclick="imbSearch_Click" />
                    <div class="clear">
                    </div>
                </div>
