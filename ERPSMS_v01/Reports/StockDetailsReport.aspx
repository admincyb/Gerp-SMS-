<%@ Page Title="gERP – STORE MANAGEMENT – Stock Report" Language="C#" EnableEventValidation="false"
    Theme="Classic" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" CodeBehind="StockDetailsReport.aspx.cs"
    Inherits="ERPSMS_v01.StoreManagement.StockDetailsReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div id="searchwrap" class="search-wrap-custom1">
                <label for="StockDate">
                    Date</label>
                <asp:TextBox ID="StockDate" runat="server" CssClass="medium" EnableViewState="false" TabIndex="1">
                </asp:TextBox>
                ...
                <label for="ddlMaterialCatg">
                    Category</label>
                <asp:DropDownList ID="ddlMaterialCatg" runat="server" AutoPostBack="true" TabIndex="3"
                    OnSelectedIndexChanged="ddlMaterialCatg_SelectedIndexChanged">
                </asp:DropDownList>
                <label for="ddlItem">
                    Item</label>
                <asp:DropDownList ID="ddlItem" runat="server" TabIndex="4">
                </asp:DropDownList>
