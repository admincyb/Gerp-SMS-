    ...
    public partial class ProductionReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                FillReport(DateTime.Now.AddDays(-1).ToString(), DateTime.Now.ToString(), 0);
            }
        }
        ...
        private void FillReport(string date, string dateTo, int store)
        {
            LocalReport locRpt;
            ...
            try
            {
                DataTable dtStockDtls = BusinessLogic.StoreManagement.StockDetailsReport.GetStockDetailsForRpt(date, store, dateTo,0, currentUser.SBUID);
                if (dtStockDtls.Rows.Count > 0)
                {
                    ...
                    locRpt.ReportPath = Server.MapPath("StockDetailsNew_EKK.rdlc");//StockReport_EKK.rdlc
        ...
        private void SetReportParameters(LocalReport locRpt)
        {
            ...
            parameters = new ReportParameter("SubTitle", "EKK");
            locRpt.SetParameters(parameters);
            parameters = new ReportParameter("HideSubTitle", "true");
            locRpt.SetParameters(parameters);
        ...
        protected void imbSearch_Click(object sender, ImageClickEventArgs e)
        {
            ...
            FillReport(StockDate.Text, StockToDate.Text, Convert.ToInt32(ddlStore.SelectedValue));
        }
