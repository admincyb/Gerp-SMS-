...
{
    public partial class StockSummaryEKK : System.Web.UI.Page
    {
        ...
        private void FillReport(string date, string dateTo,int Category, int store)
        {
            ...
            try
            {
                ...
                if (dtStockDtls.Rows.Count > 0)
                {
                    ...
                    ReportDataSource dsGRNDailyDtls = new ReportDataSource("ReportDtls", dtStockDtls);
                    locRpt = null;
                    locRpt = RptViewerReport.LocalReport;
                    locRpt.ReportPath = string.Empty;
                    locRpt.ReportPath = Server.MapPath("StkSummary_EKK.rdlc");
        ...
        private void SetReportParameters(LocalReport locRpt)
        {
            ...
            parameters = new ReportParameter("SubTitle", "Store Stock Statement (Summary)");
            locRpt.SetParameters(parameters);
