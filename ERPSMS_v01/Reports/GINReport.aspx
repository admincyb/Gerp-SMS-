<%@ Page Title="<%$ resources:Title %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="GINReport.aspx.cs" Theme="Classic" Inherits="ERPSMS_v01.Reports.GINReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content-wrapper">
        <div class="reportviewer">
            <rsweb:ReportViewer ID="RptGinReport" runat="server" BorderWidth="0" SizeToReportContent="true"
                Width="98%">
            </rsweb:ReportViewer>
        </div>
    </div>
