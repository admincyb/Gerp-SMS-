...
{
    public sealed class PurchaseVoucherReportParameter : IReportParameter
    {
        ...
        public List<SPFIN_INVOICE_VND_VOUCHER_RPT_Result> PVHeaderDtls { get; set; }
        public List<SPFIN_TRX_VOUCHER_RPT_Result> PVAccountDtls { get; set; }
    }
}