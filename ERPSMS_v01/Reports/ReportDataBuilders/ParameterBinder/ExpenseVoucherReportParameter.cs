...
{
    public sealed class ExpenseVoucherReportParameter : IReportParameter
    {
        ...
        public List<SPFIN_INVOICE_VND_VOUCHER_RPT_Result> EVHeaderDtls { get; set; }
        public List<SPFIN_TRX_VOUCHER_RPT_Result> EVAccountDtls { get; set; }
    }
}