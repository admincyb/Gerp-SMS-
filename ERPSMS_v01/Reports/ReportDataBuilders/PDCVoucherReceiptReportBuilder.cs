...
{
    public sealed class PDCVoucherReceiptReportBuilder : ReportDataBuilder
    {
        PDCVoucherReceipt reportData;
        public PDCVoucherReceiptReportBuilder(string rptType)
            : base(rptType)
        {
            reportData = new PDCVoucherReceipt();
        }
        ...
        public override string GetReportTemplate(IReportParameter reportParameter)
        {
            ...
            PDCVoucherReportParameter parameter = (PDCVoucherReportParameter)reportParameter;
        ...
        private void SetReportData(PDCVoucherReportParameter parameter)
        {
            ...
            reportData.SaleContractNo = reportDataSource.CONTRACT_NO.IsNullOrEmptyOrWhitespace()
                                    ? "-" : reportDataSource.CONTRACT_NO;
