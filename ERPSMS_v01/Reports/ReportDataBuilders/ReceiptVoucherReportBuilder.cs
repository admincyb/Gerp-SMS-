...
{
    public sealed class ReceiptVoucherReportBuilder : ReportDataBuilder
    {
        ReceiptVoucher reportData;
        public ReceiptVoucherReportBuilder(string rptType)
            : base(rptType)
        {
            reportData = new ReceiptVoucher();
        }

        public override string GetReportTemplate(IReportParameter reportParameter)
        {
            ReceiptVoucherReportParameter parameter = (ReceiptVoucherReportParameter)reportParameter;
        ...
        private void SetReportData(ReceiptVoucherReportParameter parameter)
        {
            SPFIN_RECEIPT_VOUCHER_RPT_Result reportDataSource = parameter.HeaderDtls[0];

            //GetCompany Info
            SPADM_COMPANY_MST_GET_KV_Result company = GetCompanyDetails(reportDataSource.RCH_COMPANY);
            ...
            reportData.SaleContractNo = reportDataSource.CONTRACT_NO;
