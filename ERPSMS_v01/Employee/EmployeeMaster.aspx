<%@ Page Title="<%$ Resources:Captions,Title_EmployeeMaster %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="EmployeeMaster.aspx.cs" Inherits="ERPSMS_v01.Employee.EmployeeMaster"
    Theme="ClassicExt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        //sets focus on after select
        function AfterDateSelect(controlID) {
            $("input[id$=" + controlID + "]").focus();
        }
        ...
        //Custom Validate Daily Utilization Range
        function CheckDURange(oSrc, args) {
            var value1 = $('input:text[id$=txtDUMin]').val();
            var value2 = $('input:text[id$=txtDUMax]').val();
    ...
    <asp:UpdatePanel runat="server" ID="aupdpnlEmployee">
        <ContentTemplate>
            <div class="fixed-buttons">
                ...
                <div id="divTabContainer" class="tab-container" runat="server">
                    <ul id="tab-menu">
                        ...
                        <li><span id="spnEmployeeRoles" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lbnEmployeeRoles" Text="<%$resources:PageNameRes,EmployeeRole %>"
                                OnClick="ActionHandler" CommandName="ADDROLE"></asp:LinkButton>
                        </span></li>
                    </ul>
                </div>
            </div>
            <div class="content-wrapper">
                        ...
                        <asp:TableCell>
                            <div id="searchwrap" class="search-wrap-custom1">
                                ...
                                <asp:DropDownList ID="ddlFilterBy" runat="server" TabIndex="20">
                                    ...
                                    <%--<asp:ListItem Text="<%$ resources:EmployeeType %>" Value="<%$ resources:DataFieldRes,EmpTypeData %>"></asp:ListItem>--%>
                                </asp:DropDownList>
                            ...
                            <div class="gridwrap">
                                <asp:GridView runat="server" ID="grdEmployee" Width="100%" PageSize="<%$ resources:PageSize%>"
                                    ...
                                    <Columns>
                                        ...
                                        <%-- <asp:TemplateField HeaderText="<%$ resources:EmpType %>" SortExpression="<%$ resources:DataFieldRes,EmpTypeData %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblEmployeeType" runat="server" ToolTip='<%# Eval(Resources.DataTableRes.EmployeeType +"."+ Resources.DataFieldRes.EmpTypeData) %>'
                                                    Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval(Resources.DataTableRes.EmployeeType +"."+ Resources.DataFieldRes.EmpTypeData),13) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="12%" />
                                        </asp:TemplateField>--%>
                                        ...
                                        <%-- <asp:TemplateField HeaderText="<%$ resources:EmpDesignation %>" SortExpression="<%$ resources:DataFieldRes,EmployeeDesignationName %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblEmployeeDesig" runat="server" ToolTip='<%# Eval(Resources.DataTableRes.EmpDesignation +"."+ Resources.DataFieldRes.EmployeeDesignationName) %>'
                                                    Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval(Resources.DataTableRes.EmpDesignation +"."+ Resources.DataFieldRes.EmployeeDesignationName),17) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="15%" />
                                        </asp:TemplateField>--%>
                            ...
                            <div class="contentwrapper">
                                <table class="table-devide">
                                    ...
                                    <%--<tr>
                                        <td>
                                            <div class="div2col-S">
                                                <asp:Label ID="lblDUMin" runat="server" AssociatedControlID="txtDUMin" Text="<%$ resources:DailyUtilizationMin %>"></asp:Label>
                                                <asp:TextBox runat="server" ID="txtDUMin" MaxLength="15" TabIndex="8" Width="175px"></asp:TextBox>
                                                <div class="starwrap">
                                                    <asp:RequiredFieldValidator ID="vrfDUMin" CssClass="star" SetFocusOnError="true"
                                                        ValidationGroup="Employee" EnableClientScript="true" runat="server" ControlToValidate="txtDUMin"
                                                        Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_DailyUtilizationMin %>">
                                                    </asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="revDUMin" runat="server" ControlToValidate="txtDUMin"
                                                        ErrorMessage="<%$ resources: Err_Valid_DailyUtilizationMin %>" ValidationExpression="^\$?([0-9]{0,12})?(\.[0-9]{0,2})?$"
                                                        Display="Dynamic" Text="*" EnableClientScript="true" CssClass="star" ValidationGroup="Employee">
                                                    </asp:RegularExpressionValidator>
                                                    <asp:RangeValidator ID="regDUMin" runat="server" ControlToValidate="txtDUMin" MaximumValue="24"
                                                        EnableClientScript="true" CssClass="star" MinimumValue="0" Type="Double" ValidationGroup="Employee"
                                                        Text="*" Display="Dynamic" ErrorMessage="<%$ resources:Err_Valid_UtilizationMin %> "></asp:RangeValidator>
                                                    <div class="clear">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="div2col-S">
                                                <asp:Label ID="lblDUMax" runat="server" AssociatedControlID="txtDUMax" Text="<%$ resources:DailyUtilizationMax %>"></asp:Label>
                                                <asp:TextBox runat="server" ID="txtDUMax" MaxLength="15" TabIndex="9"></asp:TextBox>
                                                <div class="starwrap">
                                                    <asp:RequiredFieldValidator ID="vrfDUMax" CssClass="star" SetFocusOnError="true"
                                                        ValidationGroup="Employee" EnableClientScript="true" runat="server" ControlToValidate="txtDUMax"
                                                        Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_DailyUtilizationMax %>">
                                                    </asp:RequiredFieldValidator>
                                                    <asp:RegularExpressionValidator ID="revDUMax" runat="server" ControlToValidate="txtDUMax"
                                                        ErrorMessage="<%$ resources: Err_Valid_DailyUtilizationMax %>" ValidationExpression="^\$?([0-9]{0,12})?(\.[0-9]{0,2})?$"
                                                        Display="Dynamic" Text="*" EnableClientScript="true" CssClass="star" ValidationGroup="Employee">
                                                    </asp:RegularExpressionValidator>
                                                    <asp:CustomValidator ID="csvDU" runat="server" Display="None" Text="*" ControlToValidate="txtDUMax"
                                                        ClientValidationFunction="CheckDURange" ErrorMessage="<%$ resources:Err_DURange %> "
                                                        ValidationGroup="Employee"></asp:CustomValidator>
                                                    <asp:RangeValidator ID="regDUMax" runat="server" ControlToValidate="txtDUMax" MaximumValue="24"
                                                        MinimumValue="1" Type="Double" ValidationGroup="Employee" EnableClientScript="true"
                                                        CssClass="star" ErrorMessage="<%$ resources:Err_Valid_UtilizationMax %> " Text="*"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="div2col-S">
                                                <%--  <asp:Label ID="lblDesignation" runat="server" AssociatedControlID="txtDesignation"
                                                    Text="<%$ resources: EmpDesignation %>"></asp:Label>
                                                <asp:TextBox runat="server" ID="txtDesignation" TabIndex="10"></asp:TextBox>
                                                ...
                                                <asp:RequiredFieldValidator ID="vrfDesignation" CssClass="star" SetFocusOnError="true"
                                                    ...
                                                    ControlToValidate="txtDesignation" Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_EmployeeDesignation %>">
                                                </asp:RequiredFieldValidator>--%>
                ...
                <div id="divRoleMapping" runat="server" class="treeview max-200">
                    <%--class="content-wrapper"--%>
                    <asp:TreeView ID="trvEmpRole" runat="server" ShowCheckBoxes="All" ShowLines="true"
                        ExpandDepth="0" InitialExpandDepth="2">
                    </asp:TreeView>
                </div>
