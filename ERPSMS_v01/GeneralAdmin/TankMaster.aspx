<%@ Page Title="<%$ Resources:Captions,Title_TankMaster %>" Language="C#" Theme="ClassicExt"
    ...
    CodeBehind="TankMaster.aspx.cs" Inherits="ERPSMS_v01.GeneralAdmin.TankMaster" %> 
            ...
            <div id="divListing" class="grdTable">
                <div id="searchwrap" class="search-wrap-custom">
                    ...
                    <asp:DropDownList runat="server" ID="SearchType" TabIndex="12" CssClass="srchboxtextbx"
                        ...
                        <asp:ListItem Value="TNK_PLANT" Text="<%$ Resources:BindValues, PlantSearch%>">
                        </asp:ListItem>
                        <asp:ListItem Value="TNK_PROCESS" Text="<%$ Resources:BindValues, Process%>">
                        </asp:ListItem>
                    </asp:DropDownList>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th fieldmap="TNK_NAME" align="left" sortable="true" width="20%">
                                 ...
                                 <th fieldmap="TNK_LINE" sortable="true" isvisible="false" width="6%" align="left">
                                    <%=Resources.Controls.Line%>
                                </th>
                                 <th fieldmap="TNK_LINE_TEXT" sortable="true"  width="6%" align="left">
                                    <%=Resources.Controls.Line%>
                                </th>
                                ...
                                <th fieldmap="TNK_STOCK" sortable="true" isvisible="false" width="6%" align="right">
                               ...
                               <%-- <th fieldmap="TNK_ACTIVE_TEXT" width="6%" sortable="true">
                                ...
                                <th fieldmap="TNK_HAS_STOCK" width="6%" isvisible="false">
                                 ...
                                 <th fieldmap="TNK_ACTIVE_TEXT" width="5%" align="center">
                                        <%=Resources.Controls.Active%>
                                    </th>
                               
                                <%--Hidden Values--%>
                                <th type="Template" width="6%" align="center">
                            ...
                            <div class="div2col-S">
                                <div class="content">
                                    ...
                                    <div>
                                        ...
                                        <asp:TextBox ID="CapacityperCm" runat="server" TabIndex="6" MaxLength="10" onkeypress="javascript:GrandScriptUtils.AllowOnlyNumbers(event,true);"
                            ...
                            <div class="div2col-S">
                                <div class="content">
                                    ...
                                    <div>
                                        ...
                                        <asp:TextBox ID="TankSlope" runat="server" TabIndex="7" MaxLength="12" onblur="javascript:return  CalculateTotalCapacity();"
