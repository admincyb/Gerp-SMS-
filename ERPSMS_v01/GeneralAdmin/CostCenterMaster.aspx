<%@ Page Title="<%$ Resources:Title_CostCenterMaster %>" Language="C#" AutoEventWireup="true"
    EnableEventValidation="false" MasterPageFile="~/ERPSMS_2.Master" Theme="ClassicExt"
    CodeBehind="CostCenterMaster.aspx.cs" Inherits="ERPSMS_v01.GeneralAdmin.CostCenterMaster" %>
            ...
            <div class="content-wrapper">
                ...
                <asp:Table runat="server" ID="tblPage" CssClass="asptbllinks">
                    <asp:TableRow ID="PageAction_List" runat="server">
                        ...
                        </asp:TableCell></asp:TableRow><asp:TableRow ID="PageAction_Entry" runat="server">
                        <asp:TableCell>
                            <table class="table-devide">
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:TextBox runat="server" ID="txtCode" TabIndex="5" CssClass="input-half" onkeydown="limitText(this,40);"
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:TextBox runat="server" ID="txtName" TabIndex="6" CssClass="input-half" onkeydown="limitText(this,40);"
                                                onkeyup="limitText(this,40);">
                                            </asp:TextBox>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            <asp:Label ID="Label1" runat="server" Text="<%$ resources:Department%>" AssociatedControlID="ddlDepartment"></asp:Label>
                                            <asp:DropDownList runat="server" ID="ddlDepartment" TabIndex="8" OnSelectedIndexChanged="ActionHandler"
                                                AutoPostBack="true" CssClass="input-medium">
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="div2col-S">
                                            <asp:Label ID="Label2" runat="server" Text="<%$ resources:Sub Department %>" AssociatedControlID="ddlSubDepartment"></asp:Label>
                                            <asp:DropDownList ID="ddlSubDepartment" runat="server" CssClass="select-small-a1"
                                                TabIndex="9">
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlGroup" TabIndex="8" CssClass="input-medium">
                                            </asp:DropDownList>
                                ...
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="lnkShowCostCenterAccounts" Visible="false" ForeColor="Blue" Text="<%$ resources:Show_Maped_Accounts%>" runat="server" OnClientClick="javascript:return ShowACDetails();" >
                                        </asp:LinkButton>
                                    </td>
                                </tr>
                             ...
                             <div id="divACList" class="grdTable w100perc" >
                                        <asp:GridView runat="server" ID="gridListAccounts" Width="100%" AllowPaging="false"
                                            PageSize="25" AllowSorting="True" OnSorting="ActionHandler" AutoGenerateColumns="false" EmptyDataRowStyle-HorizontalAlign="Center"
                                            ...
                                            <Columns>
                                               <%-- <asp:TemplateField HeaderText="SlNo">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSlNO" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(ERP.Utilities.CommonFunctions.GetEncodedString(Eval("ROW_NO")),5) %>'
                                                            ToolTip=''></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                </asp:TemplateField>--%>
                                                <asp:TemplateField HeaderText="<%$ resources:AC_Code%>" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblACCOde" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(ERP.Utilities.CommonFunctions.GetEncodedString(Eval("COA_CODE")),15) %>'
                                                            ToolTip=''></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="20%" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="<%$ resources:AC_Name%>" SortExpression="<%$ resources:DataFieldRes,AccountName %>">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblACName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(ERP.Utilities.CommonFunctions.GetEncodedString(Eval("COA_NAME")),100) %>'
                                                            ToolTip=''></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                </asp:TemplateField>
                                        ...
                                        <uc1:PagerControl ID="uclPaging1" runat="server" />
                                        <div class="clear">
                                        </div>
                                    </div>
