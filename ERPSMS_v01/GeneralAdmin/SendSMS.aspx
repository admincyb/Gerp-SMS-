<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendSMS.aspx.cs" Inherits="ERPSMS_v01.GeneralAdmin.SendSMS"
    Theme="ClassicExt" MasterPageFile="~/ERPSMS_2.Master" Title="<%$ Resources:Captions,Title_SendSMS %>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function BindEmployee() {
            GrandScriptUtils.MakeAutoCompleteDDL("txtEmployee ", url + "?EmpCategory=2" + "&EmpDept=" + $("[id$=hdfHdDepartment]").val() + "&EmpBranch=" + $("[id$=hdfHdBranchLocation]").val() + "&EmpCompany=", "hdfEmployee", true, true, "EMPLOYEEAUTOCOMPLETE", "", true, true, false, 1, '<%= Resources.ErpRes.All_Small %>');
        }
        ...
        $("[id*=chkEmp_popUp]").live("click", function () {
            var grid = $(this).closest("table");
            ...
            if (!$(this).is(":checked")) {
                ...
                $("td", $(this).closest("tr")).addClass("selected");
                if ($("[id*=chkEmp_popUp]", grid).length == $("[id*=chkEmp_popUp]:checked", grid).length) {
                    ...
                    <asp:TableRow ID="PageAction_List" runat="server" Style="display: none;">
                        ...
                        <asp:TableCell>
                            <div class="search-colapse-b">
                                <h1>
                                    <%= GetLocalResourceObject("ImportSMS").ToString()%></h1>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="divcol-S padgtop7 padgbotm3">
                                                ...
                                                <asp:TextBox runat="server" ID="txtImportDate" TabIndex="70" CssClass="input-w8per margnbotm0"
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" class="display-inline">
                                                    <ContentTemplate>
                                                        <asp:Label runat="server" ID="lblSourceFile" Text="<%$ resources: SourceFileStar %>"
                                                            CssClass="lbl-9-1perc" AssociatedControlID="fupImport"></asp:Label>
                                        ...
                                        <td>
                                            <div class="div2col-S padgtop7 padgbotm3 margnbotm5">--%>
                                                <a id="aTmpDwn" tabindex="77" class="btnInner-dwn btnInner-med-size decoration-none float-right margnrgt0-1per"
                                                    href='<%= Page.ResolveClientUrl((string.IsNullOrEmpty(System.Configuration.ConfigurationManager.AppSettings["UploadPath"].ToLower()) ? "~/Upload/" : System.Configuration.ConfigurationManager.AppSettings["UploadPath"].ToLower() )+ "Template/" + GetGlobalResourceObject("ConfigurationsRes", "HrmsImportTemplateSMS").ToString())%>'>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Message%> " SortExpression="">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblMessage" runat="server" Text='<%# Eval("SMQ_MESSAGE") %>'
                                                    ToolTip='<%# Eval("SMQ_MESSAGE") %>' align="justify"></asp:Label>
                                            </ItemTemplate>
                                      ...
                                      <%--  Copy btn--%>
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Button ID="btnCopy" runat="server" OnClick="ActionHandler" CommandName="COPY"
                                                   CommandArgument='<%# Eval("SMQ_PK") %>'  SkinID="btnInner-copy" ToolTip="Copy" TabIndex="22"   />                                                
                                            </ItemTemplate>
                    ...
                    <div id="Div5" runat="server" class="gridwrap maxh-370">
                        <asp:GridView ID="grdEmployeePopUpList" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <%--<asp:TemplateField HeaderText="<%$ resources:Company %>" SortExpression="" HeaderStyle-Width="8%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCompanyPopUp" runat="server" Text='<%#ERP.Utilities.CommonFunctions.GetShortString(Eval("EMP_COMPANY_TEXT"),60) %>'
                                            ToolTip='<%# Eval("EMP_COMPANY_TEXT") %>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="8%" />
                                </asp:TemplateField>--%>
