<%@ Page Title="<%$ Resources:Captions,Title_UserManagement %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" Theme="ClassicExt"  CodeBehind="CreateNewUser.aspx.cs" Inherits="ERPSMS_v01.GeneralAdmin.CreateNewUser" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/Administration/Configurations/CreateNewUser.js"
   ...
   <script type="text/javascript">
       ...
       function isNumber(evt) {
           ...
           if (charCode > 31 && (charCode < 48 || charCode > 57)) {
               if (charCode == 8 || charCode == 43 || charCode == 45 || charCode == 47 || charCode == 59 || charCode == 32 || charCode == 44) //backspace=>8,Plus=>43,Comma=>44,Hyphen=>45,Backslash=>47,semicolumn=>59,SPACE=>32,
                   return true;
               return false;
           }
           return true;
                        ...
                        <ul runat="server" id="pnlListing">
                            <li>
                                <asp:Button ID="btnUserMapping" Visible="false" runat="server" SkinID="btnInner-add"
                                    ...
                                    TabIndex="101" ToolTip="<%$Resources:Controls,UserMapping%>" />
                            </li>
                            <li>
                                <asp:Button ID="btnSave" runat="server" SkinID="btnInner-Save" Text="<%$Resources:Controls,Save%>"
                                    ...
                                    CommandName="SAVE" TabIndex="102" EnableViewState="false" />
                            </li>
                            <li>
                            ...
                            <li>
                                <asp:Button ID="btnCancel" runat="server" SkinID="btnInner-Cancel" Text="<%$Resources:Controls,Cancel%>"
                                    OnClick="ActionHandler" CommandName="CANCEL" TabIndex="104" /><%--OnClientClick="javascript:return CancelFun();"--%>
                            </li>
                        </ul>
                    </asp:TableCell>
                </asp:TableRow>
        ...
        <div class="tab-container padgrgt0" id="divTabContainer" runat="server">
            <ul id="tab-menu">
                ...
                <li><span id="spnLocationMapping" runat="server" class="tab-inactive">
                  ...
                  <li><span id="spnMISrpts" runat="server" class="tab-inactive">
                    <asp:LinkButton runat="server" ID="lnkMISrpts" Text="<%$ resources:ManageMISReports %>"
                        TabIndex="15" CommandName="MANAGEMISREPORTS" CommandArgument="SEC_ActionPanel"
                        OnClick="ActionHandler" CssClass="tab-inactive"></asp:LinkButton>
                </span></li>
            </ul>
        </div>
    ...
    <div class="content-wrapper">
        <asp:MultiView runat="server" ID="mltUserTabs" ActiveViewIndex="0">
                        ...
                        <tr>
                            ...
                            <asp:RequiredFieldValidator ID="vrfEmployee" CssClass="star" SetFocusOnError="true"
                             ...
                             <div class="clear">
                                    ...
                                    <asp:Label ID="lblContactNo" runat="server" AssociatedControlID="txtPassword" Text="<%$ resources:ContactNo %>" />
                                    <asp:TextBox runat="server" ID="txtContactNo" MaxLength="50"  onkeypress="return isNumber(event)"
                                        TabIndex="3"  EnableViewState="true" CssClass="input-half" />                                    
                                    <div class="clear">
                                    </div>
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlStatus" TabIndex="5" CssClass="select-half-a margnlft-minus4">
            ...
            <asp:View ID="viewLocationMapping" runat="server">
             ...
             <asp:View ID="viewManageMISrpts" runat="server">
                <div class="treeview-center">
                    <div class="treeview max-500">
                        <h4>
                            MIS Reports
                        ...
                        <asp:TreeView ID="trvMISReports" runat="server" ShowLines="True" ExpandDepth="0"
                            SelectedNodeStyle-Font-Bold="true" LeafNodeStyle-CssClass="lineheight-22" SelectedNodeStyle-ForeColor="#236cb5"
                            SelectedNodeStyle-BackColor="#e6f3ff" OnClick="OnCheckBoxCheckChanged(event);">
                        </asp:TreeView>
                    </div>
