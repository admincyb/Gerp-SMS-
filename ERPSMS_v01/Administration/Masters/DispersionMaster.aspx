<%@ Page Title="<%$ Resources:Captions,Title_DispersionFormulation %>" Language="C#"
    ...
    AutoEventWireup="true" CodeBehind="DispersionMaster.aspx.cs" Inherits="ERPSMS_v01.Administration.Masters.DispersionMaster" %>
            ...
            <table rules="all" id="grdDispersionList" grandtype="GrandGrid" ajaxurl="DispersionManagement.do?Action=GetDispersionList"
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="DSP_PREP_TIME" sortable="false" align="left" width="10%">
