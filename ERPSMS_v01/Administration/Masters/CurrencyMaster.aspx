<%@ Page Title="<%$ Resources:Captions,Title_CurrencyMaster %>" Language="C#" Theme="Classic"
    EnableEventValidation="false" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true"
    CodeBehind="CurrencyMaster.aspx.cs" Inherits="ERPSMS_v01.Administration.Masters.CurrencyMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <table rules="all" id="grdCurrency" grandtype="GrandGrid" pagesize="20" paging="true"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th fieldmap="CUR_NAME" sortable="true" width="25%" align="left">
                                    <%=Resources.Controls.CurrencyName%>
                                </th>
                                <th fieldmap="CUR_CODE" sortable="true" width="25%" align="left">
                                    <%=Resources.Controls.CurrencyCode%>
                                </th>
                                <th fieldmap="CUR_FRACTION" sortable="true" width="20%" align="left">
                                    <%=Resources.Controls.Fraction%>
                                </th>
                                <th fieldmap="CUR_SYMBOL" sortable="true" width="20%" align="left">
            ...
            <div id="divExchange" title="<%=Resources.Captions.ExchangeRate%>">
                ...
                <div class="content-wrapper">
                    <div class="divcolmiddle-S">
                        <label for="lblFromExchange">
                            <%=Resources.Controls.From%>
                            *
                        </label>
                        <asp:Label ID="lblFromExchange" runat="server" Text=""></asp:Label>
                        <label for="CUC_TO">
                            <%=Resources.Controls.To%>
                            *
                        </label>
                        <asp:DropDownList ID="CUC_TO" runat="server" TabIndex ="8">
                        </asp:DropDownList>
                        <label for="CUC_CONV_FACT">
                            <%=Resources.Controls.Rate%>
                            *
                        </label>
                        <asp:TextBox runat="server" ID="CUC_CONV_FACT" TabIndex="9" MaxLength="20" EnableViewState="False" onkeypress="return isFloatNumberKey(event);"></asp:TextBox>
                        <label for="CUC_FROM_DATE">
                            <%=Resources.Controls.FromDate%>
                            *
                        </label>
                        <asp:TextBox runat="server" ID="CUC_FROM_DATE" TabIndex="10" MaxLength="100" EnableViewState="False" onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                        <label for="CUC_TO_DATE">
                            <%=Resources.Controls.ToDate%>
                            *
                        </label>
                        <asp:TextBox runat="server" ID="CUC_TO_DATE" TabIndex="11" MaxLength="100" EnableViewState="False" onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                        <div class="clear">
                        </div>
                    </div>
                </div>
                ...
                <div id="ExchangeDiv">
                    <div class="grdTable max-250">
                        <table rules="all" id="grdExchangeRate" grandtype="GrandGrid" pagesize="5" paging="true"
    ...
    <asp:HiddenField ID="CUR_PK" runat="server" Value="0" EnableViewState="false" />
    <asp:HiddenField runat="server" ID="CUC_PK" Value="0" EnableViewState="false" />
    <asp:HiddenField runat="server" ID="CUC_FROM" Value="0" EnableViewState="false" />
