...
namespace ERPSMS_v01.Administration.Configurations
{
    public partial class CreateNewUser : ERP.Store.UI.MyBasePage
    {
        ...
        //                Response.Redirect(Resources.PageURL.UserManagement + CurrPK.ToString(), true);
        //                break;
        ...
        //                    if (IsValid)
        //                    {
        //                        if (UserType != (int)UserRight.SuperAdmin)
        //                        {
        //                            if ((CurrPK > 0
        ...
        //{
        //    int count = 0;
        //    DataTable dtActiveCount = UserManagementBL.GetUserCount(userType, Convert.ToInt32(RecordStatus.ACTIVE));
