<%@ Page Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true"
    CodeBehind="SSISPackageImport.aspx.cs" Inherits="ERPSMS_v01.Administration.Configurations.SSISPackageImport"
    Theme="Classic" ValidateRequest="false" %>

<%@ Register Src="~/UserControls/FileUploader.ascx" TagName="GtiFileUploader" TagPrefix="Gti" %>
                        ...
                        <ul runat="server" id="pnlEntry">
                            <li>
                                <asp:Button runat="server" ID="btnImport" CommandName="IMPORT" TabIndex="2" Text="<%$resources:Import %>"
                                    OnClick="ActionHandler" ToolTip="<%$resources:Import %>" 
                                    SkinID="btnInner-add" ValidationGroup="Import" OnClientClick="javascript:ValidatePageNow('Import')" />
                                <asp:Button runat="server" ID="btnClear" CommandName="CLEAR" TabIndex="2" Text="<%$resources:Clear %>"
                                    OnClick="ActionHandler" ToolTip="<%$resources:Clear %>" 
                                    SkinID="btnInner-add" />
                            </li>
                        </ul>
                    </asp:TableCell>
