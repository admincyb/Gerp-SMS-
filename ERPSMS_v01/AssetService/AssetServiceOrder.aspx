<%@ Page Title="<%$ Resources:Captions,Title_AssetServiceOrder %>" Language="C#"
    EnableEventValidation="false" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true"
    CodeBehind="AssetServiceOrder.aspx.cs" Inherits="ERPSMS_v01.AssetService.AssetServiceOrder"
    Theme="ClassicExt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            GrandScriptUtils.MakeAutoCompleteDDL("txtListTrxNo", url + "?Type=OSH_NO", "hdfTrxPk", true, true, "GETASSETSERVICEORDERNOAUTO");
        ...
        function CheckAllPR(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=grdPendingSRItems.ClientID %>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel runat="server" ID="aupdpnlBasicInfo">
        <ContentTemplate>
                            ...
                            <asp:TableCell ID="SEC_ActionPanel" CssClass="SEC_ACTION" HorizontalAlign="Right">
                                ...
                                <ul runat="server" id="pnlEntry" style="display: none">
                                    ...
                                    <li runat="server" id="pnlPrint">
                                        <asp:Button runat="server" ID="btnPrint" CommandName="PRINT" TabIndex="151" Text="<%$resources:Controls,Print %>"
                                ...
                                <ul runat="server" id="pnlListing" style="display: none">
                                    ...
                                    <li id="pnlEditforCancel">
                                        <asp:Button runat="server" TabIndex="155" ID="btnEditforCancel" CommandName="EDITFORCANCEL"
                                            OnClick="ActionHandler" Text="<%$resources:CancelSO %>" CommandArgument="SEC_ActionPanel"
                                            SkinID="btnInner-cancel1" ToolTip="<%$resources:CancelSO %>" />
                                    </li>
                                    <li>
                                ...
                                <asp:GridView runat="server" ID="grdList" Width="100%" AllowPaging="false" PageSize="<%$ resources:PageSize%>"
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:RadioButton ID="rbtSelect" runat="server" CssClass="rdoSelection" AutoPostBack="true"
                                                    ...
                                                    TabIndex="10" />
                                                <asp:HiddenField runat="server" ID="hdfOSH_PK" Value='<%# Eval("OSH_PK") %>' />
                                                <asp:HiddenField runat="server" ID="hdfStatus" Value='<%# Eval("OSH_STATUS") %>' />
                                                <asp:HiddenField ID="hdfDelStatus" runat="server" Value='<%# Eval("OSH_DEL_STATUS") %>' />
                                                <asp:HiddenField ID="hdfDept" runat="server" Value='<%# Eval("OSH_DEPT") %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="2%" />
                                            <HeaderStyle Width="2%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:ASODate%> " SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblGvDate" runat="server" Text='<%#  Eval("OSH_DATE")!=""? Convert.ToDateTime( Eval("OSH_DATE")).ToString(Resources.Constants.ReportDateFormat):"" %>'
                                                    ToolTip='<%# Eval("OSH_DATE", Resources.Constants.DateFormatGrid)%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                            <HeaderStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:TrxNo %>" SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNo" runat="server" Text='<%# string.IsNullOrEmpty(Convert.ToString(Eval("OSH_NO")))?Resources.ErpRes.Draft:Eval("OSH_NO")%>'
                                                    ToolTip='<%# string.IsNullOrEmpty(Convert.ToString(Eval("OSH_NO")))?Resources.ErpRes.Draft:Eval("OSH_NO")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="12%" />
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Controls,RequestingStore%>" SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRequestStore" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(ERP.Utilities.CommonFunctions.GetEncodedString(Eval("OSH_DEPT_STORE_TEXT")),35) %>'
                                                    ToolTip='<%# System.Web.HttpUtility.HtmlDecode(Convert.ToString(Eval("OSH_DEPT_STORE_TEXT")))%>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:ServiceType%> " SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSeviceType" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(ERP.Utilities.CommonFunctions.GetEncodedString(Eval("OSH_SERVICE_TYPE_TEXT")),55) %>'
                                                    ToolTip='<%# System.Web.HttpUtility.HtmlDecode(Convert.ToString(Eval("OSH_SERVICE_TYPE_TEXT")))%>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="20%" />
                                            <ItemStyle Width="20%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Vendor%> " SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblVendorName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(System.Web.HttpUtility.HtmlDecode(Convert.ToString(Eval("OSH_VENDOR_TEXT"))),45) %>'
                                                    ToolTip='<%# System.Web.HttpUtility.HtmlDecode(Convert.ToString(Eval("OSH_VENDOR_TEXT")))%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="28%" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Button ID="imgStatus" runat="server" OnClientClick="javascript:return false;"
                                                    CssClass='<%# Eval("OSH_CSS_CLASS") %>' ToolTip='<%# Eval("OSH_STATUS_TEXT") %>' />
                                                <asp:HiddenField runat="server" ID="hdfApproved" Value='<%# Eval("OSH_STATUS") %>' />
                                            </ItemTemplate>
                    ...
                    <asp:TableRow ID="PageAction_Entry" runat="server">
                        <asp:TableCell>
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:Label ID="lblDate" runat="server" Text="<%$ resources:ASODateReq%>" AssociatedControlID="txtDate"
                            ...
                            <h3 class="fontWGT-Nrml">
                                <%= GetLocalResourceObject("PendingServiceRequestItems").ToString()%>
                            </h3>
                            <div class="gridwrap">
                                <asp:GridView runat="server" ID="grdPendingSRItems" Width="100%" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:SR# %>">
                                            <ItemTemplate>
                                                <asp:HiddenField runat="server" ID="hdfSRH_PK" Value='<%# Eval("SRD_SRH_HDR") %>' />
                                                <asp:HiddenField runat="server" ID="hdfSRD_PK" Value='<%# Eval("SRD_PK") %>' />
                                                <asp:HiddenField runat="server" ID="hdfSRH_CURRENCY" Value='<%# Eval("SRH_CURRENCY") %>' />
                                                <asp:HiddenField runat="server" ID="hdfSRH_DEPT" Value='<%# Eval("SRH_DEPT") %>' />
                                                ...
                                                <asp:Label ID="lblSRD_SRH_NO" runat="server" Text='<%# Eval("SRD_SRH_NO") %>' ToolTip='<%# Eval("SRD_SRH_NO") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Vendor %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblVendorName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(HttpUtility.HtmlDecode(Eval("SRH_VENDOR_TEXT").ToString()),56) %>'
                                                    ToolTip='<%# HttpUtility.HtmlDecode(Eval("SRH_VENDOR_TEXT").ToString())%>'></asp:Label>
                                                <asp:HiddenField runat="server" ID="hdfVendorPk" Value='<%# Eval("SRH_VENDOR") %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="24%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:AssetType %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblServiceTypeName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(HttpUtility.HtmlDecode(Eval("SRD_ASSET_TYPE_TEXT").ToString()),56) %>'
                                                    ToolTip='<%# HttpUtility.HtmlDecode(Eval("SRD_ASSET_TYPE_TEXT").ToString())%>'></asp:Label>
                                                <asp:HiddenField runat="server" ID="hdfSRH_SERVICE_TYPE" Value='<%# Eval("SRH_SERVICE_TYPE") %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="22%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Asset %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAssetName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(HttpUtility.HtmlDecode(Eval("SRD_ASSET_TEXT").ToString()),56) %>'
                                                    ToolTip='<%# HttpUtility.HtmlDecode(Eval("SRD_ASSET_TEXT").ToString())%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="22%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Currency %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCurrencyName" runat="server" Text='<%# Eval("SRH_CURRENCY_TEXT") %>'
                                                    ToolTip='<%# Eval("SRH_CURRENCY_TEXT")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="8%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:Amount %>" ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNetAmt" runat="server" Text='<%# Eval("SRD_AMOUNT", "{0:c}") %>'
                                                    ToolTip='<%# Eval("SRD_AMOUNT", "{0:c}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="12%" />
                                    ...
                                    <Gti:ExtGridView runat="server" ID="grdAssetDetails" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button runat="server" ID="btnActivityDetails" OnClick="ActionHandler" CommandName="ACTIVITYLIST"
                                                        CommandArgument='<%# Eval("OSD_PK") %>' EnableTheming="false" Style="display: none" />
                                                    <asp:HiddenField runat="server" ID="hdfIsExpanded" Value="1" />
                                                    <asp:HiddenField runat="server" ID="hdfSRDPK" Value='<%# Eval("OSD_PK") %>' />
                                                    <asp:HiddenField runat="server" ID="hdfSRDSlNo" Value='<%# Eval("OSD_SL_NO") %>' />
                                                    <asp:HiddenField runat="server" ID="hdfOSD_SRD_DTL" Value='<%# Eval("OSD_SRD_DTL") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$ resources:AssetType %>">
                                                <ItemTemplate>
                                                    <div class="ellipsisText">
                                                        <asp:Label ID="lblAssetType" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval("OSD_ASSET_TYPE_TEXT"),60) %>'
                                                            ToolTip='<%#HttpUtility.HtmlDecode(Convert.ToString(Eval("OSD_ASSET_TYPE_TEXT"))) %>'></asp:Label>
                                                        <asp:HiddenField runat="server" ID="hdfAssetTypePK" Value='<%# Eval("OSD_ASSET_TYPE") %>' />
                                                    </div>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ resources:Asset %>">
                                                <ItemTemplate>
                                                    <div class="ellipsisText">
                                                        <asp:Label ID="lblAssetName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval("OSD_ASSET_TEXT"),60) %>'
                                                            ToolTip='<%#HttpUtility.HtmlDecode(Convert.ToString(Eval("OSD_ASSET_TEXT"))) %>'></asp:Label>
                                                        <asp:HiddenField runat="server" ID="hdfAssetPK" Value='<%# Eval("OSD_ASSET") %>' />
                                                    </div>
                                                </ItemTemplate>
                                                <ItemStyle CssClass="col-md-9 col-sm-9 col-xs-9" HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$ resources:Amount %>" ItemStyle-HorizontalAlign="Right"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotal" runat="server" Text='<%# GetFormattedCurrency(Eval("OSD_AMOUNT")) %>'
                                                        ToolTip='<%# GetFormattedCurrency(Eval("OSD_AMOUNT")) %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgShowpopup" runat="server" CommandName="SHOWPOPUP" SkinID="imbaddnew"
                                                        OnClick="ActionHandler" CommandArgument='<%# Eval("OSD_SL_NO") %>' TabIndex="12"
                                                        ToolTip="<%$ resources:Controls,Add  %>" />
                                                    <asp:ImageButton ID="imbAssetEdit" runat="server" CommandName="EDITASSET" SkinID="imbeditgrid"
                                                        Visible="false" OnClick="ActionHandler" CommandArgument='<%# Eval("OSD_SL_NO") %>'
                                                    ...
                                                    <div class="hscroll">
                                                        <asp:GridView runat="server" ID="grdItems" Width="100%" PageSize="<%$ resources:PageSize%>"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:HiddenField ID="hdfActivityPK" runat="server" Value='<%# Eval("OID_PK") %>' />
                                                                        <asp:HiddenField runat="server" ID="hdfHasChildren" Value="0" />
                                                                        <asp:HiddenField ID="hdfItm_SlNo" runat="server" Value='<%# Eval("OID_ITEM_SL_NO") %>' />
                                                                        <asp:HiddenField ID="hdfOID_SID_DTL" runat="server" Value='<%# Eval("OID_SID_DTL") %>' />
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="1%" HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:HiddenField ID="hdfSequence" runat="server" Value='<%# Eval("OID_SL_NO") %>' />
                                                                        <asp:ImageButton CssClass="nomargin" ID="imbRuleUp" SkinID="move-up" runat="server"
                                                                            ...
                                                                            CommandArgument='<%# Eval("OID_SL_NO") %>' TabIndex="1"></asp:ImageButton>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ resources:Items %>" SortExpression="">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCode" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval("OID_ASR_ITEM_TEXT"),30) %>'
                                                                            ToolTip='<%# HttpUtility.HtmlDecode(Convert.ToString(Eval("OID_ASR_ITEM_TEXT"))) %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="18%" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="<%$ resources:Quantity %>" SortExpression="">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# GetFormattedNumber(Eval("OID_QTY")) %>'
                                                                            ToolTip='<%# GetFormattedNumber(Eval("OID_QTY")) %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ resources:UOM %>" SortExpression="">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblUom" runat="server" Text='<%# Eval("OID_UOM_TEXT") %>' ToolTip='<%# Eval("OID_UOM_TEXT") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ resources:Rate %>" SortExpression="" ItemStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblRate" runat="server" Text='<%# GetFormattedRate(Eval("OID_RATE")) %>'
                                                                            ToolTip='<%# GetFormattedRate(Eval("OID_RATE")) %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ resources:Amount %>" ItemStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAmt" runat="server" Text='<%# GetFormattedCurrency(Eval("OID_AMOUNT")) %>'
                                                                            ToolTip='<%# GetFormattedCurrency(Eval("OID_AMOUNT")) %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="10%" />
                                                                    <HeaderStyle CssClass="amount-numeric" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="<%$ resources:Discount %>" ItemStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblDiscount" runat="server" Text='<%# Eval("OID_DISCOUNT", "{0:c}") %>'
                                                                            ToolTip='<%# Eval("OID_DISCOUNT", "{0:c}") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="7%" />
                                                                    <HeaderStyle CssClass="amount-numeric" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="<%$ resources:Tax %>" ItemStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblTax" runat="server" Text='<%# Eval("OID_TAX", "{0:c}") %>' ToolTip='<%# Eval("OID_TAX", "{0:c}") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="8%" />
                                                                    <HeaderStyle CssClass="amount-numeric" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="<%$ resources:TotalAmount %>" ItemStyle-HorizontalAlign="Right">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblNetAmt" runat="server" Text='<%# GetFormattedCurrency(Eval("OID_NET_AMOUNT")) %>'
                                                                            ToolTip='<%# GetFormattedCurrency(Eval("OID_NET_AMOUNT")) %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="12%" />
                                                                    <HeaderStyle CssClass="amount-numeric" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="<%$ resources:Remarks %>">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblRemarks" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Eval("OID_REMARKS"),30) %>'
                                                                            ToolTip='<%# Eval("OID_REMARKS") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="8%" />
                                                                    <HeaderStyle />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="imbItemEdit" runat="server" CommandName="EDITITEM" SkinID="imbeditgrid"
                                                                            CommandArgument='<%# Eval("OID_SL_NO") %>' OnClick="ActionHandler" ToolTip="<%$resources:Controls,Edit %>"
                                                                            TabIndex="13" />
                                                                        <asp:ImageButton ID="imbItemDelete" runat="server" CommandName="REMOVEITEM" SkinID="imbdeletegrid"
                                                                            OnClick="ActionHandler" CommandArgument='<%# Eval("OID_SL_NO") %>' ToolTip="<%$resources:Controls,Delete %>"
                                        ...
                                        <asp:GridView runat="server" ID="grdTaxDetails" Width="100%" AllowSorting="false"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Type">
                                                    <ItemTemplate>
                                                        <asp:HiddenField ID="hdfTaxSplitPK" runat="server" Value='<%#Eval("SSD_PK") %>' />
                                                        <asp:HiddenField ID="hdfTaxPK" runat="server" Value='<%#Eval("SSD_TAX") %>' />
                                                        <asp:Label ID="lblTaxText" runat="server" Text='<%# Convert.ToString(Eval("SSD_TAX_TEXT")) == string.Empty ? Resources.Report.Custom : Convert.ToString(Eval("SSD_TAX_TEXT")) %>'
                                                            ToolTip='<%# HttpUtility.HtmlDecode(Convert.ToString(Eval("SSD_TAX_TEXT")) == string.Empty ? Resources.Report.Custom : Convert.ToString(Eval("SSD_TAX_TEXT"))) %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="35%" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTaxName" runat="server" Text='<%#Eval("SSD_NAME") %>' ToolTip='<%# HttpUtility.HtmlDecode(Convert.ToString(Eval("SSD_NAME"))) %>'></asp:Label>
                                                        <asp:HiddenField ID="hdfTaxName" runat="server" Value='<%#Eval("SSD_NAME") %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle Width="35%" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTaxAmount" runat="server" Text='<%#GetFormattedCurrency(Eval("SSD_TAX_AMT")) %>'
                                                            ToolTip='<%#GetFormattedCurrency(Eval("SSD_TAX_AMT")) %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="22%" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                            ...
                            <asp:Button ID="btnVendorSel" runat="server" OnClick="ActionHandler" CommandName="PENDINGREQUESTS"
                                Style="display: none" EnableTheming="false" />
            ...
            <asp:HiddenField ID="SR_PK" runat="server" Value="0" />
