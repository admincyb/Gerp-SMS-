<%@ Page Title="<%$ Resources:Captions,Title_ContainerInspection %>"  Language="C#" AutoEventWireup="true" CodeBehind="ContainerInspectionCreate.aspx.cs" 
         Inherits="ERPSMS_v01.Sales.ContainerInspectionCreate" Theme="Classic" MasterPageFile="~/ERPSMS_2.Master" %>
                                ...
                                <ul runat="server" id="pnlEntry">
                                    <li runat="server" id="pnlSubmit">
                                        <asp:Button runat="server" ID="btnSubmit" CommandName="SUBMIT" TabIndex="51" Text="<%$resources:ErpRes,Submit %>"
                                            OnClick="ActionHandler" OnClientClick="javascript:ValidatePageNow('ContainerInspection')" ValidationGroup="ContainerInspection"
                                    ...
                                    <li>
                                        <asp:Button runat="server" ID="btnCancel" Text="<%$resources:ErpRes,Cancel %>" OnClick="ActionHandler"
                                            CommandName="CANCEL" TabIndex="94" CommandArgument="SEC_ActionPanel" SkinID="btnInner-Cancel"
                        ...
                        <asp:TableCell>
                            ...
                            <asp:HiddenField ID="hdfInspectionNo" runat="server" Value="" />
                                    ...
                                    <tr>
                                        <td>
                                           <div class="div2col-S">
                                              ...
                                              <asp:RequiredFieldValidator ID="vrfDeliverynumber" CssClass="star" SetFocusOnError="true" InitialValue="<%$ resources:ErpRes, AutoDefaultValue %>"
                                                        ValidationGroup="ContainerInspection" EnableClientScript="true" runat="server" ControlToValidate="txtDespatchNumber"
                                            ...
                                            <asp:Button ID="btnGODetails" runat="server" OnClick="ActionHandler" CommandName="SHOW"
                                              ...
                                              <%-- <asp:DropDownList ID="ddlDeliveryNumber" runat ="server" TabIndex ="1" CssClass ="medium" ></asp:DropDownList>--%>
                                        ...
                                        <td>
                                            <div class="div2col-S">
                                                <asp:Label runat="server" ID="lblInspectionNo" Text="<%$ resources:InspectionNo %>" AssociatedControlID="lblInspectionNoTxt"
                                                    ></asp:Label>
                                                <asp:Label runat="server" ID="lblInspectionNoTxt" TabIndex="2"></asp:Label>
                                        ...
                                        <tr>
                                           <td>
                                            <div class="div2col-S">
                                                ...
                                                <asp:TextBox runat="server" ID="txtDate" TabIndex="3" MaxLength="12" CssClass="Uidate-picker"
                                                    onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                                                <div class="starwrap">
                                                    <asp:RequiredFieldValidator ID="vrfDate" CssClass="star" SetFocusOnError="true"
                                                        ValidationGroup="ContainerInspection" EnableClientScript="true" runat="server" ControlToValidate="txtDate"
                                           ...
                                           <td>
                                            <div class="div2col-S">
                                                ...
                                                <asp:TextBox runat="server" ID="txtContainerNo" TabIndex="4" MaxLength="200"></asp:TextBox>
                                                <div class="clear">
                                                </div>
                                            </div>
                                        </td>
                                         ...
                                         <tr>
                                          <td>
                                            <div class="div2col-S">
                                               ...
                                               <asp:TextBox runat="server" ID="txtSerialNo" TabIndex="5" MaxLength="200"  ></asp:TextBox>
                                                <div class="clear">
                                                </div>
                                            </div>
                                        </td>
                                          <td>
                                             <div class="div2col-S">
                                              <asp:Label runat="server" ID="lblISOPAS" Text="<%$ resources:ISOPAS %>" AssociatedControlID="txtISOPAS"></asp:Label>
                                                <asp:TextBox runat="server" ID="txtISOPAS" TabIndex="6" MaxLength="200" ></asp:TextBox>
                                        ...
                                        <tr>
                                          <td colspan ="2">
                                             <div class="divcol-S">
                                                ...
                                                <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" MaxLength="500" TabIndex="7" Width="715"
                                ...
                                <div class="clear">
                                 ...
                                 <CL1:CheckListItems ID="uclCheckList" runat="server" TabIndex="8" />

                        </asp:TableCell></asp:TableRow><asp:TableRow ID="ModifiedDatePnl" runat="server" CssClass="last-modified" Visible="false">
                        <asp:TableCell>
                            <asp:Label ID="lblLastModifiedHDR" runat="server"></asp:Label>
                        </asp:TableCell></asp:TableRow></asp:Table><div id="diverror" style="display: none">
                    <asp:Label runat="server" ID="litErrorMsg" ClientIDMode="Static" CssClass="star"></asp:Label><asp:ValidationSummary ID="vsPage" ValidationGroup="ContainerInspection" runat="server" />
