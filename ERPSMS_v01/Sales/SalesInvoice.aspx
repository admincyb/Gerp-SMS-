<%@ Page Title="<%$ Resources:Captions,Title_SalesInvoice %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="SalesInvoice.aspx.cs" Inherits="ERPSMS_v01.Sales.SalesInvoice"
    Theme="ClassicExt" %>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell ID="SEC_ActionPanel" CssClass="SEC_ACTION" HorizontalAlign="Right">
                                ...
                                <ul runat="server" id="pnlEntry" style="display: none">
                                    ...
                                    <li runat="server" id="pnlInActive">
                                        <asp:Button runat="server" ID="btnInActive" CommandName="INACTIVE" Text="<%$resources:Controls,Delete %>"
                                            OnClick="ActionHandler" TabIndex="54" CommandArgument="SEC_ActionPanel" SkinID="btnInner-Delete"
                                    ...
                                    <li>
                                        <asp:Button runat="server" ID="btnJournalize" CommandName="JOURNALIZE" TabIndex="57"
                                    ...
                                    <li id="pnlAlert" runat="server" visible="false">
                                        <asp:Button runat="server" ID="btnAlert" CommandName="ALERT" TabIndex="58" Text="<%$resources:Controls,Alert %>"
                                ...
                                <ul runat="server" id="pnlListing" style="display: none">
                                    ...
                                    <li>
                                        <asp:Button runat="server" ID="btnPickForReceipt" CommandName="PICKFORRECEIPT" TabIndex="44"
                                            Text="<%$resources:PickInvforReceipt %>" OnClick="ActionHandler" ToolTip="Pick Inv for Receipt"
                                            CommandArgument="SEC_ActionPanel" SkinID="btnInner-receipt" OnClientClick="javascript:return SelectedCheckBoxCount(2);" />
                                    </li>
                                    <li>
                                        <asp:Button runat="server" ID="btnPickForCrDrNote" CommandName="PICKFORCRDRNOTE"
                                            TabIndex="45" Text="<%$resources:PickForCrDrNote %>" OnClick="ActionHandler"
                    ...
                    <ul id="tab-menu">
                        <li><span id="spnPOListing" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowSC %>">
                            <asp:LinkButton runat="server" ID="lbnSOListing" Text="<%$resources:PageNameRes,SalesOrder %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="60" CssClass="tab-inactive" OnClick="ActionHandler"
                        ...
                        <li><span id="spnDeliveryOrder" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowDO %>">
                            <asp:LinkButton runat="server" ID="lnbDeliveryOrder" Text="<%$resources:PageNameRes,DeliveryOrder %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="61" OnClick="ActionHandler" CommandName="DELIVERYORDER"
                                CssClass="tab-active"></asp:LinkButton>
                        </span></li>
                        <li><span id="spnSalesInvoice" runat="server" class="tab-active" visible="<%$ resources:ConfigurationsRes,TabShowSalesAdvInvoice %>">
                            <asp:LinkButton runat="server" ID="lnbSalesInvoice" Text="<%$resources:PageNameRes,AdvanceInvoice %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="62" OnClick="ActionHandler" CommandName="SALESINVOICE"
                        ...
                        <li><span id="spnAdvanceInvoice" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowSalesInvoice %>">
                            <asp:LinkButton runat="server" ID="lnbAdvanceInvoice" Text="<%$resources:PageNameRes,SalesInvoice %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="63" OnClick="ActionHandler" CommandName="INVOICE"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li><span id="Spnmiscellaneous" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowMiscInvoice %>">
                            <asp:LinkButton runat="server" ID="lnbMiscellaneous" Text="<%$resources:PageNameRes,miscellaneous %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="64" OnClick="ActionHandler" CommandName="MISC"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li><span id="spnSalesReceipt" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowReceipt %>">
                            <asp:LinkButton runat="server" ID="lbnSalesReceipt" Text="<%$resources:PageNameRes,SalesReceipt %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="65" OnClick="ActionHandler" CommandName="SALESRECEIPT"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li><span id="spnCrDrNote" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowSalesCRDR %>">
                            <asp:LinkButton runat="server" ID="lnbCrDrNote" Text="<%$resources:PageNameRes,CreditDebitNotes %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="66" OnClick="ActionHandler" CommandName="CRDRNOTE"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li><span id="spnAcPayables" runat="server" class="tab-inactive" visible="<%$ resources:ConfigurationsRes,TabShowAR %>">
                            <asp:LinkButton runat="server" ID="lnbAcPayables" Text="<%$resources:PageNameRes,AccountReceivables %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="67" OnClick="ActionHandler" CommandName="ACRECEIVABLE"
                                ...
                                <tr id="Tr1" runat="server">
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            ...
                                            <asp:Label runat="server" ID="lblPlantName" Text="<%$ resources:Controls, CompanyPlant %>"  AssociatedControlID="ddlPlantName"
                                    ...
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            ...
                                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="select-small-a" TabIndex="3">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hdfSalesContractType" runat="server" Value='' />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:InvoiceNo %>" SortExpression="<%$ resources:DataFieldRes,SalesInvoiceNo %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblInvoiceNo" runat="server" Text='<%# Eval(Resources.DataFieldRes.SalesInvoiceNo) ==""?"[NEW]":Eval(Resources.DataFieldRes.SalesInvoiceNo)%>'
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Label ID="lblPlant" runat="server"  CssClass="<%# Eval(Resources.DataFieldRes.CMP_LINE_COLOUR) %>" Text='<%# Eval(Resources.DataTableRes.CompanyMst + "." +Resources.DataFieldRes.CMP_DISPLAY_CODE) %>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Customer %>" SortExpression="<%$ Resources:DataFieldRes,InvoiceCustomerPK%>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustomer" runat="server" Text='<%#ERP.Utilities.CommonFunctions.GetShortString( Eval(Resources.DataTableRes.CustomerMst+"."+Resources.DataFieldRes.CustomerName),65 )%>'
                                                ...
                                                <asp:HiddenField runat="server" ID="hdfCustomerPK" Value='<%# Eval(Resources.DataFieldRes.InvoiceCustomerPK) %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="45%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="<%$ resources:InvType1 %>" SortExpression="ICH_TYPE">
                                            <ItemTemplate>
                                                <asp:Label ID="lblInvType" runat="server" Text="" ToolTip=""></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="4%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:InvoiceValue %>" SortExpression="<%$ resources:DataFieldRes,SalesInvoiceNetAmountTC %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblInvoiceValue" runat="server" Text='<%# Eval(Resources.DataFieldRes.SalesInvoiceNetAmountTC, "{0:c}") %>'
                                                    ToolTip='<%# Eval(Resources.DataFieldRes.SalesInvoiceNetAmountTC, "{0:c}") %>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:BalAmt %>">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbnBalAmt" runat="server" Text='' CssClass="text-underline" ToolTip=''
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Paybydate %>" SortExpression="<%$ resources:DataFieldRes,SalesInvoiceDate %>">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPaybydate" runat="server" Text='<%# Eval(Resources.DataFieldRes.SalesPayDate, Resources.Constants.DateFormatGrid) %>'
                                                    ToolTip='<%# Eval(Resources.DataFieldRes.SalesPayDate, Resources.Constants.DateFormatGrid)%>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Wrap="false" />
                        ...
                        <asp:TableCell>
                            <table class="table-devide tablelayout" id="tblDetailHdr">
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            <asp:Label runat="server" ID="lblCustomerName" Text="<%$ resources:CustomerName%>"
                                                AssociatedControlID="lblDispCustomerName"></asp:Label>
                                            <asp:Label runat="server" ID="lblDispCustomerName" Text="" CssClass="select-half"></asp:Label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:DropDownList runat="server" ID="ddlInvoiceType" AutoPostBack="true" TabIndex="11"
                                                OnSelectedIndexChanged="ActionHandler" CssClass="select-small-b-19-11-2">
                                            </asp:DropDownList>
                                            ...
                                            <asp:Label runat="server" ID="lblCurrency" Text="<%$ resources:Currency%>" AssociatedControlID="txtCurrr"
                                                CssClass="middle-lbl-small-a-20-11-8"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtCurrr" Text="" class="input-small" TabIndex="11"
                                ...
                                <tr>
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:DropDownList ID="ddlCompanyView" Visible="false"  Enabled="false"  runat="server" CssClass="select-small-a"  >
                                            </asp:DropDownList>
                            ...
                            <div class="gridwrap">
                                <asp:GridView ID="grdSalesList" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Label ID="lblPlantCode" runat="server" Text='' ToolTip=''></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="1%" />
                                        </asp:TemplateField>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Amt Adj." SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAdj" runat="server" Text='' ToolTip=''></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:ProformaInvoiced %>" SortExpression=""
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblProformaInvoiced" runat="server" Text='' ToolTip=''></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:InvoicedNow %>" ItemStyle-HorizontalAlign="Right">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtPayNow" runat="server" onkeyup="CalculateTotal();" CssClass="input-w70 numeric"
                                                    MaxLength="15" TabIndex="15" Width="90%"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:Tax %>" SortExpression="">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSOTax" Text="0.00" runat="server" ToolTip=''></asp:Label>
