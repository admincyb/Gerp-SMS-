<%@ Page Title="<%$ Resources:Captions,Title_OpeningInv %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" Theme="ClassicExt" CodeBehind="OpeningInvoice.aspx.cs"
    Inherits="ERPSMS_v01.Sales.OpeningInvoice" %>
            ...
            <div class="fixed-buttons">
                ...
                <div class="tab-container" id="divTabContainer" runat="server">
                    <ul id="tab-menu">
                        ...
                        <li style="display:none;"><span id="spnDeliveryOrder" runat="server" class="tab-inactive">
                        ...
                        <li style="display:none;"><span id="spnSalesInvoice" runat="server" class="tab-inactive">
                        ...
                        <li><span id="Spnmiscellaneous" runat="server" class="tab-active">
                            <asp:LinkButton runat="server" ID="lnbMiscellaneous" Text="<%$resources:PageNameRes,OpeningInvoice %>"
                                CommandArgument="SEC_ActionPanel" TabIndex="75" OnClick="ActionHandler" CommandName="MISC"
                                CssClass="tab-inactive"></asp:LinkButton>
                        </span></li>
                        <li style="display:none;"><span id="spnSalesReceipt" runat="server" class="tab-inactive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:TextBox runat="server" ID="txtShipmentTerm" Text="" CssClass="input-half" TabIndex="11"
                                                MaxLength="100"></asp:TextBox>
                                            <div class="clear">
                                            </div>
                                            <asp:Label runat="server" ID="lblReference" Text="<%$ resources:Reference%>" AssociatedControlID="txtReference"></asp:Label>
                                            <asp:TextBox ID="txtReference" runat="server" MaxLength="100" TabIndex="16" CssClass="input-half"></asp:TextBox>
                                            <%--      Adding TaxID -------------------------------%>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <div id="divOtherDetails" style="display: none">
                                <table class="table-devide" id="tblOtherDetails">
                                    <tr>
                                        <td>
                                            <div class="div2col-S">
                                                <asp:Label runat="server" ID="Label2" Text="<%$ resources:PLoading%>" AssociatedControlID="ddlFromPort"></asp:Label>
                                        ...
                                        <td>
                                            <div class="div2col-S">
                                                ...
                                                <asp:TextBox ID="txtQty" runat="server" CssClass="input-small numeric" MaxLength="11"
                                                    TabIndex="26" onchange="CalculateAmount();" Text="1"></asp:TextBox>
