<%@ Page Title="<%$ Resources:Captions,Title_DirectReceipt %>" Language="C#" Theme="ClassicExt"
    EnableEventValidation="false" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true"
    CodeBehind="DirectReceiptVoucher.aspx.cs" Inherits="ERPSMS_v01.Journalize.DirectReceiptVoucher" %>
...
<asp:Content ID="cntScript" runat="server" ContentPlaceHolderID="head">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            //GrandScriptUtils.MakeAutoCompleteDDL("txtTo", url, "hdfVendor", true, true, "VENDOR");
            //GrandScriptUtils.MakeAutoCompleteDDL("txtTo", url, "hdfVendor", true, true, "CUSTOMERLIST");
            GrandScriptUtils.MakeAutoCompleteDDL("txtTo", url + "&IsSBUVendor=" + $("[id$='hdfIsSBUVendor']").val(), "hdfVendor", true, true, "CUSTOMERVENDORLIST", false, false, false, true);
...
//                        msg += '<ul><li><%= GetLocalResourceObject("Err_FavourOf") %></ul></li>';
        ...
        function CalculateTotalCCAmount() {
            ...
            $("#[id*=grdVoucherCC] [id*=lblTotalVoucherCCAmnt]").html((TotalCCSplit).toFixed(currencyDecimal));
        }
    ...
    <asp:UpdatePanel ID="aupdpnlVoucher" runat="server">
        <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                            ...
                                            <asp:TextBox ID="txtRefNo" runat="server" CssClass="input-small"
                                    ...
                                    <td colspan="2">
                                        <div class="divcol-S">
                                            ...
                                            <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" MaxLength="500"
                                                TabIndex="8" CssClass="multiline-1col" onkeydown="limitText(this,500);" onkeyup="limitText(this,500);" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <table class="gridwraptable gridwrap">
                                        ...
                                        <tr class="grd-rowhead">
                                            ...
                                            <td id="tdDebit1" runat="server">
                                                <asp:TextBox ID="txtDebit1" runat="server" CssClass="input-w70 numeric" onchange="SetDebitCreditAmt(1)"
                                                    TabIndex="19" onkeypress="return validateFloatKeyPress(this,event);" MaxLength="12" />
                                                <div class="starwrap">
                                            ...
                                            <td id="tdCredit1" runat="server">
                                                <asp:TextBox ID="txtCredit1" runat="server" CssClass="input-w70 numeric" onchange="SetDebitCreditAmt()"
                                                    TabIndex="20" onkeypress="return validateFloatKeyPress(this,event);" MaxLength="12" />
                                                <div class="starwrap">
                                            ...
                                            <td style="text-align: center; vertical-align: middle;">
                                                <asp:Button ID="imbShowCostCenterAllocPopup" runat="server" SkinID="costcenter-icon" Visible="false"
                                                    CommandName="COSTCENTER" OnClick="ActionHandler" TabIndex="25" ToolTip="<%$ resources:CCButtonToolTip%>" ValidationGroup="AddItem1" OnClientClick="return ValidateAddItems('AddItem1');" />
                                        ...
                                        <tr id="trInstrDet1" class="grd-rowhead" style="display: none" runat="server">
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtFavourOf1" runat="server" Width="95%" TabIndex="25" />
                                                <div class="starwrap">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ resources:Controls,Narration %>">
                                                ...
                                                <FooterTemplate>
                                                    ...
                                                    <asp:Panel ID="pnlVatSale" runat="server" Visible="false">
                                                        <div class="div2col-S" style="float: left; width: 64%">
                                                            <asp:Label runat="server" ID="lblVatSaleAmount" Text="<%$ resources:VatSale%>" AssociatedControlID="txtVatSale"
                                                                Width="55"></asp:Label>
                                                            <asp:TextBox ID="txtVatSale" runat="server" TabIndex="20" MaxLength="17" Enabled="false"
                                                                CssClass="Uiinput-amount numeric input-disabled"></asp:TextBox>
                                                            <asp:ImageButton ID="imgVatSale" SkinID="tax" runat="server" OnClick="ActionHandler"
                                                                ValidationGroup="taxDate" ToolTip="<%$ resources:Tax %>" CommandName="VATSALEHEADER" />
                                                        </div>
                                                    </asp:Panel>
                    ...
                    <div class="content-wrapper">
                        <table class="table-devide">
                            <tr>
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblformno" Text="<%$ resources:formno%>" AssociatedControlID="ddlFormno"></asp:Label><asp:DropDownList
                                            ID="ddlFormno" runat="server" Width="121px" TabIndex="50">
                                        </asp:DropDownList>
                                ...
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblTaxid" Text="<%$ resources:Taxid%>" AssociatedControlID="txtTaxid"></asp:Label><asp:TextBox
                                            runat="server" ID="txtTaxid" TabIndex="51" MaxLength="100"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="div2col-P">
                                        ...
                                        <asp:Label runat="server" ID="lblWhtHoBr" Text="<%$ resources:HoBr%>" AssociatedControlID="txtWthAddressType"></asp:Label><asp:TextBox
                                            ID="txtWthAddressType" runat="server" MaxLength="100" TabIndex="62" onkeydown="ClearWhtVendorContacts();"
                                            Width="190" OnTextChanged="ActionHandler"> </asp:TextBox><%--<asp:DropDownList ID="ddlAddressType" runat="server" TabIndex="62" OnSelectedIndexChanged="ActionHandler"
                                                        AutoPostBack="true" Width="125">
                                                    </asp:DropDownList>--%><asp:RequiredFieldValidator ID="vrfWthAddressType" CssClass="star"
                                                        SetFocusOnError="true" ValidationGroup="wht" EnableClientScript="true" runat="server"
                                                        ControlToValidate="txtWthAddressType" Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_HoBr %>"
                                                        InitialValue="<%$ resources:Messages, AutoDefaultValue %>">
                                                    </asp:RequiredFieldValidator><asp:Label runat="server" ID="lblWhtHo" Text="<%$ resources:Ho%>"
                                                        AssociatedControlID="chkWthHeadOffice" Width="30"></asp:Label><asp:CheckBox ID="chkWthHeadOffice"
                                                            runat="server" Width="13" CssClass="check-inline"></asp:CheckBox>
                                ...
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblWthBranchCode" Text="<%$ resources:BranchCode%>"
                                            AssociatedControlID="txtWthBranchCode"></asp:Label><asp:TextBox ID="txtWthBranchCode"
                                                runat="server" MaxLength="5" TabIndex="63" Width="100px" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="divcol-P">
                                        <asp:Label ID="lblvendorWHT" runat="server" Text="<%$ resources:Party%>" AssociatedControlID="txtCustomerTxtWHT"></asp:Label><asp:TextBox
                                            runat="server" ID="txtCustomerTxtWHT" TabIndex="52" MaxLength="100"></asp:TextBox><asp:HiddenField
                                                ID="hdfvendorWHTPK" runat="server" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="divcol-P">
                                        <asp:Label runat="server" ID="lbladdress" Text="<%$ resources:PartyAds %>" AssociatedControlID="txtpartyads"></asp:Label><asp:TextBox
                                            runat="server" ID="txtpartyads" TabIndex="53" TextMode="MultiLine" CssClass="multiline-2line"
                                ...
                                <td align="right" style="width: 31%;">
                                    <div class="div3col-S">
                                        ...
                                        <asp:Label runat="server" ID="lblWhtAccountPopup" Text="<%$ resources:WHTAccount%>"
                                            AssociatedControlID="txtWHTAccountPopup"></asp:Label><asp:TextBox ID="txtWHTAccountPopup"
                                                runat="server" MaxLength="100" TabIndex="54"> </asp:TextBox><asp:HiddenField ID="hdfWHTAccountPopup"
                                                    runat="server" Value="" />
                                ...
                                <td align="center" style="width: 17%;">
                                    <div>
                                        <asp:Label ID="lblWHTAmountPopup" runat="server" Text="<%$ resources:Amount %>" AssociatedControlID="txtPopupWHTAmount"
                                            Width="53"></asp:Label><asp:TextBox ID="txtPopupWHTAmount" TabIndex="55" runat="server"
                                                CssClass="input-w70 numeric" onkeypress="return validateFloatKeyPress(this,event);"
                                                EnableViewState="false" MaxLength="11" onkeyup="CalculateWHTTotal(this);"></asp:TextBox><cc1:AmountValidation
                                                    ID="vamWHTAmountPopup" runat="server" ControlToValidate="txtPopupWHTAmount" ErrorMessage="<%$ resources:Err_ValidWHTAmount %>"
                                                    NumberDigits="11" Display="Dynamic" Text="*" EnableClientScript="true" CssClass="star"
                                                    ValidationGroup="wht" NonZero="true"></cc1:AmountValidation><asp:RequiredFieldValidator
                                                        ID="vrfWHTAmountPopup" CssClass="star" SetFocusOnError="true" ValidationGroup="wht"
                                                        EnableClientScript="true" runat="server" ControlToValidate="txtPopupWHTAmount"
                                ...
                                <td style="width: 20%;">
                                    <div>
                                        <asp:Label ID="lblWHTTaxAmountPopup" runat="server" Text="<%$ resources:WHTAmount %>"
                                            AssociatedControlID="txtWHTTaxAmountPopup" Width="80"></asp:Label><asp:TextBox ID="txtWHTTaxAmountPopup"
                                                runat="server" CssClass="input-w70 numeric" EnableViewState="false" onkeypress="return validateFloatKeyPress(this,event);"
                                                MaxLength="11"></asp:TextBox><cc1:AmountValidation ID="vamWHTTaxAmountPopup" runat="server"
                                                    ControlToValidate="txtWHTTaxAmountPopup" ErrorMessage="<%$ resources:Err_WHTTaxAmount %>"
                                                    NumberDigits="11" Display="Dynamic" Text="*" EnableClientScript="true" CssClass="star"
                                                    ValidationGroup="wht" NonZero="true"></cc1:AmountValidation><asp:RequiredFieldValidator
                                                        ID="vrfWHTTaxAmountPopup" CssClass="star" SetFocusOnError="true" ValidationGroup="wht"
                                                        EnableClientScript="true" runat="server" ControlToValidate="txtWHTTaxAmountPopup"
                        ...
                        <div class="divcol-P">
                            ...
                            <asp:Label ID="lblDescriptionPopup" runat="server" Text="<%$ resources:Description %>"
                                AssociatedControlID="txtDescriptionPopup"></asp:Label><asp:TextBox ID="txtDescriptionPopup"
                                    TabIndex="56" runat="server" EnableViewState="false" MaxLength="400" Width="70%"></asp:TextBox><asp:ImageButton
                                        ID="imgPopupAdd" SkinID="imbaddnew" runat="server" OnClick="ActionHandler" TabIndex="57"
                            ...
                            <asp:GridView runat="server" ID="grdWHTTaxDetails" Width="100%" AllowSorting="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="<%$ resources:formno %>">
                                        <ItemTemplate>
                                            <asp:Label ID="lblformnoGRD" runat="server"></asp:Label><asp:HiddenField ID="hdfWHTFormNo"
                                                runat="server" Value='<%#Eval("WTH_FORM_NO") %>' />
                                        </ItemTemplate>
                                        <ItemStyle Width="13%" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="<%$ resources:Amount %>">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTaxAmount" runat="server" Text='<%#GetFormattedCurrency(Eval("WTH_AMOUNT")) %>'
                                                ToolTip='<%# GetFormattedCurrency(Eval("WTH_AMOUNT")) %>'></asp:Label><asp:HiddenField
                                                    ID="hdfWHTTaxName1" runat="server" Value='<%#Eval("WTH_NAME") %>' />
                                        </ItemTemplate>
                                        <ItemStyle Width="20%" />
                                    </asp:TemplateField>
                    ...
                    <div class="content-wrapper">
                        <table class="table-devide">
                            <tr>
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label ID="lblVendor" runat="server" Text="<%$ resources:Vendor %>" AssociatedControlID="txtVendorPopup"></asp:Label><asp:TextBox
                                            ID="txtVendorPopup" runat="server" MaxLength="100" TabIndex="60" onkeydown="ClearVendorContacts();"
                                            OnTextChanged="ActionHandler" AutoPostBack="true"> </asp:TextBox><%--<asp:TextBox ID="txtTo" runat="server" TextMode="MultiLine" MaxLength="500" TabIndex="7"
                                                CssClass="multiline-1col" onkeydown="limitText(this,500);" onkeyup="limitText(this,500);" />--%><asp:HiddenField
                                                    ID="hdfVendorPopup" runat="server" />
                                ...
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblVatBuyTaxId" Text="<%$ resources:Taxid%>" AssociatedControlID="txtVatTaxId"></asp:Label><asp:TextBox
                                            runat="server" ID="txtVatTaxId" TabIndex="61" MaxLength="100"></asp:TextBox>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="div2col-P">
                                        ...
                                        <asp:Label runat="server" ID="lblAddressType" Text="<%$ resources:HoBr%>" AssociatedControlID="txtAddressType"></asp:Label><asp:TextBox
                                            ID="txtAddressType" runat="server" MaxLength="100" TabIndex="62" Width="190"
                                        ...
                                        </asp:DropDownList>--%><asp:RequiredFieldValidator ID="vrfAddressType" CssClass="star"
                                            SetFocusOnError="true" ValidationGroup="vatbuy" EnableClientScript="true" runat="server"
                                            ControlToValidate="txtAddressType" Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_HoBr %>">
                                        </asp:RequiredFieldValidator><asp:Label runat="server" ID="lblHO" Text="<%$ resources:Ho%>"
                                            AssociatedControlID="chkHeadOffice" Width="30"></asp:Label><asp:CheckBox ID="chkHeadOffice"
                                                runat="server" Width="13" CssClass="check-inline" OnCheckedChanged="ActionHandler"
                                ...
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblBranchCode" Text="<%$ resources:BranchCode%>" AssociatedControlID="txtBranchCode"></asp:Label><asp:TextBox
                                            ID="txtBranchCode" runat="server" MaxLength="5" TabIndex="63" Width="97" />
                                ...
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblVatTaxInvDate" Text="<%$ resources:TaxInvoiceDate%>"
                                            AssociatedControlID="txtVatTaxInvDate"></asp:Label><asp:TextBox ID="txtVatTaxInvDate"
                                                runat="server" MaxLength="200" CssClass="medium" TabIndex="64" onkeydown="return CheckKey(event)"
                                                onpaste="return false;" />
                                ...
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblVatTaxInvNo" Text="<%$ resources:TaxInvoiceNo%>"
                                            AssociatedControlID="txtVatTaxInvNo"></asp:Label><asp:TextBox runat="server" ID="txtVatTaxInvNo"
                                                TabIndex="65" MaxLength="100"></asp:TextBox><asp:RequiredFieldValidator ID="vrfTaxInvNo"
                                                    CssClass="star" SetFocusOnError="true" ValidationGroup="vatbuy" EnableClientScript="true"
                                                    runat="server" ControlToValidate="txtVatTaxInvNo" Display="Dynamic" Text="*"
                                                    ErrorMessage="<%$ resources:Err_TaxInvoiceNo %>">
                                                </asp:RequiredFieldValidator>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label ID="lblAmtBeforeTax" runat="server" Text="<%$ resources:AmountBeforeTax %>"
                                            AssociatedControlID="txtBeforeTaxAmount"></asp:Label><asp:TextBox ID="txtBeforeTaxAmount"
                                                TabIndex="66" runat="server" CssClass="input-w80 numeric" onkeypress="return validateFloatKeyPress(this,event);"
                                                EnableViewState="false" MaxLength="11" onkeyup="CalculateVatBuyTotal(this);"></asp:TextBox><cc1:AmountValidation
                                                    ID="vamAmtBeforeTax" runat="server" ControlToValidate="txtBeforeTaxAmount" ErrorMessage="<%$ resources:Err_ValidVatAmount %>"
                                                    NumberDigits="11" Display="Dynamic" Text="*" EnableClientScript="true" CssClass="star"
                                                    ValidationGroup="vatbuy" NonZero="true"></cc1:AmountValidation><asp:RequiredFieldValidator
                                                        ID="vrfBeforeTaxAmount" CssClass="star" SetFocusOnError="true" ValidationGroup="vatbuy"
                                                        EnableClientScript="true" runat="server" ControlToValidate="txtBeforeTaxAmount"
                                ...
                                <td>
                                    <div class="div2col-P">
                                        ...
                                        <asp:Label runat="server" ID="lblVatAccountPopup" Text="<%$ resources:VatBuy%>" AssociatedControlID="ddlVATAccountPopup"></asp:Label><%--<asp:TextBox ID="txtVATAccountPopup" runat="server" MaxLength="100" TabIndex="54"> </asp:TextBox>--%>
                                        <asp:DropDownList ID="ddlVATAccountPopup" TabIndex="67" runat="server" EnableViewState="true" CssClass="medium"
                                        ...
                                        <asp:RequiredFieldValidator ID="vrfVATAccountPopup" CssClass="star" SetFocusOnError="true"
                                            ...
                                            InitialValue="-1">
                                        </asp:RequiredFieldValidator><%--<asp:Label ID="lblVatTax" runat="server" Text="<%$ resources:Tax %>" AssociatedControlID="txtVATTaxAmountPopup"></asp:Label>--%><asp:TextBox
                                            ID="txtVATTaxAmountPopup" runat="server" CssClass="input-w80 numeric" onkeypress="return validateFloatKeyPress(this,event);"
                                            EnableViewState="false" MaxLength="11" TabIndex="68"></asp:TextBox><cc1:AmountValidation
                                                ID="vamVATTaxAmountPopup" runat="server" ControlToValidate="txtVATTaxAmountPopup"
                                                ErrorMessage="<%$ resources:Err_VATTaxAmount %>" NumberDigits="11" Display="Dynamic"
                                                Text="*" EnableClientScript="true" CssClass="star" ValidationGroup="vatbuy" NonZero="true"></cc1:AmountValidation><asp:RequiredFieldValidator
                                                    ID="vrfVATTaxAmountPopup" CssClass="star" SetFocusOnError="true" ValidationGroup="vatbuy"
                                                    EnableClientScript="true" runat="server" ControlToValidate="txtVATTaxAmountPopup"
                            ...
                            <tr>
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label ID="lblMaterial" runat="server" Text="<%$ resources:Material %>" AssociatedControlID="txtMaterial"></asp:Label><asp:TextBox
                                            ID="txtMaterial" TabIndex="69" runat="server" EnableViewState="false" MaxLength="400"
                                            Width="60%"></asp:TextBox><asp:RequiredFieldValidator ID="vrfMaterial" CssClass="star"
                                                SetFocusOnError="true" ValidationGroup="vatbuy" EnableClientScript="true" runat="server"
                                                ControlToValidate="txtMaterial" Display="Dynamic" Text="*" ErrorMessage="<%$ resources:Err_Material %>">
                                            </asp:RequiredFieldValidator>
                                    </div>
                                </td>
                                <td>
                                    <div class="div2col-P">
                                        <asp:Label runat="server" ID="lblRefundDate" Text="<%$ resources:RefundMonth %>"
                                            AssociatedControlID="txtVatRefundDate"></asp:Label><asp:TextBox ID="txtVatRefundDate"
                                                runat="server" MaxLength="200" CssClass="medium" TabIndex="65" onkeydown="return CheckKey(event)"
                                                onpaste="return false;" />
                    ...
                    <div class="content-wrapper">
                        <div class="Button-container-popup">
                            <asp:Button ID="btnVoucherCCApply" SkinID="btnInner-add-dsd" runat="server" Text="<%$resources:ErpRes,Apply %>"
                                OnClick="ActionHandler" TabIndex="54" CommandName="COSTCENTERAPPLY" ToolTip="<%$resources:ErpRes,Apply %>" ValidationGroup="VoucherCostCenter" OnClientClick="javascript:ValidatePageNow('VoucherCostCenter')" />
                            <asp:Button ID="btnVoucherCCCancel" SkinID="btnInner-cancel-dsd" runat="server"
                                Text="<%$resources:ErpRes,Cancel %>" ToolTip="<%$resources:ErpRes,Cancel %>"
                                OnClick="ActionHandler" TabIndex="54" CommandName="COSTCENTERCANCEL" />
                        </div>
                        <div class="gridwrap">
                                    ...
                                    <asp:TemplateField HeaderText="<%$ resources:CostCenterAmount %>">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtVoucherCCAmountTC" runat="server" CssClass="input-full numeric margn-rgt0"
                                                MaxLength="16" Text='<%# GetFormattedCurrency(Eval("FTD_AMT_TC"))%>' onkeyup="CalculateTotalCCAmount();" onkeypress="javascript:GrandScriptUtils.AllowOnlyNumbers(event,true);">
                                            </asp:TextBox>
                                            <cc1:AmountValidation ID="vccVoucherAmountTC" runat="server" ControlToValidate="txtVoucherCCAmountTC"
            ...
            <div id="diverror" style="display: none">
                ...
                <asp:ValidationSummary ID="vsVoucherCostCenter" ValidationGroup="VoucherCostCenter" runat="server" />
            </div>
            ...
            <div id="divScriptButtons">
                ...
                <asp:Button ID="btnJournalizeUpdate" runat="server" OnClick="ActionHandler" CommandName="JOURNALIZEUPDATE"
                    EnableTheming="false" Style="display: none" />
                <asp:Button ID="btnComparision" runat="server" OnClick="ActionHandler" CommandName="COMPARE"
                    EnableTheming="false" Style="display: none" />
