    ...
    public partial class PendingOrders : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                hdfDecimalCoundMst = this.Page.Master.FindControl("hdfBinDecimal") as HiddenField;
                for (int i = 0; i < Convert.ToInt32(hdfDecimalCoundMst.Value); i++)
                {
                    WeightFormat += "0";
                }
                #endregion
            ...
            try
            {
                ...
                switch (ControlType)
                {
                    ...
                    case ControlsEnum.CLEARLIST:
                        ...
                        objPendingOrders = PendingOrderBO = OrderPlanningBL.GetPendingOrdersList(currentUser.CurrentSBUPK, (xmlDoc == null ? string.Empty : xmlDoc.InnerXml), txtDispatchDate.Text, Convert.ToInt32(POPageIndex), PageSize, OrderPlanPK, Convert.ToInt32(chkWithStock.Checked), Convert.ToInt32(chkFullyAllocated.Checked), Convert.ToInt32(chkFullyPlanned.Checked));
