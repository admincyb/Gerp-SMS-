<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PendingOrders.ascx.cs" 
    Inherits="ERPSMS_v01.UserControls.PendingOrders" %>
        ...
        <asp:GridView ID="grdPendingOrders" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:Order %>">
                    <ItemTemplate>
                        <asp:Label ID="lblOrderNo" runat="server" Text='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOH_NO) %>'
                            ToolTip='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOH_NO) %>'></asp:Label>
                        <asp:HiddenField ID="hdfSOPk" runat="server" Value='<%#Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOH_PK)%>' />
                        <asp:HiddenField ID="hdfOrderDtlPk" runat="server" Value='<%#Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_PK)%>' />
                        <asp:HiddenField ID="hdfItemPlanGroup" runat="server" Value='<%#Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ITM_PLAN_GROUP)%>' />
                        <asp:HiddenField ID="hdfItemPlanGroupText" runat="server" Value='<%#Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ITM_PLAN_GROUP_TEXT)%>' />
                        <asp:HiddenField ID="hdfAvailQty" runat="server" Value='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_GRP_AVAILABLE_QTY) %>' />
                        <asp:HiddenField ID="hdfAllocatedQty" runat="server" Value='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_GRP_ALLOCATED_QTY) %>' />
                        <asp:HiddenField ID="hdfBaltoAllocate" runat="server" Value='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_BAL_TO_ALLOCATE) %>' />
                        <asp:HiddenField ID="hdfSizeSequence" runat="server" Value='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ISD_SIZE_SEQUENCE) %>' />
                        <asp:HiddenField ID="hdfAGradePerc" runat="server" Value='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ISD_AGRADE_PER) %>' />
                    </ItemTemplate>
                    <ItemStyle Width="13%" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:lblCustomer %>">
                    <ItemTemplate>
                        <asp:Label ID="lblCustomer" runat="server" Text='<%# ERP.Production.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOH_CUSTOMER_CODE)),20) %>'
                            ToolTip='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOH_CUSTOMER_NAME) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="14%" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:Product %>">
                    <ItemTemplate>
                        <asp:Label ID="lblProduct" runat="server" Text='<%# ERP.Production.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_ITEM_CODE)),20) %>'
                            ToolTip='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_ITEM_TEXT) %>'></asp:Label>
                        <asp:HiddenField ID="hdfProductPk" runat="server" Value='<%#Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_ITEM)%>' />
                    </ItemTemplate>
                    <ItemStyle Width="14%" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:Size %>">
                    <ItemTemplate>
                        <asp:Label ID="lblProductSizeText" runat="server" Text='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ISD_SIZE_TEXT) %>'
                            ToolTip='<%# Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ISD_SIZE_TEXT) %>'></asp:Label>
                        <asp:HiddenField ID="hdfProductSize" runat="server" Value='<%#Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_ISD_SIZE)%>' />
                    </ItemTemplate>
                    <ItemStyle Width="3%" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:Quantity %>"
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lblQuantity" runat="server" Text='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY)) %>'
                            ToolTip='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY)) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="9%" HorizontalAlign="Right" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:Requiredby %>">
                    <ItemTemplate>
                        <asp:Label ID="lblRequiredby" runat="server" Text='<%# Convert.ToDateTime(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_REQUIRED_BY)).ToString("dd-MMM-yyyy") %>'
                            ToolTip='<%# Convert.ToDateTime(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_REQUIRED_BY)).ToString("dd-MMM-yyyy") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="8%" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:DispatchedQty %>"
                    HeaderStyle-CssClass="grd-head-rgt">
                    <ItemTemplate>
                        <asp:Label ID="lblDispatchedQty" runat="server" Text='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_DISPATCHED)) %>'
                            ToolTip='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_DISPATCHED)) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="9%" HorizontalAlign="Right" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:AllocationQty %>"
                    HeaderStyle-CssClass="grd-head-rgt">
                    <ItemTemplate>
                        <%--<asp:Label ID="lblAllocatedQty" runat="server" Text='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_ALLOCATED)) %>'
                            ToolTip='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_ALLOCATED)) %>'></asp:Label>--%>
                        <asp:LinkButton ID="lnkAllocatedQty" runat="server" Text='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_ALLOCATED)) %>'
                            ToolTip='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_ALLOCATED)) %>'
                ...
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:PlannedQty %>"
                    HeaderStyle-CssClass="grd-head-rgt">
                    <ItemTemplate>
                        <asp:Label ID="lblPlannedQty" runat="server" Text='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_PLANNED)) %>'
                            ToolTip='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_QTY_PLANNED)) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="9%" HorizontalAlign="Right" />
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-CssClass="grdText" HeaderText="<%$ resources:BalancetoPlan %>"
                    HeaderStyle-CssClass="grd-head-rgt">
                    <ItemTemplate>
                        <asp:Label ID="lblBalPlanQty" runat="server" Text='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_BAL_TO_PLAN)) %>'
                            ToolTip='<%# GetFormattedNumber(Eval(ERP.Production.Utilities.Constants.DA.OrderPlanning.OrderPlanning.F_SOD_BAL_TO_PLAN)) %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Width="9%" HorizontalAlign="Right" />
                </asp:TemplateField>
            </Columns>
            ...
            <table class="groupplan-grid margnbotm10">
                <tr>
                    ...
                    <td class="w10perc">
                        ...
                        <asp:CheckBox runat="server" ID="chkWithStock" Checked="false" />
                        <asp:Label runat="server" ID="lblWithStock" Text="<%$ resources:WithStock %>" CssClass="lbl-80perc"
                            ToolTip="<%$ resources:WithStock %>"></asp:Label>
                        <asp:CheckBox runat="server" ID="chkFullyAllocated" Checked="true" />
                        <asp:Label runat="server" ID="lblFullyAllocated" Text="<%$ resources:FullyAllocated %>"
                            CssClass="lbl-80perc" ToolTip="<%$ resources:ToolTipFullyAllocated %>"></asp:Label>
                        <asp:CheckBox runat="server" ID="chkFullyPlanned" Checked="false" />
