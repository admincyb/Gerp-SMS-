<%@ Page Title="<%$ Resources:Captions,Title_PurchaseRequest %>" Language="C#" Theme="ClassicExt"
    MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" CodeBehind="PurchaseRequestDetailListing.aspx.cs"
    Inherits="ERPSMS_v01.PurchaseRequestManagement.PurchaseRequestDetailListing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            var prPageURL = "/PurchaseRequestManagement/PurchaseRequestCreation.aspx";

            prAutoCompleteURL += "&Type=" + $("[id$=hdfType]").val();

            if (parseInt($("[id$=hdfType]").val()) > 0) {
                prPageURL += "?Type=" + $("[id$=hdfType]").val();
                if (parseInt($("[id$=hdfSbu]").val()) > 0) {
                    prPageURL += "%26Sbu=" + $("[id$=hdfSbu]").val();
                }
            }

            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtPRNumber", prAutoCompleteURL + "&SearchType=PRH_NO" + "&PageURL=" + prPageURL, "hdfPRNumber", true, true, 4);
            ...
            GrandScriptUtils.MakeAutoCompleteDDLNEW("txtIONo", prAutoCompleteURL + "&SearchType=SOH_NO" + "&PageURL=" + prPageURL, "hdfIONo", true, true, 4);
    ...
    <asp:UpdatePanel ID="aupdpnlAvtivity" runat="server">
        <contenttemplate>
            ...
            <div class="content-wrapper">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton runat="server" ID="imbModify" CommandName="CHANGE"
                                                    TabIndex="10" SkinID="imbUpdate" alt="<%$Resources:Controls,Modify%>" title="<%$Resources:Controls,Modify%>" />
                                            </ItemTemplate>
                                            <ItemStyle Width="11%" />
                                        </asp:TemplateField>
                                    </Columns>
                ...
                <asp:HiddenField ID="hdfSbu" runat="server" Value="0" />
                <asp:HiddenField ID="hdfChangePR" runat="server" Value="0" />
            </div>
        </contenttemplate>
    </asp:UpdatePanel>
</asp:Content>
