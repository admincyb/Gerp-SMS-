<%@ Page Title="<%$ Resources:Captions,Title_PurchaseRequestTrading %>" Language="C#" EnableEventValidation="false"
    MasterPageFile="~/ERPSMS_2.Master" Theme="ClassicExt" AutoEventWireup="true"
    CodeBehind="PurchaseRequestTrading.aspx.cs" Inherits="ERPSMS_v01.PurchaseRequestManagement.PurchaseRequestTrading" %>

<%@ Register Src="../WorkFlow/WorkflowComments.ascx" TagName="WorkflowComments" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../Scripts/PageScript/PurchaseRequestManagement/PurchaseRequestTrading.js.axd"
    ...
    <div class="content-wrapper">
                ...
                <td>
                    <div class="div2col-S">
                        ...
                        <label for="PRH_DATE" class="middle-lbl-small-c">
                            ...
                            *</label>
                        <asp:TextBox ID="PRH_DATE" runat="server" TabIndex="1" EnableViewState="false" onkeydown="return CheckKey(event)"
                        ...
                        <asp:Label ID="Label1" runat="server" Text='<%$ Resources:ConfigurationsRes,RequestedBy%>'
                ...
                <td>
                    <div class="div2col-S" style="float: right;">
                        ...
                        <div id="divSubDept" style="display: none;">
                            ...
                            <asp:DropDownList ID="PRH_ISSUE_SUB_DEPT" runat="server" TabIndex="4" CssClass="select-half">
                            </asp:DropDownList>
                        </div>
                ...
                <table rules="all" id="grdPuchasePendingList" grandtype="GrandGrid" paging="false"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th fieldmap="ITM_ROL_STK" align="right" width="6%">
                    ...
                    <table id="PurchaseRequestInsert" class="gridwraptable gridwrap tablefixwidth-td">
                        ...
                        <tbody>
                            <tr class="grd-rowhead">
                                ...
                                <td>
                                    <asp:TextBox ID="ItemCodeMaterial" Width="250px" runat="server" TabIndex="15">
                                    </asp:TextBox>
        ...
        <div id="divMetarialDetails" title="<%=Resources.Captions.MaterialDescription%>">
            <div class="div2Col-M">
                ...
                <%-- <label for="ThisStoreStockUOM" style="width: 150px">
                    <%=Resources.Controls.CurrentStock%>
                </label>--%>
                <%-- <asp:Label ID="ThisStoreStockUOM" runat="server" Font-Bold="true" EnableViewState="false"></asp:Label>--%>
                <div class="clear">
                </div>
            ...
            <table rules="all" id="grdBreakupStoreList" grandtype="GrandGrid" paging="false"
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="STD_QTY_IN_STOCK_TO_UOM" align="left">
                            <%=Resources.Controls.Stock%>
                        </th>
                        <th fieldmap="TO_UOM_TEXT" align="left">
                            <%=Resources.Controls.UOM%>
                        </th>
                    </tr>
                </thead>
            ...
            <table rules="all" id="grdPendingPOList" grandtype="GrandGrid" paging="false" editable="false"
                ...
                <thead>
                    <tr>
                        ...
                        <th fieldmap="POD_UOM_TEXT_TO_UOM" align="left">
                            <%=Resources.Controls.UOM%>
                        </th>
                    </tr>
                </thead>
        ...
        <asp:HiddenField ID="hdfRequestedBy" runat="server" Value='<%# GetGlobalResourceObject("ConfigurationsRes","RequestedByValidation").ToString()%>'></asp:HiddenField>
        <asp:HiddenField ID="hdfRequestbyDept" runat="server"  Value='<%# GetGlobalResourceObject("ConfigurationsRes","RequestbyDeptValidation").ToString()%>'></asp:HiddenField>
        ...
        <asp:HiddenField ID="hdfDefaultPRItemUOM" Value="0" runat="server" />
        ...
        <asp:HiddenField ID="hdfIsSingleReqDeptWkfSetting" runat="server" Value="0" />  <%--If the Requested Dept ddl contain only one value,Select it by default.In case of multipleplant,we need postback.Infinite loop occurs.For avoiding this we used this hiddenfield --%>    
