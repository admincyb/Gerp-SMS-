...
namespace ERP.Utilities.Dashboard
{
    public class DashboardConstants
    {
        ...
        public const string AllThreeStyle = "one-three-graph";
        public const string CotainerStyle = "dash-container";
        public const string EmptyStyle = "emptytable";
        public const string GridWrapStyle = "gridwrap";
        public const string FilterName = "Name";
        public const string FilterKey = "Value";
        public const string ParamLogo = "HeaderImage";
    ...
    public class MSChartProperties
    {
        ...
        /// For Pie Chart
        /// </summary>
        public const string IsExplode = "isexplode";
    }
