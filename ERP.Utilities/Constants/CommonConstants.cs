...
namespace ERP.Utilities.Constants.DA
{
    ...
    public enum CustomerSpecialCategory
    { 
        InterState = 204,
        IntraState = 205,
        Overseas = 4520,
    ...
    /// <summary>
    /// Represents Application Module values
    /// </summary>
    ...
    public enum WidgetControls
    {
        Default = 0,
        ProjectProgress = 1,
        ProjectAchievement = 2,
        PurchaseHistory = 3,
        HRAdmin = 4,
        StockHistory = 5,
        SalesHistory = 6,
        TopCustomers = 7,
        SalesByCountry=8,
        ProjectProgressExpenditure = 9,
        DailyProductionByLine = 10,
        ProductionTrend = 11,
        DailyProduction = 12,
        MonthlyProduction = 13,
        StorewiseStock = 14,
        DailyPacking = 15,
        MonthlyPacking = 16,
        DefectsbyCategory = 17,
        MonthlyProductionCost = 18
    }
    ...
    {
        public const string PDFPAYSLIPURL = "?RecPK={0}&RptType={1}&RptSubType={2}&EmpName={3}&SbuID={4}&RptName={5}&Token={6}&UserID={7}&Dept={8}&FilePath={9}";           
    }
