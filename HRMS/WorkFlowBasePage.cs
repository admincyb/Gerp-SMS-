...
namespace ERP.Store.UI
{
    public class WorkFlowBasePage : Page
    {
        ...
        /// </summary>
        public int ExtUserDept
        {
            get
            {
                return (this.ViewState["ExtUserDept"] == null ? 0 : (int)this.ViewState["ExtUserDept"]);
            }
            set
            {
                this.ViewState["ExtUserDept"] = value;
            }
        }
        ...
        /// <returns></returns>
        public string GetPageDepartmentText()
        {
        ...
        public void SetPageDepartmentText()
        {
            if (this.Page != null && this.Page.Master != null)
            {
                ...
                {
                    lblPageDeptText.Text = ERP.Utilities.CommonFunctions.GetShortString(litDept.Text, 20);
        ...
        public void GetWorkflowUserRights()
        {
            ...
            int userDept = currentUser.CurrentDeptPK;
            userDept = ExtUserDept > 0 ? ExtUserDept : currentUser.CurrentDeptPK;
            UserRights = userAuth.GetWorkFlowUserRightsInfo(currentUser.PKUser, pageURL, userDept, WkfRefID, WkfPageType);
        }
        /// <summary>
        ...
        /// <summary>
        /// To Check a button with the specified section action has permission
        /// </summary>
        /// <param name="buttonName"></param>
        /// <param name="sectionName"></param>
        /// <returns></returns>
        public bool IsValidButton(string buttonName, string sectionName)
        {
            return UserRights != null && UserRights.Rights != null &&
                UserRights.Rights.Count(acn => acn.SectionName.ToLower() == sectionName.ToLower() && acn.ActionName.ToLower() == buttonName.ToLower() && acn.HasActionRight) > 0;
        }
        /// <summary>
