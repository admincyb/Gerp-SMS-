...
{
    public partial class PayrollProcess : ERP.Store.UI.WorkFlowBasePage
    {
        #region Variables
            ...
            try
            {
                ...
                switch (commonActions)
                {
                        ...
                        else
                        {
                            ...
                            if (objEmpPayrollHeader != null)
                            {
                                ...
                                if (objEmpPayrollHeader.EmpPayrollDtl == null || objEmpPayrollHeader.EmpPayrollDtl.Count > 0)
                                {
                                    ...
                                    result = PayrollProcessBL.ProcessPayrollDetails(xmlDoc, out TrxNo, out dtErrorList);
                                    if (result > 0)
                                    {
                    ...
                    case ActionsEnum.SAVEEMPLOYEEPAYROLL:
                        ...
                        else
                        {
                            ...
                            if (objEmpPayHeader != null)
                            {
                                ...
                                result = PayrollProcessBL.SaveEmployeePayroll(xmlDoc);
                                if (result > 0)
                                {
                    ...
                    case ActionsEnum.PRINT:
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "Openwindow", "OpenPDF('" + Page.ResolveClientUrl(Resources.PageURL.ReportPath + "?ID=0" + "&APPTYPE=" + "PAYRL" + "&APPSUBTYPE= 9") + "');", true);//HRMS Pay Slip Monthly
                        }
                        else
                        {
                    ...
                    case ActionsEnum.PRINTALL:
                        if (Convert.ToInt32(ddlProcessMode.SelectedValue) == (int)PayrollProcessMode.Monthly)
                        {
                            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "Openwindow", "OpenPDF('" + Page.ResolveClientUrl(Resources.PageURL.ReportPath + "?ID=0" + "&APPTYPE=" + "PAYRL" + "&APPSUBTYPE= 8" + "&CurPK=" + CurrPK) + "');", true);
                        }
                    ...
                    case ActionsEnum.PRINTMULTIPLE:
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this.Page, typeof(Page), "Openwindow", "OpenPDF('" + Page.ResolveClientUrl(Resources.PageURL.ReportPath + "?ID=0" + "&APPTYPE=" + "PAYRL" + "&APPSUBTYPE= 1") + "');", true);//Daily
                        }
                        break;
                    #endregion
                    ...
                    case ActionsEnum.DELETEPERIOD:
                        ...
                        {
                            CurrPK = Convert.ToInt32(hdfEphPK.Value);
                            result = PayrollProcessBL.DeleteProcessPeriod(this.CurrPK, Convert.ToDateTime(hdfProcessLastModDate.Value).ToString());
                        }
                        if (result > 0)
                        {
                            EntryStatus = EntryStatus.LISTMODE;
                    ...
                    case ActionsEnum.DELETEPAYROLL:
                        ...
                        if (hdfItemPK != null)
                        {
                            ...
                            result = PayrollProcessBL.DeleteEmployeePayroll(xmlDoc);
                        }
                        if (result > 0)
                        {
                            EntryStatus = EntryStatus.LISTMODE;
        ...
        private void SetPayrollProcessDates()
        {
            ...
            if (dtResult != null && dtResult.Rows.Count > 0)
            {
                if (!string.IsNullOrEmpty(txtSalaryMonth.Text.Trim()))
                {
                    ...
                    int month = salMonth.Month + offset;
                    if (month > 0)
                        tempDate = new DateTime(salMonth.Year, salMonth.Month + offset, 1);
                    else
            ...
            try
            {
                switch (type)
                {
                    ...
                    case ControlsEnum.PAYROLLTYPE:
                        ...
                        dtResult = PayrollProcessBL.GetPayrollType(PayrollTypePk, currentUser.SBUID, Convert.ToInt32(DbActiveStatus.ACTIVE), processmode, currentUser.PKUser);
                        break;
                    #endregion
                    #region PAYROLL TYPE DETAILS
                    case ControlsEnum.PAYROLLTYPEDETAILS:
                    ...
                    case ControlsEnum.EMPPAYROLLLIST:
                        ...
                        if (objFilterEmpDetails != null)
                        {
                            ...
                            objEmpPayrollHeader = PayrollProcessBL.GetEmployeePayrollList(xmlDoc);
                    ...
                    case ControlsEnum.PERIODLIST:
                        ...
                        dtPageData = PayrollProcessBL.GetPayrollProcessPeriodList(filterParams, currentUser.SBUID, processMode);
                        if (dtPageData != null)
                        {
                    ...
                    #region EMPLOYEE PAYROLL LIST
                    case ControlsEnum.EMPPAYROLLDETAILLIST:
                        objEmpPayHeader = PayrollProcessBL.GetEmployeePayrollDetailList(CurrEmployeePayrollPK);
                        break;
                    #endregion
                    #region WORKING DAYS DETAILS
                    case ControlsEnum.WORKINGDAYSDETAILS:
                        objWorkdayHdr = PayrollProcessBL.GetWorkingDaysDetails(CurrPK, currentUser.SBUID, Convert.ToInt32(DbActiveStatus.ACTIVE), 0);
                    ...
                    case ControlsEnum.NONPAYROLL:
                        dtNonPayroll = PayrollProcessBL.GetNonPayrollEmployees(Convert.ToInt32(ddlPayrollType.SelectedValue), txtProcessFromDate.Text, txtProcessToDate.Text);
                        break;
                        #endregion
