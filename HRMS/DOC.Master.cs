...
namespace HRMS
{
    public partial class DOC : System.Web.UI.MasterPage
    {
        #region Declaration
        string sContent;
        ...
        protected void imgbtnChangePwd_Click(object sender, ImageClickEventArgs e)
        {
            if (System.Configuration.ConfigurationManager.AppSettings["PROFILEURL"] != null)
                Response.RedirectPermanent(System.Configuration.ConfigurationManager.AppSettings["PROFILEURL"].ToString() + GetGlobalResourceObject("PageURL", "UserProfileURL").ToString(), true);
        }
