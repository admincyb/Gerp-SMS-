...
{
    public class DirectSalesInvoiceBO
    {
    }
    //[Serializable]
    //[XmlRoot("Root")]
    //public class DirectSOInvoiceHeaderMul
    //{
    //    [XmlElement("SO")]
    //    public List<DirectSOInvoiceHeader> SOMainList { get; set; }
    //}


    [Serializable]
    [XmlRoot("Root")]
    public class DirectSOInvoiceHeader : WorkflowBO
    {
        [XmlElement("ICH_PK")]
        ...
        [XmlElement("ICH_CUSTOMER_GSTNO")]
        public string ICH_CUSTOMER_GSTNO { get; set; }
        ...
        public List<DirectSOInvoiceDetails> OrderDetail { get; set; }
        [XmlElement("TaxHdr")]
        public List<DirectSOInvoiceTaxHdr> TaxHdr { get; set; }
        [XmlElement("AdvDedDtl")]
        public List<DirectSOAdvDeductionDetails> DeductionDetails { get; set; }
        [XmlElement("DueDetail")]
        public List<DirectDueDetail> DueDetail { get; set; }
        [XmlElement("SOMpg")]
        public List<DirectSOInvoiceMappingDetails> SOMappingDetails { get; set; }
        [XmlElement("FileList")]
        public List<DirectSOInvoiceUploads> FileList { get; set; }
    }
    [Serializable]
    public class DirectSOInvoiceDetails
    {
        [XmlElement("CID_PK")]
        ...
        [XmlElement("CID_DPD_PK")]
        public int CID_DPD_PK { get; set; }
        ...
        [XmlElement("CID_SOD_QTY")]
        public double CID_SOD_QTY { get; set; }
        ...
        [XmlElement("TaxDtl")]
        public List<DirectSOInvoiceTaxHdr> TaxDtl { get; set; }
        [XmlElement("IssueDetail")]
        public List<DirectIssueDetail> IssueDtl { get; set; }
    }

    [Serializable]
    public class DirectSOInvoiceTaxHdr
    {
        [XmlElement("CIT_PK")]
    ...
    [Serializable]
    public class DirectSOAdvDeductionDetails
    {
        [XmlElement("IAD_PK")]
    ...
    [Serializable]
    public class DirectIssueDetail
    {
        [XmlElement("CII_PK")]
    ...
    [Serializable]
    public class DirectSOInvoiceMappingDetails
    {
        [XmlElement]
        ...
        [XmlElement]
        public long ICM_INVOICE_HDR { get; set; }
        [XmlElement]
        public decimal SOH_GROSS_AMT { get; set; }
        [XmlElement]
        public decimal SOH_DISCOUNT_AMT { get; set; }
        [XmlElement]
        public decimal SOH_TAX_AMT { get; set; }
        [XmlElement]
        public decimal SOH_OTHER_CHARGES { get; set; }
        [XmlElement]
        public decimal SOH_AJUST_AMT { get; set; }
        [XmlElement]
        public decimal SOH_TOTAL_AMT { get; set; }

        [XmlElement]
        public decimal ICM_INVOICED_AMT { get; set; }
        [XmlElement]
        public decimal ICM_PINVOICED_AMT { get; set; }
        [XmlElement]
        public decimal ICM_BAL_TO_INVOICE { get; set; }
        [XmlElement]
        public int SOH_PK { get; set; }
        [XmlElement("SOTax")]
        public List<DirectSOTaxDetails> SOTaxList { get; set; }

    }

    [Serializable]
    public class DirectSOTaxDetails
    {
        [XmlElement]
        public int TSH_TAX { get; set; }       
        [XmlElement]
        public double TSH_TAX_AMT { get; set; }
        [XmlElement]
        public string TSH_NAME { get; set; }      
    }

    [Serializable]
    [XmlRoot("ROOT")]
    public class DirectDueDateDetails
    {
        [XmlElement("TCH_PK")]
    ...
    [Serializable]
    [XmlRoot("Root")]
    public class DirectAgentCommInvHeader
    {
        [XmlElement("IVH_NO")]
        ...
        [XmlElement("Detail")]
        public List<DirectAgentCommInvDetails> agtCommInvDetail { get; set; }

    }
    [Serializable]
    public class DirectAgentCommInvDetails
    {
    ...
    [Serializable]
    [XmlRoot("ROOT")]
    public class DirectSOHeaderBO
    {
        [XmlElement("SO")]
        public List<DirectSOHeaderListBO> SOList { get; set; }
    }

    [Serializable]
    public class DirectSOHeaderListBO
    {
        [XmlElement("SOH_PK")]
        public int SOH_PK { get; set; }
        [XmlElement("DPH_PK")]
    ...
    public class DirectFileDetailsSI
    {
        public int SlNo
        {
            get;
    ...
    [Serializable]
    public class DirectSOInvoiceUploads
    {
        [XmlElement("DOC_PK")]
