...
{
    public sealed class PDCVoucherReceipt
    {
        #region Constructors
        public PDCVoucherReceipt()
        {
        ...
        private string reportTemplate = @"<div id='printContainer'>" +
                                        "<table border='0' cellpadding='0' cellspacing='0' class='table-top-sales'>" +
                                            ...
                                            "</tr>" +
                                            "<tr>" +
                                                "<td valign='top' class='table-top-sales-col-first'>" +
                                                    "Inv/ Tax No" +
                                                "</td>" +
                                                "<td valign='top' class='table-col-seperator'> : </td>" +
                                                "<td valign='top' class='table-top-sales-col-second'>" +
                                                    " {9}" +
                                                "</td>" +
                                                "<td valign='top' class='table-top-sales-col-third'>" +
                                                    "Date"+
                                                "</td>" +
                                                "<td valign='top' class='table-top-sales-col-forth'>" +
                                                    ": {10}" +
                                                "</td>" +
                                                "<td valign='top' class='table-top-sales-col-fifth'>" +
                                                    "RV No" +
                                                "</td>" +
                                                "<td valign='top' class='table-top-sales-col-sixth'>" +
                                                    ": <b>{11}</b>" +
                                                "</td>" +
                                            "</tr>" +
                                            "<tr>" +
                                            ...
                                            "</tr>" +
                                             "<tr>" +
                                                ...
                                                "<td>" +
                                                "</td>" +
                                            "</tr>" +   // Next Row Header Fields Are Hiden
                                        "</table>" +
