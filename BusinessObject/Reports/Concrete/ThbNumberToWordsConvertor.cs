...
{
    internal sealed class ThbNumberToWordsConvertor : NumberToWordsConvertor
    {
        public ThbNumberToWordsConvertor(string currency) : base(currency) { }
        ...
        public override string ConvertNumberToWords(string Number)
        {
            ...
            try
            {
                ...
                if (decimalPlace > 0)
                {
                    ...
                    {
                        andStr = "and Satang " + translateWholeNumber(points).Trim();
                    }
                }
                val = String.Format("{0} {1}{2} {3}", "THB " + translateWholeNumber(wholeNo).Trim(), andStr, pointStr, endStr);
            }
            catch
            {
