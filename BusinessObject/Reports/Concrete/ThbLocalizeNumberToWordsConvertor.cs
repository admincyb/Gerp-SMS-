...
{
    class ThbLocalizeNumberToWordsConvertor : NumberToWordsConvertor
    {
        ...
        public ThbLocalizeNumberToWordsConvertor(string currency) : base(currency) { }

        public override string ConvertNumberToWords(string Number)
        {
            return ToBahtText(Convert.ToDouble(Number.Trim()));
        }

        #region Helper Methods
        private static string ToBahtText(double value)
        {
            string result;
