...
namespace BusinessObject.POInvoicing
{
    ...
    [Serializable]
    [XmlRoot("Root")]
    public class POInvoiceHeader : WorkflowBO
    {
        [XmlElement("IVH_PK")]
        ...
        public double IVH_AMOUNT_SET { get; set; }
        ...
        [XmlElement("POH_PRICE_ADJUST_TOTAL")]
        public double POH_PRICE_ADJUST_TOTAL { get; set; }
        [XmlElement("POH_TOTAL_VALUE_TC")]
        public double POH_TOTAL_VALUE_TC { get; set; }
        [XmlElement("POH_DISC_AMT_TOTAL")]
        public double POH_DISC_AMT_TOTAL { get; set; }
        ...
        public string IVH_INVESTOR { get; set; }
        [XmlElement("IVH_TO_PORT")]
        public string IVH_TO_PORT { get; set; }
        [XmlElement("IVH_TO_PORT_TEXT")]
        public string IVH_TO_PORT_TEXT { get; set; }
        ...
        public double POH_PRICE_ADJUST { get; set; }
        [XmlElement("POH_SUB_TOTAL")]
        public double POH_SUB_TOTAL { get; set; }
        [XmlElement("POH_TOTAL_VALUE")]
        public double POH_TOTAL_VALUE { get; set; }
        [XmlElement("POH_DISC_AMT")]
        public double POH_DISC_AMT { get; set; }
        ...
        public int IVH_CONVERT { get; set; }
        ...
        public string IVH_BILL_ENTRY_NO { get; set; }
        [XmlElement("IVH_BILL_ENTRY_DATE")]
        public string IVH_BILL_ENTRY_DATE { get; set; }
        [XmlElement("IVH_BILL_ENTRY_VALUE")]
        public string IVH_BILL_ENTRY_VALUE { get; set; }
        [XmlElement("PREPARED_BY")]
        ...
        public string IVH_GST_TYPE { get; set; }

        [XmlElement("IVH_ISSUE_DEPT")]
        public int IVH_ISSUE_DEPT { get; set; }
        [XmlElement("IVH_ISSUE_DEPT_TEXT")]
        public string IVH_ISSUE_DEPT_TEXT { get; set; }

        
        // Alert End
        [XmlElement("OrderDetail")]
        public List<POInvoiceDetails> OrderDetail { get; set; }
        [XmlElement("TaxHdr")]
        public List<POInvoiceTaxHdr> TaxHdr { get; set; }
        [XmlElement("AdvDedDtl")]
        public List<POAdvDeductionDetails> DeductionDetails { get; set; }
        [XmlElement("FileList")]
        public List<POInvoiceUploads> FileList { get; set; }
        [XmlElement("POMpg")]
        public List<POOtherChargeDetails> OtherChargeDetails { get; set; }
        [XmlElement("IVH_AMOUNT_REFUND")]
        public decimal IVH_AMOUNT_REFUND { get; set; }
        [XmlElement("ExpSet")]
        public List<ExpenseSettilements> ExpSettlements { get; set; }
    ...
    [Serializable]
    public class ExpenseSettilements
    {
        [XmlElement("IED_VOUCHER_HDR")]
        public int IED_VOUCHER_HDR { get; set; }
        [XmlElement("IED_PK")]
        public int IED_PK { get; set; }
        [XmlElement("IED_AMOUNT")]
        public decimal IED_AMOUNT { get; set; }
    }
    [Serializable]
    public class POInvoiceDetails
    {
        ...
        [XmlElement("VID_ORDERED_TAX")]
        public double VID_ORDERED_TAX { get; set; }
        [XmlElement("VID_ORDERED_DISC")]
        public double VID_ORDERED_DISC { get; set; }
        
        [XmlElement("VID_ASSET_TYPE")]
        public int? AssetTypePK { get; set; }

        [XmlElement("VID_IS_ASSET")]
        public int IsAsset { get; set; }

        [XmlElement("VID_IS_FORMER")]
        public int IsFormer { get; set; }

        [XmlElement("VID_ITM_IS_ASSET")]
        public int ItemIsAsset { get; set; }

        [XmlElement("TaxDtl")]
        public List<POInvoiceTaxHdr> TaxDtl { get; set; }
        [XmlElement("GRNDtl")]
        public List<GRNQTYDetails> GRNDtl { get; set; }
        [XmlElement("CostCenterDtl")]
        public List<POCostCenterDetails> CostCenterDtl { get; set; }
    }

    [Serializable]
    public class POInvoiceTaxHdr
    {
        [XmlElement("VTL_PK")]
        ...
        [XmlElement("VTL_HAS_SUB_TOTAL")]
        public int VTL_HAS_SUB_TOTAL { get; set; }
        [XmlElement("VTL_HAS_DISCOUNT")]
        public int VTL_HAS_DISCOUNT { get; set; }
        [XmlElement("VTL_HAS_OTHER_CHARGE")]
        public int VTL_HAS_OTHER_CHARGE { get; set; }
        [XmlElement("VTL_POH_PRICE_ADJUST")]
        public double VTL_POH_PRICE_ADJUST { get; set; }

    }

    [Serializable]
    public class POInvoiceUploads
    {
        [XmlElement("DOC_PK")]
        ...
        [XmlElement("DOC_TASK2")]
        public string DOC_TASK2 { get; set; }
        [XmlElement("DOC_TASK_ID2")]
        public string DOC_TASK_ID2 { get; set; }
        [XmlElement("DOC_IS_GRN")]
        public int DOC_IS_GRN { get; set; }
    ...
    [Serializable]
    public class POAdvDeductionDetails
    {
        [XmlElement("VAD_PK")]
    ...
    [Serializable]
    public class POOtherChargeDetails
    {
        [XmlElement]
    ...
    public class GRNQTYDetails
    {
        ...
        [XmlElement]
        public double VGL_DMG_QTY { get; set; }
        [XmlElement]
        public string TIH_NO { get; set; }
        [XmlElement]
        public int TIH_PK { get; set; }
        [XmlElement]
        public int RawMaterialPageType { get; set; }
    }

    [Serializable]
    public class POCostCenterDetails
    {
        [XmlElement("IVC_PK")]
        public int IVC_PK { get; set; }
        [XmlElement("IVC_SL_NO")]
        public int IVC_SL_NO { get; set; }
        [XmlElement("IVC_PO_DTL")]
        public int IVC_PO_DTL { get; set; }
        [XmlElement("IVC_POD_NO")]
        public string IVC_POD_NO { get; set; }
        [XmlElement("IVC_COST_CENTER")]
        public int IVC_COST_CENTER { get; set; }
        [XmlElement("IVC_COST_CENTER_TEXT")]
        public string IVC_COST_CENTER_TEXT { get; set; }
        [XmlElement("IVC_POR_QTY_ORDERED")]
        public double IVC_POR_QTY_ORDERED { get; set; }
        [XmlElement("IVC_PERCENTAGE")]
        public double IVC_PERCENTAGE { get; set; }
        [XmlElement("IVC_QUANTITY")]
        public double IVC_QUANTITY { get; set; }
        [XmlElement("IVC_AMOUNT")]
        public double IVC_AMOUNT { get; set; }
    }
    ...
    [Serializable]
    [XmlRoot("Root")]
    public class MultiplePOInvoiceHeader
    {
        [XmlElement("PO")]
        public List<POInvoiceHeader> MultiplePOList { get; set; }
    }
    #endregion
}
