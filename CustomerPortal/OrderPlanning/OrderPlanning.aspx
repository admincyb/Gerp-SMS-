<%@ Page Title="" Language="C#" MasterPageFile="~/ERPSMS_2.Master" AutoEventWireup="true" CodeBehind="OrderPlanning.aspx.cs" Inherits="CustomerPortal.OrderPlanning.OrderPlanning" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        #ctl00_MainContent_grdGrouplist_ctl02_grdSize_ctl02_imbViewSC {
            margin-left: 18px;
        }
    ...
    <script src="../Scripts/PageScript/OrderPlanning/OrderPlanning.js" type="text/javascript"></script>
    <script type="text/javascript">
        var pageURL = window.document.URL;
        var virtualPath = '<%=(System.Configuration.ConfigurationManager.AppSettings["VirtualDirectory"].ToString())%>';
        var url = pageURL.replace(window.document.location.search, "").replace(location.pathname, virtualPath == "" ? "/Handlers/AutoComplete.ashx" : "/" + virtualPath + "Handler/AutoComplete.ashx");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <asp:TableRow ID="PageAction_Entry">
                        <asp:TableCell>
                                    ...
                                    <td>
                                        <div class="div2col-S padgtop7">
                                            ...
                                            <div class="starwrap">
                                                ...
                                                <asp:CustomValidator ID="vreFromDate2" SetFocusOnError="true" ValidationGroup="Plan"
                                                    EnableClientScript="true" runat="server" ControlToValidate="txtFromDate"
                                                    Text="*" ErrorMessage="<%$ resources: Msg_Empty_FromDate %>" Display="Dynamic"
                                                    CssClass="star">
                                                </asp:CustomValidator>
                                            </div>
                                            ...
                                            <div class="starwrap">
                                                ...
                                                <asp:RequiredFieldValidator ID="vrfToDate2" SetFocusOnError="true" ValidationGroup="Plan"
                                                    EnableClientScript="true" runat="server" ControlToValidate="txtToDate" Text="*"
                                                    ErrorMessage="<%$ resources: Msg_Empty_ToDate %>" Display="Dynamic" CssClass="star">
                                                </asp:RequiredFieldValidator>
                                            </div>
                            ...
                            <ul id="tab-menu" class="margnbotm-minus1">
                                ...
                                <li><span id="tab4" runat="server" visible="false" class="tab-inactive">
                                    <asp:LinkButton runat="server" ID="lnkScenario" Text="<%$ Resources:Scenario %>"
                                        CssClass="tab-inactive" OnClick="ActionHandler" ValidationGroup="Plan" OnClientClick="javascript:ValidatePageNow('Plan')"
                                        CommandName="SCENARIO"></asp:LinkButton>
                                </span></li>
                                <li><span id="tab2" runat="server" class="tab-active">
                                    ...
                                    <asp:LinkButton runat="server" ID="lnkPlanning" Text="<%$ Resources:Planning %>"
                                        CssClass="tab-active" OnClick="ActionHandler" ValidationGroup="Plan" OnClientClick="javascript:ValidatePageNow('Plan')" CommandName="PLANNING"></asp:LinkButton>
                                </span></li>
                            ...
                            <div id="divPlanning" style="overflow-x: hidden; overflow-y: auto; max-height: 400px;"
                                ...
                                <div class="button-wrap-right">
                                    <asp:CheckBox runat="server" ID="chkOptimizePlan" Visible="false" ToolTip="<%$ Resources:Optimize %>" CssClass="margnbotm0 margntop3" onClick="ShowHidePlanSplit();" />
                                    <asp:Label runat="server" ID="lblOptimizePlan" Visible="false" Text="<%$ Resources:Optimize %>"></asp:Label>
                                ...
                                <div class="gridwrap hierarchical-wrap2" id="divSec_ScrollContainer" grid="grdGrouplist">
                                    ...
                                    <cc1:ExtGridView runat="server" ID="grdGrouplist" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:SCNo %>" HeaderStyle-HorizontalAlign="Left"
                                                HeaderStyle-Width="10%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblProductGroup" runat="server" Text='<%#  ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("SOD_NO")),65) %>'
                                                        ToolTip='<%# Eval("SOD_NO") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:Customer %>" HeaderStyle-HorizontalAlign="Left"
                                                HeaderStyle-Width="24%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCustomer" runat="server" Text='<%#  ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("SOH_CUSTOMER_CODE")),65) %>'
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:Requiredby %>" HeaderStyle-CssClass="grd-head-center"
                                                ...
                                                <ItemStyle Width="6.5%" HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-Width="2%">
                                                <HeaderTemplate>
                                                    <asp:LinkButton runat="server" Visible="false" ID="lnkbtnAGradeHdr" Text="<%$ Resources:AGradeRealizationCaption %>"
                                                        ToolTip="<%$ Resources:AGradeRealizationTooltip %>" OnClientClick="javascript:return CalculateTotalwithAGrade();"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkbtnAGradeDtl" Visible="false" Text="<%$ Resources:AGradeRealizationCaption %>"
                                            ...
                                            <asp:TemplateField Visible="false" HeaderText="<%$ Resources:LinePlannedQty %>" HeaderStyle-Width="6%"
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="imbAddLine" runat="server" Visible="false" SkinID="imbsplitup" OnClick="ActionHandler"
                                                        ...
                                                        <asp:GridView runat="server" ID="grdSize" AutoGenerateColumns="False" Width="100%"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="<%$ Resources:Brand %>">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSizeText" runat="server" Text='<%# Eval("SOD_BRAND_CODE") + " - " + Eval("SOD_BRAND_NAME") %>' ToolTip='<%# Eval("SOD_BRAND_NAME") %>'></asp:Label>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ Resources:Size %>">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSize" runat="server" Text='<%# Eval("SOD_BRAND_SIZE_NAME") %>' ToolTip='<%# Eval("SOD_BRAND_SIZE_NAME") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="5%" />
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ Resources:Planned %>" HeaderStyle-CssClass="grd-head-rgt"
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ Resources:CurrentPlan %>" HeaderStyle-CssClass="grd-head-rgt">
                                                                    ...
                                                                    <ItemStyle Width="13.5%" HorizontalAlign="Right" />
                                                                </asp:TemplateField>

                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="imbViewSC" CssClass="imbviewsc-img" runat="server" SkinID="imgbtnaction" OnClick="ActionHandler"
                                        ...
                                        <cc1:ExtGridView runat="server" ID="grdSummaryPlant" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Plant %>" HeaderStyle-HorizontalAlign="Left"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPlantText" runat="server" Text='<%#  ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("LNE_PLANT_TEXT")),40) %>'
                                                            ...
                                                            <cc1:ExtGridView runat="server" ID="grdLineSummary" AutoGenerateColumns="False" Width="100%"
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="<%$ Resources:Line %>" HeaderStyle-HorizontalAlign="Left">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblLineText" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("PNL_LINE_TEXT")),40) %>'
                                                                                ...
                                                                                <asp:GridView runat="server" ID="grdPGroupSummary" AutoGenerateColumns="False" Width="100%"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="<%$ Resources:ProductGroup %>">
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lblPGroupText" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("PND_PLAN_GROUP_TEXT")),75) %>'
                                    ...
                                    <cc1:ExtGridView runat="server" ID="grdGrouplistScenario" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="<%$ Resources:ProductGroup %>" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblProductGroup" runat="server" Text='<%#  ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("PND_PLAN_GROUP_TEXT")),65) %>'
                                                        ToolTip='<%# Eval("PND_PLAN_GROUP_TEXT") %>'></asp:Label>
                                                    <asp:HiddenField runat="server" ID="hdfIsExpandedGroupItem" Value="0" />
                                                    <asp:HiddenField runat="server" ID="hdfPlanDtlPK" Value='<%# Eval("PND_PK") %>' />
                                                    <asp:HiddenField runat="server" ID="hdfPlanGroupPK" Value='<%# Eval("PND_PLAN_GROUP") %>' />
                                ...
                                <asp:GridView ID="grdPlanList" runat="server" AutoGenerateColumns="False" class="gridwraptable gridwrap tablefixwidth-td"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:PlanName %>" ItemStyle-HorizontalAlign="Left"
                                            SortExpression="PNH_NAME" ItemStyle-Width="45%" ItemStyle-CssClass="grdText">
                                            <ItemTemplate>
                                                <asp:Label ID="lblPlanName" runat="server" Text='<%# ERP.Utilities.CommonFunctions.GetShortString(Convert.ToString(Eval("PNH_NAME")),50) %>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:PlannedQty %>" ItemStyle-HorizontalAlign="Right"
                                            ItemStyle-Width="6%" ItemStyle-CssClass="grdText" HeaderStyle-CssClass="grd-head-rgt">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:ProducedQty %>" Visible="false" ItemStyle-HorizontalAlign="Right"
                                        ...
                                        <asp:TemplateField HeaderText="<%$ Resources:BalToProduce %>" Visible="false" ItemStyle-HorizontalAlign="Right"
                                            ItemStyle-Width="10%" ItemStyle-CssClass="grdText" HeaderStyle-CssClass="grd-head-rgt">
                                            <ItemTemplate>
    ...
    <div id="diverror" style="display: none">
        ...
        <asp:ValidationSummary ID="vvsUcrPlan" ValidationGroup="Plan" runat="server" />
