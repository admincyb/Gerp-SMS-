...
{
    public partial class DirectOrderAccept : ERP.Store.UI.MyBasePage
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (CurrPK > 0)
                    {
                        ...
                        if (QuotationHeaderSession.QuotationDtl != null && QuotationHeaderSession.QuotationDtl.Count > 0)
                        {
                            QuotationHeaderSession.QuotationDtl.ForEach(dtl => dtl.CED_AMOUNT = dtl.CED_RATE * dtl.CED_ENQ_QTY);
                        }
            ...
            try
            {
                switch (type)
                {
                    ...
                    case ControlsEnum.QUOTATIONTAXTYPES:
                        ...
                        {
                            dsQuotationTaxDetails = BusinessLogic.Sales.QuotationBL.GetQuotationTaxDetails(TaxPK, category, currentUser.SBUID, Convert.ToByte(DbActiveStatus.ACTIVE));
                        }
                        break;
                ...
                switch (controlType)
                {
                    ...
                    case ControlsEnum.QUOTATIONHEADER:
                        if (quotationHeaderObj != null)
                        {
                            ...
                            lblEnquiryNo.Text = String.IsNullOrEmpty(quotationHeaderObj.CEH_REF_NO) ? string.Empty : quotationHeaderObj.CEH_REF_NO.ToString();
                            hdfEnquiryNo.Value = String.IsNullOrEmpty(quotationHeaderObj.CEH_REF_NO) ? string.Empty : quotationHeaderObj.CEH_REF_NO.ToString();
        ...
        private void BindDropDown(ControlsEnum controlType)
        {
            switch (controlType)
            {
                ...
                case ControlsEnum.QUOTATIONTAXTYPES:
                    ...
                    if (dsQuotationTaxDetails != null && dsQuotationTaxDetails.Tables[0].Rows.Count > 0)
                    {
                        ddlPopupTaxType.DataSource = CommonFunctions.HtmlDecodeDataTable(dsQuotationTaxDetails.Tables[0], "TAX_HEAD");
        ...
        private void SetDetailTax(object sender)
        {
            ...
            if (sender != null)
            {
                ...
                txtQuantity = (((sender as TextBox).Parent.Parent as GridViewRow).FindControl("txtQuantity") as TextBox);
            ...
            else if (SelectedQuotationPK == 0 && SelectedItemPK == 0)
            {
                ...
                foreach (GridViewRow gvr in grdQuotation.Rows)
                {
                    if (gvr.RowType == DataControlRowType.DataRow)
                    {
                        ...
                        SelectedQuotationPK = Convert.ToInt32(hdfCEDPK.Value);
        ...
        protected void ActionHandler(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (((TextBox)sender).ID == "txtRate" || ((TextBox)sender).ID == "txtQuantity")
                    {
                ...
                switch (commonActions)
                {
                    ...
                    case ActionsEnum.ADDRESSSELECTED:
                        ...
                        if (dtPageData != null && dtPageData.Rows.Count > 0)
                        {
                            txtShippingAddress.Text = HttpUtility.HtmlDecode(dtPageData.Rows[0]["CAD_ADDRESS"].ToString()) +
                                ...
                                (string.IsNullOrEmpty(txtShippingAddress.Text) ? dtPageData.Rows[0]["CAD_CITY"].ToString() :
                                ...
                                (string.IsNullOrEmpty(txtShippingAddress.Text) ? dtPageData.Rows[0]["CAD_STATE_TEXT"].ToString() :
                                ...
                                (string.IsNullOrEmpty(txtShippingAddress.Text) ? dtPageData.Rows[0]["CAD_COUNTRY_TEXT"].ToString() :
                            ...
                            if (hasValidRate)
                            {
                                if (quotationHeaderObj != null && quotationHeaderObj.QuotationDtl != null)
                                {
                                    ...
                                    if (result > 0) // Success !  redirect to listing page
                                    {
                                        ...
                                        litErrorMsg.Text = string.Format(litErrorMsg.Text, Resources.PageNameRes.OrderAccept);
                                        //if (string.IsNullOrEmpty(lblQuotationNo.Text))
                                        //{
                            ...
                            if (QuotationHeaderSession != null)
                            {
                                ...
                                if (ddlPopupTaxType.Items.Count > 0)
                                {
                                    if (Convert.ToInt32(ddlPopupTaxType.SelectedValue) > 0)
                                    {
                                        ...
                                        if (dsQuotationTaxDetails != null && dsQuotationTaxDetails.Tables[0].Rows.Count == 1)
                                        {
                                            string taxFormula = dsQuotationTaxDetails.Tables[0].Rows[0]["TAX_FORMULA"].ToString();
                                            ...
                                            SelectedTaxText = HttpUtility.HtmlDecode(dsQuotationTaxDetails.Tables[0].Rows[0]["TAX_HEAD"].ToString());
                    ...
                    case ActionsEnum.TAXTYPECHANGED:
                        if (Convert.ToInt32(ddlPopupTaxType.SelectedValue) > 0)
                        {
                            ...
                            if (dsQuotationTaxDetails != null && dsQuotationTaxDetails.Tables[0].Rows.Count == 1)
                            {
                                ...
                                taxFormula = taxFormula.Replace("#SUBTOTAL#", txtPopupItemAmount.Text.Trim());
                                txtPopupAmount.Text = Math.Round(StringToFormula(taxFormula), Thread.CurrentThread.CurrentCulture.NumberFormat.CurrencyDecimalDigits).ToString(hdfCurrencyFormat.Value);
                                SelectedTaxText = HttpUtility.HtmlEncode(dsQuotationTaxDetails.Tables[0].Rows[0]["TAX_HEAD"].ToString());
                                txtPopupOther.Text = ddlPopupTaxType.SelectedItem.Text;
                                txtPopupAmount.Enabled = false;
                                txtPopupOther.Enabled = false;
                            }
                    ...
                    case ActionsEnum.SALEORDER:
                        if (CurrPK > 0)
                        {
                            ...
                            Response.Redirect(Page.ResolveClientUrl(Resources.PageURL.SaleOrderDetails), false);
                        }
                        //currentUser = ((BusinessObject.User)(HttpContext.Current.User.Identity));
