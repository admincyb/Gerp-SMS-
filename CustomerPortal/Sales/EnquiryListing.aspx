<%@ Page Title="<%$ Resources:Captions,Title_EnquiryListing %>" Language="C#" MasterPageFile="~/ERPSMS_2.Master"
    AutoEventWireup="true" CodeBehind="EnquiryListing.aspx.cs" Inherits="ERPSMS_v01.Sales.EnquiryListing"
    Theme="ClassicExt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function InitComponents() {
            ...
            GrandScriptUtils.MakeAutoCompleteDDL("txtEnqNumber", url, "hdfEnqNumber", true, true, "ENQUIRYNO");
            GrandScriptUtils.MakeAutoCompleteDDL("txtQuotNumber", url, "hdfQuotNumber", true, true, "QUOTATIONNO");
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell ID="SEC_ActionPanel" CssClass="SEC_ACTION" HorizontalAlign="Right">
                                ...
                                <ul runat="server" id="pnlListing" style="display: none">
                                    ...
                                    <li id="pnlQuotation">
                                        <asp:Button runat="server" ID="btnQuote" CommandName="QUOTE" TabIndex="11" Text="<%$resources:Controls,Quote %>"
                                            OnClick="ActionHandler" CommandArgument="SEC_ActionPanel" SkinID="btnInner-respond"
                                            ToolTip="<%$resources:Controls,Quote %>" />
                                    </li>
                                    <li id="pnlPrint">
                    ...
                    <ul id="tab-menu">
                        <li><span id="Span1" runat="server" class="list-active">
                            <asp:LinkButton runat="server" ID="lbnList" TabIndex="13" CommandName="ENQUIRYLIST"
                                CommandArgument="SEC_ActionPanel" OnClick="ActionHandler" CssClass="list-active"
                                OnPreRender="btnAction_PreRender" OnLoad="btnAction_Load"></asp:LinkButton>
                        </span></li>
                        <li><span id="spnEnquiry" runat="server" class="tab-inactive">
                            <asp:LinkButton runat="server" ID="lbnEnquiry" Text="<%$resources:PageNameRes,Enquiry %>"
                                ...
                                CssClass="tab-inactive" OnPreRender="btnAction_PreRender" OnLoad="btnAction_Load"></asp:LinkButton>
                        </span></li>
                        ...
                        <asp:TableCell>
                                    ...
                                    <td>
                                        <div class="div2col-S">
                                            <div id="divQuotationFilter">
                                                ...
                                                <asp:TextBox ID="txtQuotNumber" runat="server" CssClass="input-half" MaxLength="100"
                                            ...
                                            <div id="divEnquiryFilter">
                                                <asp:Label ID="lblEnqNumber" runat="server" Text="<%$resources:EnqNo %>" AssociatedControlID="txtEnqNumber"></asp:Label>
                                                <asp:TextBox ID="txtEnqNumber" runat="server" CssClass="input-half"  MaxLength="100"
                                                    TabIndex="1"> </asp:TextBox>
                            ...
                            <table class="table-devide">
                                <tr>
                                    <td>
                                        <div class="div2col-S div-separatn">
                                         <asp:Label ID="lblCustomer" runat="server" Text="<%$resources:Customer %>" AssociatedControlID="txtCustomer"></asp:Label>
                                            <asp:TextBox ID="txtCustomer" runat="server" CssClass="input-half margnbotm0 valid" MaxLength="100"
                                    ...
                                    <td>
                                        <div class="div2col-S div-separatn">
                                         <asp:Label runat="server" ID="lblFromDate" CssClass="middle-lbl-small" Text="<%$ resources:FromDate %>" AssociatedControlID="txtFromDate"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtFromDate" CssClass="input-small margnbotm0" TabIndex="3"
                                                onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                                            <asp:HiddenField ID="hdfFromDate" runat="server" />
                                                <asp:Label runat="server" ID="lblToDate" Text="<%$ resources:ToDate %>" CssClass="middle-lbl-xsmall-b margnbotm0" AssociatedControlID="txtToDate"></asp:Label>
                                            <asp:TextBox runat="server" ID="txtToDate" CssClass="input-small margnbotm0" TabIndex="4"
                                                onkeydown="return CheckKey(event)" onpaste="return false;"></asp:TextBox>
                                        ...
                                        <asp:ImageButton ID="btnSearch" runat="server" Text="<%$ resources:Controls,Search %>"
                                                ...
                                                CommandName="SEARCH" SkinID="search-ext" Style="margin-bottom: 0px!important; margin-top: 2px;" />
                                            <asp:ImageButton ID="btnClear" runat="server" Text="<%$ resources:Controls,Clear %>" TabIndex="6"
                                                ToolTip="<%$ resources:Controls,Clear %>" OnClick="ActionHandler" CommandName="CLEAR"
                                                Style="margin-bottom: 0px!important;margin-top: 2px;" SkinID="clear-ext" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <asp:GridView runat="server" ID="grdEnquiryList" Width="100%" PageSize="<%$ resources:PageSize%>"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:CustomerName %>" SortExpression="CEH_CUSTOMER_TEXT">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustomerName" runat="server" Text='<%# STATUS=="2"? ERP.Utilities.CommonFunctions.GetShortString(Eval("CEH_CUSTOMER_TEXT"), 25) : ERP.Utilities.CommonFunctions.GetShortString(Eval("CEH_CUSTOMER_TEXT"), 53)%>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:CustCountry %>" SortExpression="CEH_CUS_COUNTRY_TEXT">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustCountry" runat="server" Text='<%# STATUS=="2"? ERP.Utilities.CommonFunctions.GetShortString(Eval("CEH_CUS_COUNTRY_TEXT"), 18) : ERP.Utilities.CommonFunctions.GetShortString(Eval("CEH_CUS_COUNTRY_TEXT"), 35)%>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:ShipToPort %>" SortExpression="CEH_TO_PORT">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRemarks" runat="server" Text='<%# STATUS=="2"? ERP.Utilities.CommonFunctions.GetShortString(Eval("CEH_TO_PORT"),17) : ERP.Utilities.CommonFunctions.GetShortString(Eval("CEH_TO_PORT"),25) %>'
                                        ...
                                        <asp:TemplateField HeaderText="<%$ resources:TotalAmount %>" SortExpression="CEH_NET_AMOUNT"
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalAmount" runat="server" Text='<%# Convert.ToDecimal(Eval("CEH_NET_AMOUNT")).ToString("c") %>'
                                                    ToolTip='<%# Convert.ToDecimal(Eval("CEH_NET_AMOUNT")).ToString("c")%>'></asp:Label>
                                            </ItemTemplate>
