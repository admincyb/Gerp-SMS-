...
#endregion
/// <summary>
/// This class is responsible for mapping resourse keys used in .js files with values 
/// </summary>
public class ScriptTranslator : IHttpHandler
{
	...
	/// <summary>
	/// Translates the text keys in the script file. The format :Translate(key).
	/// </summary>
	...
	private string TranslateScript(string text)
	{
        ...
        ResourceManager manager = new ResourceManager(typeof(Resources.Messages));

        foreach (Match match in matches)
        {

            object obj = (Object)HttpContext.GetGlobalResourceObject("Messages", match.Groups[1].Value);
            if (obj != null)
            {
