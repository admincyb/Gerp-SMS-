...
namespace ERP.UserControl
{
    ...
    public partial class PagerControl : System.Web.UI.UserControl
    {
        ...
        {
            get { return int.Parse((lblCurrentPage.Text.Equals(String.Empty) ? "0" : lblCurrentPage.Text)); }
        ...
        {
            get { return (lblTotalCount.Text.Equals(String.Empty) ? "0" : lblTotalCount.Text); }
