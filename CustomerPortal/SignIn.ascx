...
<div id="loginwrapper" runat="server" class="loginwrap">
    ...
    <div id="NewLogin">
        ...
        <div id="login-container">
            ...
            <a href="AccountManagement/ResetPassword.aspx">Forgot password</a> 
            <span id="divPresentation" runat="server" >
              <a style="text-decoration: none"> | </a><a href="NewPresentation/presentation.html" target="_blank"><img src="Images/Classic/layout/dwnlod.png" style=" vertical-align:text-bottom; margin-right:3px;" />Presentation</a>
             </span>
