...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $("#ddl1").change(function () {
            ...
            //$("#CIM_PROCESS").removeAttr("disabled");
        });
            ...
            <div class="content-wrapper">
                <asp:Table runat="server" ID="tblTemplate" CssClass="asptbllinks">
                    <asp:TableRow ID="PageAction_List" runat="server">
                        <asp:TableCell>
                            <asp:DropDownList ID="ddl1" runat="server" ClientIDMode="Static" OnSelectedIndexChanged="ActionHandler" AutoPostBack="true">
                                <asp:ListItem Value="0" Text="Val 0" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="1" Text="Val 1"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddl2" runat="server" ClientIDMode="Static" OnSelectedIndexChanged="ActionHandler" AutoPostBack="true">
                                <asp:ListItem Value="0" Text="Val 0" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="1" Text="Val 1"></asp:ListItem>
                            </asp:DropDownList>
                             <div class="clear">
                            </div>
                            <asp:DropDownList ID="ddl3" runat="server" ClientIDMode="Static">
                                <asp:ListItem Value="0" Text="Val 0" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="1" Text="Val 1"></asp:ListItem>
                            </asp:DropDownList>
                            <asp:TextBox ID="txt1" runat="server" ClientIDMode="Static"></asp:TextBox>
                             ...
                             <asp:DropDownList ID="ddl4" runat="server" ClientIDMode="Static">
                                <asp:ListItem Value="0" Text="Val 0" Selected="True"></asp:ListItem>
                                <asp:ListItem Value="1" Text="Val 1"></asp:ListItem>
                            </asp:DropDownList>
