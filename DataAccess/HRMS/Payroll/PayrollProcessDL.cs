...
{
    public class PayrollProcessDL
    {
        //public static string GetEmployeePayrollList(int empPK, int empTypePK, int empBranchPK, int currPK, int empPayrollTypePK, int cmpPK, int employeeTypePK)
        //{
        //    string strRetVal = "";
        ...
        public static int? ProcessPayrollDetails(string strxml, out string TrxNo, out DataTable dtErrorList)
        {
            ...
            DataSet dsResult = dbService.DataAdapter(CommandType.StoredProcedure, Procedures.SPHRM_EMP_PAYROLL_SAVE, colParameters);
        ...
        public static DataTable GetPayrollProcessPeriodList(ERP.Utilities.HRMS.FilterParameters gridParam, int bizUnit, int processMode)
        {
            ...
            return dbService.DataAdapterTable(CommandType.StoredProcedure, Procedures.SPHRM_EMP_PAYROLL_GET_LIST, colParameters);
        }
