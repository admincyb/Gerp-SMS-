...
{
    public class ServiceOrderReceiptDL
    {
        /// <summary>
        /// For get   lsit
        /// </summary>
        ...
        public static DataTable GetServiceOrderReceiptList(GridPrams grid, User objUser, string trxNo, int vendorPk, int seriveTypePk)
        {
            ...
            {        
               new DBService.Parameters(GTIService.Constants.Common.Common.P_PAGE_NUM, grid.PageNumber), 
                ...
                new DBService.Parameters(Parameters.P_RSH_NO, trxNo == string.Empty ? (object) DBNull.Value : trxNo),
                new DBService.Parameters(Parameters.P_RSH_VENDOR, vendorPk >0?vendorPk :(object)DBNull.Value), 
                ...
                new DBService.Parameters(Parameters.P_RSH_SERVICE_TYPE, seriveTypePk >0?seriveTypePk :(object)DBNull.Value),
                new DBService.Parameters(Parameters.P_RSH_STATUS, string.IsNullOrEmpty(grid.FilterStatus) ? (object)DBNull.Value : grid.FilterStatus),
                new DBService.Parameters(Parameters.P_USER_PK, objUser.PKUser)
            };
            return dbService.DataAdapterTable(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_GET_LIST, colParameters);
        }
        public static int? SaveServiceOrderReceiptDetails(string strxml, out string TrxNo)
        {
            ...
            int rows = dbService.ExecuteNonQuery(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_WKF_SAVE, colParameters);
        ...
        public static string GetServiceOrderReceiptByPK(int itemPK)
        {
            string strRetVal = "";
            DBService dbService = new DBService();
            DBService.Parameters[] colParameters = null;
            colParameters = new DBService.Parameters[] 
            {  
                new DBService.Parameters(Parameters.P_RSH_PK, itemPK)
            };
            DataTable dtxml = dbService.DataAdapterTable(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_GET_XML, colParameters);
        ...
        public static int DeleteServiceOrderReceipt(int pk, string lastModifiedDate)
        {
            ...
            colParameters = new DBService.Parameters[] 
            {     
                new DBService.Parameters(Parameters.P_RSH_PK , pk),
            ...
            dbService.ExecuteNonQuery(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_DELETE, colParameters);
        ...
        /// <returns></returns>
        public static DataTable GetAssetServiceOrderReceiptNoAutocomplete(string searchBy, string searchValue, User objUser)
        {
            DBService dbService = new DBService();
            DBService.Parameters[] colParameters = null;
            colParameters = new DBService.Parameters[] 
            ...
            return dbService.DataAdapter(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_AUTO, colParameters).Tables[0];
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public static DataSet GetServiceOrderPending(int sbuID, int storeID, int vendor, int serviceType, int sohPk)
        {
            ...
            {   
                ...
                new DBService.Parameters(Parameters.P_OSH_VENDOR, vendor>0 ? vendor:(object)DBNull.Value ),
                new DBService.Parameters(Parameters.P_OSH_SERVICE_TYPE , serviceType>0 ?serviceType: (object)DBNull.Value),
                new DBService.Parameters(Parameters.P_DEPT, storeID>0 ? storeID: (object)DBNull.Value)  ,
                new DBService.Parameters(Parameters.P_RSH_PK, sohPk>0 ? sohPk:(object)DBNull.Value ),
            };
            return dbService.DataAdapter(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_PENDING_GET_LIST, colParameters);
        }
        public static string GetSelectedServiceOrderDetail(string strxml)
        {
            string strRetVal = "";
            DBService dbService = new DBService();
            DBService.Parameters[] colParameters = null;
            ...
            DataTable dtxml = dbService.DataAdapterTable(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_ORDER_GET_XML, colParameters);
            foreach (DataRow dr in dtxml.Rows)
            {
                strRetVal += dr[0].ToString();
            }
        ...
        /// <returns></returns>
        public static DataTable GetSOVendorStoreDetails(int srhPk)
        {
            DBService dbService = new DBService();
            DBService.Parameters[] colParameters = null;
            colParameters = new DBService.Parameters[] 
            {  
                new DBService.Parameters(Parameters.P_OSH_PK, srhPk >0?srhPk :(object)DBNull.Value) 
            };
            return dbService.DataAdapterTable(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_ORDR_DTL_GET, colParameters);
        }
        ...
        public static DataSet GetAssetServiceOrderReceiptReport(int RecPK)
        {
            ...
            colParameters = new DBService.Parameters[] 
            {
               new DBService.Parameters(Parameters.P_RSH_PK , RecPK==0?(object) DBNull.Value:RecPK)
              };
            DataSet dsList = new DataSet();
            dsList = dbService.DataAdapter(CommandType.StoredProcedure, Procedures.SPASR_SERVICE_RECEIPT_RPT, colParameters);
            return dsList;
        }
    }
}
